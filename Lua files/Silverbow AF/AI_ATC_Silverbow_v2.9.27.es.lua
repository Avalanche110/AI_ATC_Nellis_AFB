...
AI_ATC2_SoundFiles.Departure.SID = {
  ["ESSAA ONE"]     = {filename = "ESSAA ONE.ogg",     duration = 1.312, Subtitle = "ESSAA ONE Salida"},
  ["JAYSN ONE"]     = {filename = "JAYSN ONE.ogg",     duration = 1.300, Subtitle = "JAYSN ONE Salida"},
  ["LEAHI ONE"]     = {filename = "LEAHI ONE.ogg",     duration = 1.509, Subtitle = "LEAHI ONE Salida"},
  ["RANGE TWO"]     = {filename = "RANGE TWO.ogg",     duration = 1.207, Subtitle = "RANGE TWO Salida"},
  ["SILVER ONE"]    = {filename = "SILVER ONE.ogg",    duration = 1.358, Subtitle = "SILVER ONE Salida"},
  ["STOFF TWO"]     = {filename = "STOFF TWO.ogg",     duration = 1.196, Subtitle = "STOFF TWO Salida"},
  ["TONOPAH THREE"] = {filename = "TONOPAH THREE.ogg", duration = 1.521, Subtitle = "TONOPAH THREE Salida"},
}
  ...
  AI_ATC2.SID = {
    ["14"] = {
      ["ESSAA ONE"] = {
        Altitude = "18",
        Radial = "214",
        Instruction = {file = "RightESSAA.ogg",    duration = 1.393, Subtitle = "Vire right direct ESSAA"},
        NAVPOINTS = {
      ...
      ["JAYSN ONE"] = {
        Altitude = "18",
        Radial = "204",
        Instruction = {file = "DirectJAYSN.ogg",    duration = 2.171, Subtitle = "Proceda directo a JAYSN"},
        NAVPOINTS = {
      ...
      ["LEAHI ONE"] = {
        Altitude = "18",
        Radial = "204",
        Instruction = {file = "DirectLEAHI.ogg",    duration = 2.402, Subtitle = "Proceda directo a LEAHI"},
        NAVPOINTS = {
      ...
      ["RANGE TWO"] = {
        Altitude = "10",
        Radial = "204",
        Instruction = {file = "DirectTONOPAH.ogg",    duration = 1.625, Subtitle = "Proceda directo a Tonopah"},
        NAVPOINTS = {
      ...
      ["STOFF TWO"] = {
        Altitude = "10",
        Radial = "204",
        Instruction = {file = "137Radial.ogg",    duration = 2.183, Subtitle = "Intercepte el 137 radial"},
        NAVPOINTS = {
    ...
    ["32"] = {
      ["ESSAA ONE"] = {
        Altitude = "18",
        Radial = "214",
        Instruction = {file = "LeftESSAA.ogg",    duration = 2.078, Subtitle = "Vire left direct ESSAA"},
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.ESSAA
        },
      },
...
function AI_ATC2:InitMenus(Alias)
  ...
  local AI_ATC_Ground_Menu = MENU_GROUP:New(Group, "Rodadura", AI_ATC_Menu)
...
function AI_ATC2:ClearanceSubMenu(Alias)
  ...
  local AI_ATC2_Departure_Menu = MENU_GROUP:New(Group, "Salida...", AI_ATC2_Clearance_Menu)
  ...
  local OptionsMenu = MENU_GROUP:New(Group, "Opciones...", AI_ATC2_Clearance_Menu)
  ...
  local Menu10 = MENU_GROUP:New(Group, "Establecer número entero",   CallsignMenu)
  ----------------------------------------------------------------------------------------------------------------------
  if not Helo then
  ...
  MENU_GROUP_COMMAND:New(Group, "Fuerte",    Menu3, function() AI_ATC2:SetCallsign(Alias, "Fuerte",        "11") end, Group)
...
function AI_ATC2:ReadBackSubMenu(Alias)
  ...
  local AI_ATC2_Readback_Menu = MENU_GROUP:New(Group, "Repetición...", AI_ATC2_Clearance_Menu)
  local OptionsMenu    = MENU_GROUP:New(Group, "Opciones...", AI_ATC2_Clearance_Menu)
  local CallsignMenu   = MENU_GROUP:New(Group, "Establecer callsign...", OptionsMenu)
  
  if squawk and string.find(squawk, "001", 1, true) then
    MENU_GROUP_COMMAND:New(Group, "Código transpondedor 1001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "1001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Código transpondedor 2001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "2001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Código transpondedor 3001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "3001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Código transpondedor 4001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "4001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Código transpondedor 5001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "5001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Código transpondedor 6001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "6001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Código transpondedor 7001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "7001") end, Group)
  else
...
function AI_ATC2:SeperateFromGroup(Alias)
  ...
  local Menu = MENU_GROUP:New(Group, "Separarse del grupo", AI_ATC2.ParentMenu)
  
  MENU_GROUP_COMMAND:New(Group, "Separarse del grupo", Menu, function() AI_ATC2:SeperateGroup(Alias, Menu) end, Group)
...
function AI_ATC2:GroundStartSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Solicitar arranque de motores", AI_ATC2_Ground_Menu, function() AI_ATC2:EngineStart(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:TaxiSubMenu(Alias)
  ...
  if Helo==false then
    MENU_GROUP_COMMAND:New(Group, "Solicitar arranque de motores", AI_ATC2_Ground_Menu, function() AI_ATC2:EngineStart(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Solicitar autorización de rodaje", AI_ATC2_Ground_Menu, function()AI_ATC2:TaxiClearance(Alias) end, Group)
  elseif Helo==true then
    MENU_GROUP_COMMAND:New(Group, "Solicitar arranque de motores", AI_ATC2_Ground_Menu, function() AI_ATC2:EngineStart(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Solicitar autorización de rodaje", AI_ATC2_Ground_Menu, function()AI_ATC2:TaxiClearance(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Solicitar comprobación de vuelo estacionario", AI_ATC2_Ground_Menu, function()AI_ATC2:HoverCheck(Alias, "Tierra") end, Group)
    MENU_GROUP_COMMAND:New( Group, "Solicitar despegue desde estacionamiento", AI_ATC2_Tower_Menu, function()AI_ATC2:TakeoffFromParking(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:CrossPadSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Solicitar autorización a plataforma", AI_ATC2_Tower_Menu, function() AI_ATC2:TakePad(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************GROUND - HOVER CHECK**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HoverSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Tower_Menu = ATM2.ClientData[Alias].TowerMenu
  local HoverMenu = MENU_GROUP_COMMAND:New( Group, "Solicitar comprobación de vuelo estacionario", AI_ATC2_Tower_Menu, function()AI_ATC2:HoverCheck(Alias, "Tower") end, Group)
...
function AI_ATC2:HeloTakeOffSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Solicitar despegue", AI_ATC2_Tower_Menu, function()AI_ATC2:HeloTakeoff(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER TAKEOFF SUB MENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TakeOffSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Solicitar despegue", AI_ATC2_Tower_Menu, function()AI_ATC2:TakeoffClearance(Alias) end, Group)
  if not Helo then
    local ClimbMenu = MENU_GROUP:New(Group, "Ascenso sin restricciones", AI_ATC2_Tower_Menu)
...
function AI_ATC2:DepartureSubMenu(Alias, missed)
  ...
  if Randomizer==1 and missed~=true then
    MENU_GROUP_COMMAND:New(Group, "Contacto inicial", DepartureMenu, function() AI_ATC2:DepartureIdent(Alias) end, Group)
  elseif Randomizer~=1 and missed~=true then
    MENU_GROUP_COMMAND:New(Group, "Contacto inicial", DepartureMenu, function() AI_ATC2:DepartureCheckin(Alias) end, Group)
  elseif missed==true then
    MENU_GROUP_COMMAND:New(Group, "Contacto inicial", AppraochMenu, function() AI_ATC2:MissedApproach(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:NavigationSubMenu(Alias, Modifier)
  ...
  local VectorMenu = MENU_GROUP:New(Group, "Vector a", DepartureMenu)
    ...
    if branch == "Helo" then
      for _, navpoint in ipairs(navTable) do
        if navpoint and navpoint.GetName then
          ...
          MENU_GROUP_COMMAND:New(Group, "Informar "..name, ReportMenu, function() AI_ATC2:RadarTerminate(Alias) end, Group)
          MENU_GROUP_COMMAND:New(Group, "Vectores para "..name, NavPoint, function() AI_ATC2:NavAssist(Alias, name, Transmitter) end, Group)
        end
      end

    else
      MENU_GROUP_COMMAND:New(Group, "Informar punto de anclaje", ReportMenu, function() AI_ATC2:RadarTerminate(Alias) end, Group)
  ...
  MENU_GROUP_COMMAND:New(Group, "Solicitar aproximación", DepartureMenu, function() AI_ATC2:RequestApproach(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************APPROACH SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:ApproachTypeMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Cancelar IFR", ApproachMenu, function() AI_ATC2:CancelIFR(Alias) end, Group)
  ...
  local function GenerateIFRMenus()
    ...
    MENU_GROUP_COMMAND:New(Group, "Solicitar GCA", IFRMenu, function() AI_ATC2:PushGCA(Alias) end, Group)
  end
...
function AI_ATC2:GCASubMenu(Alias, missed, modifier)
  ...
  if not modifier then
    MENU_GROUP_COMMAND:New(Group, "Contacto inicial GCA", AppraochMenu, function() AI_ATC2:IFRApproachType5(Alias, "PAR") end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, "Contacto inicial GCA", AppraochMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "PAR") end, Group)
  end
...
function AI_ATC2:B2CheckInSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Contacto inicial", AppraochMenu, function() AI_ATC2:B2RCheckIn(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:BackToRadarSubMenu(Alias)
  ...
  if ActiveRunway=="14" then
    ...
    MENU_GROUP_COMMAND:New(Group, "Solicitar GCA", IFRMenu, function() AI_ATC2:PushGCA(Alias, true, true) end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, TacSub, IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, TacFinal, IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, "", IFRMenu, function()  end, Group)
...
function AI_ATC2:ApproachAssistMenu(Alias, report)
  ...
  local ApproachMenu = ATM2.ClientData[Alias].ApproachMenu
  local VectorMenu = MENU_GROUP:New(Group, "Vector a Navpoint", ApproachMenu)
  ...
  if Procedure=="VFR" then
    if Helo then
      ...
      MENU_GROUP_COMMAND:New(Group, "Solicitar identificación IFR", ApproachMenu, function() SetApproachType("IFR") AI_ATC2:IFRApproach(Alias) end, Group)
    end
  elseif Procedure=="IFR" then
  ...
  local AirfieldMenu = MENU_GROUP:New(Group, "Vector a aeródromo", ApproachMenu)
  AI_ATC2:AirfieldMenus(Transmitter, Alias, AirfieldMenu)
...
function AI_ATC2:VectorToFinal(Alias, Tbl, Transmitter)
  ...
  local VectorMenu = MENU_GROUP:New(Group, "Vector a...", ApproachMenu)
  MENU_GROUP_COMMAND:New(Group, "Radar tramo a favor de viento", VectorMenu, function() AI_ATC2:NavAssist(Alias, Downwind, Transmitter, "Downwind") end, Group)
...
function AI_ATC2:MissedApproachMenu(Alias)
  ...
  local Procedure1 = "Vector para "..Navpoint
  ...
  MENU_GROUP_COMMAND:New(Group, "Solicitar GCA", IFRMenu, function() AI_ATC2:PushGCA(Alias, true) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:LandingSubMenu(Alias, Modifier)
  ...
  if Helo~=true then
    if ApproachType == "VFR" then
      ...
      if Modifier then
        MENU_GROUP_COMMAND:New(Group, "Solicitar salida", CommandMenu, function() AI_ATC2:RadarVectorDeparture(Alias) end, Group)
      end
    elseif ApproachType == "IFR" then
      MENU_GROUP_COMMAND:New(Group, "Directo por instrumentos", CommandMenu, function() AI_ATC2:InstrumentStraightIn(Alias) end, Group)
      if Modifier then
        MENU_GROUP_COMMAND:New(Group, "  ", CommandMenu, function() end, Group)
        MENU_GROUP_COMMAND:New(Group, "Solicitar regreso a radar", CommandMenu, function() AI_ATC2:RadarVectorDeparture(Alias) end, Group)
      end
    end
  else
    MENU_GROUP_COMMAND:New(Group, "Straight In", CommandMenu, function() AI_ATC2:HeloRequestLanding(Alias, "Straight In") end, Group)
     MENU_GROUP_COMMAND:New(Group, "Circuito cerrado", CommandMenu, function() AI_ATC2:HeloRequestLanding(Alias, "Closed traffic") end, Group)
  end
...
function AI_ATC2:InitialSubMenu(Alias)
  ...
  local InitialMenu = MENU_GROUP:New(Group, "Informar 5 millas", CommandMenu)
  ...
  MENU_GROUP_COMMAND:New(Group, "Aproximación baja", InitialMenu, function() AI_ATC2:RequestLowApproach(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Procedimiento opción", InitialMenu, function() AI_ATC2:RequestOption(Alias) end, Group)
...
function AI_ATC2:ReportHighKeyMenu(Alias)
  ...
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Informar", TowerMenu)
  MENU_GROUP_COMMAND:New(Group, "Informar punto alto", CommandMenu, function() AI_ATC2:ReportKey(Alias, "High") end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:ReportLowKeyMenu(Alias)
  ...
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Informar", TowerMenu)
  MENU_GROUP_COMMAND:New(Group, "Informar punto bajo", CommandMenu, function() AI_ATC2:ReportKey(Alias, "Low") end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER REPORT INITIAL************************************************************************************--
...
function AI_ATC2:ReportBaseSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Aproximación baja", BaseMenu, function() AI_ATC2:RequestLowApproach(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Procedimiento opción", BaseMenu, function() AI_ATC2:RequestOption(Alias) end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************HELO REPORT BASE************************************************************************************--
...
function AI_ATC2:HeloBaseSubMenu(Alias, Type)
  ...
  if Type=="Closed traffic" then
    MENU_GROUP_COMMAND:New(Group, "Informar base", TowerMenu, function() AI_ATC2:HeloBase(Alias) end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, "Informar 3 millas", TowerMenu, function() AI_ATC2:HeloBase(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC2:WingmanBaseSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Aproximación baja", BaseMenu, function() AI_ATC2:WingmanReportBase(Alias, "Aproximación baja", "2") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Procedimiento opción", BaseMenu, function() AI_ATC2:WingmanReportBase(Alias, "Procedimiento opción", "2") end, Group)
  ...
  MENU_GROUP_COMMAND:New(Group, "Aproximación baja", BaseMenu3, function() AI_ATC2:WingmanReportBase(Alias, "Aproximación baja", "3") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Procedimiento opción", BaseMenu3, function() AI_ATC2:WingmanReportBase(Alias, "Procedimiento opción", "3") end, Group)
  ...
  MENU_GROUP_COMMAND:New(Group, "Aproximación baja", BaseMenu4, function() AI_ATC2:WingmanReportBase(Alias, "Aproximación baja", "4") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Procedimiento opción", BaseMenu4, function() AI_ATC2:WingmanReportBase(Alias, "Procedimiento opción", "4") end, Group)
...
function AI_ATC2:WingmanClosedSubMenu(Alias)
  ...
  if Wingman2Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Solicitar circuito cerrado", Command2Menu, function() AI_ATC2:WingmanClosedTraffic(Alias, "2") end, Group)
  end
  ...
  if Wingman3Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Solicitar circuito cerrado", Command3Menu, function() AI_ATC2:WingmanClosedTraffic(Alias, "3") end, Group)
  end
  ...
  if Wingman4Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Solicitar circuito cerrado", Command4Menu, function() AI_ATC2:WingmanClosedTraffic(Alias, "4") end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--**************************************************************************TOWER GO AROUND**************************************************************************************--
...
function AI_ATC2:GoAroundSubMenu(Alias, modifier)
  ...
  if Proceedure=="VFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function()  end, Group)
    MENU_GROUP_COMMAND:New(Group, "Solicitar circuito cerrado", CommandMenu, function() SetApproachType("VFR") AI_ATC2:ClosedTraffic(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Solicitar regreso a radar", CommandMenu, function() SetApproachType("IFR") AI_ATC2:BackToRadar(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Aproximación frustrada", CommandMenu, function() SetApproachType("IFR") AI_ATC2:GoAround(Alias) end, Group)
  ...
  elseif Proceedure=="IFR" then
    ...
    MENU_GROUP_COMMAND:New(Group, " ", CommandMenu, function()  end, Group)
    MENU_GROUP_COMMAND:New(Group, "Solicitar regreso a radar", CommandMenu, function()SetApproachType("IFR") AI_ATC2:BackToRadar(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Aproximación frustrada", CommandMenu, function()SetApproachType("IFR") AI_ATC2:GoAround(Alias, "IFR") end, Group)
    MENU_GROUP_COMMAND:New(Group, "  ", CommandMenu, function()  end, Group)
  end
  
  if modifier then
    MENU_GROUP_COMMAND:New(Group, "Parada completa", CommandMenu, function() AI_ATC2:RollOutLanding(Alias) end, Group)
  end
...
function AI_ATC2:GCAGoAroundSubMenu(Alias, RadioObject)
  ...
  MENU_GROUP_COMMAND:New(Group, "Cancelar IFR", ApproachMenu, function() AI_ATC2:CancelIFR(Alias, "Torre") end, Group)
  ...
  if Proceedure=="VFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function() end, Group)
    MENU_GROUP_COMMAND:New(Group, "Solicitar circuito cerrado", CommandMenu, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Solicitar regreso a radar", CommandMenu, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Aproximación frustrada", CommandMenu, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
...
function AI_ATC2:TowerCheckIn2Menu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Contacto inicial", CommandMenu, function() AI_ATC2:GCATowerCheckIn(Alias) end, Group)
...
function AI_ATC2:TowerAncilleryMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group,"Tráfico a la vista", AncilaryMenu, function() AI_ATC2:AcknowledgeTraffic(Alias, true) end, Group)
  ...
  MENU_GROUP_COMMAND:New(Group,"Informar del viento", AncilaryMenu, function() AI_ATC2:TowerWinds(Alias) end, Group)
   MENU_GROUP_COMMAND:New(Group,"Salga del viraje", AncilaryMenu, function() AI_ATC2:BreakOut(Alias, NavPoint) end, Group)
...
function AI_ATC2:ParkingSubMenu(Alias)
  ...
  if Helo==false then
    MENU_GROUP_COMMAND:New(Group, "Rodar a estacionamiento", GroundMenu, function() AI_ATC2:TaxiParking(Alias) end, Group)
  elseif Helo==true then
    MENU_GROUP_COMMAND:New(Group, "Rodar a estacionamiento", GroundMenu, function() AI_ATC2:TaxiParking(Alias) end, Group)
  end
end
...
function AI_ATC2:ClearanceDelivery(Alias, Departure, Transition, Audio)
  ...
  SCHEDULER:New(nil, function()
    ...
    if RequestedProcedure=="VFR" then
       DepartureSub = "salida autorizada según plan"
      SubDuration = 9
    else
      ...
      if Transition then
        ...
        Instruction = Departure.." salida."
      end
       DepartureSub = "aeródromo Silverbow autorizado vía "..Instruction
      SubDuration = 3
    end
...
function AI_ATC2:ClearanceReadBack(Alias, code)
  ...
  local function Execute()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS["Clearance"] and AI_ATC2_MSRS["Clearance"].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, colación correcta. Contacte Tierra control antes de rodar.", spokenCallsign)
...
function AI_ATC2:HeloTaxi(Alias, Audio)
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, %s tierra. Ruede por juliett, kilo. Contacte torre manteniendo fuera de Jolly.",spokenCallsign,AI_ATC2.AirbaseAlias)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
      return
    end
...
function AI_ATC2:HoverCheck(Alias, Agency)
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:ChannelOpen(6, Transmitter, Alias)
    local Subtitle = string.format("%s: %s. Autorizado hover check. ", Title, CallsignSub)

    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, autorizado hover check.", spokenCallsign)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 4)
      return
    end
...
function AI_ATC2:VFRDeparture(Alias, Audio)
  ...
  SCHEDULER:New(nil, function()
    if Helo then
      ...
      TerminalRange = 55559
      Instruction = "Mantenga VFR. Autorizado programado, Contacte BLACKJACK, canal UHF 16."
    end
    AirbaseName = "Nellis"
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      ...
      if Helo then
        msg = msg .. " Mantenga como máximo quinientos hasta abandonar espacio aéreo de clase Delta. Autorizado programado. Contacte black jack, canal U H F sixteen."
         ...
         msg = msg .. " Mantenga V F R. Autorizado programado. Contacte black jack, canal U H F dieciséis."
      end
...
function AI_ATC2:RadarTerminate(Alias, Audio)
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, servicio radar terminado, autorizado programado. Contacte black jack canal U H F sixteen.", spokenCallsign)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
...
function AI_ATC2:VFRApproach(Alias)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      local Subtitle = string.format("%s: %s, Nellis Control. Contacto radar. Espere visual aproximación para pista %s", Title, CallsignSub, Runway )

      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC2:SRS_ConvertRunway(Runway)
        local msg = string.format("%s, Nellis Control. Contacto radar. Espere visual aproximación para pista %s.",
...
function AI_ATC2:IFRApproachType2(Alias, Type, Missed)
  ...
  local function Message()
    ...
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
       local Subtitle = string.format("%s: %s, Nellis Control. %s. Proceda directo a %s y vuele el arco DME de 16 hasta la pista %s.", Title, CallsignSub, AltSubtitle, Fix, Runway )
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        local spokenFix      = AI_ATC2:SRS_ConvertNavFix(Fix)
         ...
         local msg = string.format("%s, Nellis control, %s %s, proceda directo a %s, vuele el arco D M E de dieciséis hasta la pista %s. Informe establecido en el arco.",
...
function AI_ATC2:IFRApproachType4(Alias, Type, Missed)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control, vuele rumbo %s. %s. %s. Informe %s", Title, CallsignSub,TurnHeading, AltSubtitle, Sqwuak, Navpoint )
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(TurnHeading)
        local spokenAlt      = AI_ATC2:SRS_ConvertAltitude(AltSub)
        local spokenNavpoint = AI_ATC2:SRS_ConvertNavFix(Navpoint)
        local msg = string.format("%s, Nellis Control, vuele rumbo %s. %s %s. %s. Informe %s.",
...
function AI_ATC2:IFRApproachType5(Alias, Type, Call, Base)
  ...
  local function CorrectHeading(NewHeading)
    ...
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s GCA, vuele rumbo %s.", Title, CallsignSub, AirbaseAlias, NewHeading)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(NewHeading)
  ...
  local function FinalController()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      ...
      local spokenHeading  = AI_ATC2:SRS_ConvertHeading(tostring(RunwayHeading))
       local msg = string.format("%s, %s G C A, vire %s rumbo %s, espere al controlador final.",
...
function AI_ATC2:MissedApproach(Alias, Audio)
  ...
  local RadialTable = {
    ["14"] = {
      ["ILS"] = { filename = "340Radial.ogg", duration = 2.148, subtitle = "Intercepte el 340 radial." },
      ["RNAV"] = { filename = "340Radial.ogg", duration = 2.148, subtitle = "Intercepte el 340 radial." },
      ["TACAN"] = { filename = "340Radial.ogg", duration = 2.148, subtitle = "Intercepte el 340 radial." },
    },
    ["32"] = {
      ["TACAN"] = { filename = "325Radial.ogg", duration = 2.113, subtitle = "Intercepte el 325 radial." },
      ["ILS"] = { filename = "325Radial.ogg", duration = 2.113, subtitle = "Intercepte el 325 radial." },
      ["RNAV"] = { filename = "325Radial.ogg", duration = 2.113, subtitle = "Intercepte el 325 radial." },
    },
  }
...
function AI_ATC2:ApproachBackToRadar(Alias, Type)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s, vuele rumbo %s. %s. %s", Agency, CallsignSub, Agency, Heading, AltSubtitle, Instruction)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(Heading)
        local spokenAlt      = AI_ATC2:SRS_ConvertAltitude(AltSub)
  ...
  local function Execute()
    ...
    SCHEDULER:New(nil, function()
      ...
      if Approach=="VFR" or Approach=="Generic" then
        local Subtitle = string.format("%s: %s contactee torre en 257.950.", Title, CallsignSub)
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
          local spokenFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
          local msg = string.format("%s, contacte silverbow torre en %s.", spokenCallsign, spokenFreq)
          AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
          return
        end
      ...
      elseif Approach=="IFR" then
        local Subtitle = string.format("%s: %s Servicio radar terminado. Contacte Silverbow torre en 257.950.", Title, Callsign)
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
          local spokenFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
          local msg = string.format("%s, servicio radar terminado. Contacte torre en %s.", spokenCallsign, spokenFreq)
          AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
          return
        end
...
function AI_ATC2:CancelIFR(Alias, agency)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:CancelIFR(Alias, agency) end, Transmitter)==false then
    ...
    SCHEDULER:New(nil, function()
      ...
      local Subtitle = string.format("%s: %s, cancellation recieved, contactee torre en 257.95.", Title, CallsignSub)
  ...
  local function TowerMessage()
    SCHEDULER:New(nil, function()
      ...
      local Subtitle = string.format("%s: %s Contacte torre en 325.750.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Agency] and AI_ATC2_MSRS[Agency].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
...
function AI_ATC2:PushGCA(Alias, missed, radar)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(6, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      local Subtitle = string.format("%s: %s, Contacte Silverbow GCA en 343.725.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("SFA")
        local msg = string.format("%s, contacte Silverbow G C A en %s.", spokenCallsign, spokenFreq)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      end
...
function AI_ATC2:TowerTraffic(Alias)
  ...
  local StateTbl = {
    ...
    ["Landed on runway 14"] = {filename = "OnFinal.ogg", duration = 0.570, subtitle = "en final"},
    ["Landed on runway 32"] = {filename = "OnFinal.ogg", duration = 0.570, subtitle = "en final"},
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        if ApproachType == "Straight in" then
          msg = string.format("%s, Silverbow torre, informe cinco millas directo, pista %s.",
            spokenCallsign, spokenRunway)
        elseif ApproachType == "Instrument Straight in" then
          ...
          if TrafficType and TrafficType ~= "" and StateData and StateSub and StateSub ~= "" then
            local aircraftPhrase = AI_ATC2:SRS_ConvertAircraftType(TrafficType, RadioKey)
            msg = string.format("%s, Silverbow torre, informe cinco millas. Usted es el número %s detrás de la %s %s para pista %s.",
              spokenCallsign, spokenLandingNo, aircraftPhrase, StateSub, spokenRunway)
          else
            msg = string.format("%s, Silverbow torre, informe cinco millas para pista %s.",
              spokenCallsign, spokenRunway)
          end
        elseif ApproachType == "Overhead" then
          msg = string.format("%s, Silverbow torre, informe cinco millas inicial, pista %s.",
            spokenCallsign, spokenRunway)
        elseif ApproachType == "SFO" then
          msg = string.format("%s, Silverbow torre, pista %s. %s vire out autorizado. informe punto alto.",
            spokenCallsign, spokenRunway, string.lower(Break or ""))
        elseif ApproachType == "Deadside" then
           msg = string.format("%s, Silverbow torre, informe listo sobre la vertical para pista %s.",
            spokenCallsign, spokenRunway)
        end
...
function AI_ATC2:HeloRequestLanding(Alias, Type)
  ...
  local function ClosedCircuit()
    SCHEDULER:New(nil, function()
      ...
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      local Subtitle = string.format("%s: %s %s, Pista %s, Join %s viento de cola a or below 3900. Informe base.", Title, CallsignSub, Title, Runway, Base)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC2:SRS_ConvertRunway(Runway)
        local msg = string.format(
           "%s, torre Silverbow, pista %s. Incorpórese a viento de cola %s a tres mil novecientos pies o menos. Informe base.",
    ...
    SCHEDULER:New(nil, function()
     ...
     local Subtitle = string.format("%s: %s %s, Pista %s, Informe 3 millas.", Title, CallsignSub, Title, Runway)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC2:SRS_ConvertRunway(Runway)
       local msg = string.format("%s, Silverbow torre, pista %s. Informe tres millas.",
          spokenCallsign, spokenRunway)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        if TrafficType and StateData then
          local aircraftPhrase = AI_ATC2:SRS_ConvertAircraftType(TrafficType, RadioKey)
          msg = string.format("%s, Silverbow torre. Usted es el número %s detrás de la %s %s para pista %s. %s %s.",
            spokenCallsign, spokenLandingNo, aircraftPhrase, StateSub, spokenRunway, BreakSub, BaseSub)
        else
          msg = string.format("%s, Silverbow torre. Usted es el número %s para pista %s. %s %s.",
    ...
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        local landingWord = "autorizado procedimiento opción"
         if LandingType == "Full Stop" then landingWord = "autorizado a aterrizar"
         elseif LandingType == "Touch and Go" then landingWord = "autorizado toque y despegue"
         elseif LandingType == "Low Approach" then landingWord = "autorizado aproximación baja"
        end
...
function AI_ATC2:GoAround(Alias, Type)
  ...
  local InstructionTable = {
    ["IFR"] = {
      ["14"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Ejecute la aproximación frustrada publicada." },
      ["32"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Ejecute la aproximación frustrada publicada."  },
    },
    ["VFR"] = { 
       ["14"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Salga del viraje e informe cinco millas inicial."  },
       ["32"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Salga del viraje e informe cinco millas inicial."  },
    },
  }
  ...
  SCHEDULER:New(nil, function()
    ...
    elseif ApproachType=="IFR" then
      ...
      Instruction = AudioData.subtitle.." Contacte Nellis Control en 254.400"
...
function AI_ATC2:BackToRadar(Alias)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(10, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      local Subtitle = string.format("%s: %s Vire %s rumbo %s. Ascienda y mantenga 11000. Contacte Nellis Control en 254.400.", Title, CallsignSub, Turn, Heading)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading = AI_ATC2:SRS_ConvertHeading(Heading)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("NATCF_LEE")
        local msg = string.format("%s, vire %s rumbo %s. Ascienda y mantenga once mil. Contacte Nellis Control en %s.",
...
function AI_ATC2:TowerPAR(Alias)
  ...
  local function RunwayInSight()
    local Subtitle = string.format("%s: Copiado, pista a la vista. Contacte torre en 257.950.", Title)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
  ...
  local function OverThreshold()
    ...
    local Subtitle = string.format("%s: sobre el umbral de aterrizaje. Contacte torre en 257.950", Title)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local towerFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
...
function AI_ATC2:GCAPushTower(Alias, RadioObject)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      local Subtitle = string.format("%s: %s Contacte torre en 257.950", Title, CallsignSub)
...
function AI_ATC2:GCATowerCheckIn(Alias)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, %s torre, diga intenciones.", spokenCallsign, AI_ATC2.AirbaseAlias)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 3)
        return
      end
