...
AI_ATC2.Airstart = false

AI_ATC2.CrewChief = false
...
AI_ATC2.ParentMenu = MENU_MISSION:New("Silverbow AF", AI_ATC_.TopMenu)
...
AI_ATC2.TimeStamp = function()timer.getTime()end

AI_ATC2.LegacyProcedures = false

AI_ATC2.PARdata = {}
AI_ATC2.PendingRetry = {}

AI_ATC2.Coalition = "blue"
AI_ATC2.Airbase = "Tonopah Test Range"
AI_ATC2.AirbaseAlias = "Silverbow"
AI_ATC2.AirbaseID = AIRBASE.Nevada.Tonopah_Test_Range
AI_ATC2_Airbase = AIRBASE:FindByName("Tonopah Test Range")

AI_ATC2.Runways = { Takeoff = nil, TakeoffZone = nil, Landing = nil, LandingZone = nil, HoldShort = nil, TakeoffClearance = false }
  
AI_ATC2.MissionStart = UTILS.SecondsOfToday()

AI_ATC2.Radio = {
  ["ATIS"] = {      Key = "ATIS",         UHF = 369.4,   VHF = 113.000, UserFreq = "UHF", Transmitter = "Tonopah_ATIS" },
  ["Ground"] = {    Key = "Ground",       UHF = 335.5,   VHF = 127.250, UserFreq = "UHF", Transmitter = "Tonopah_Ground" },
  ["Clearance"] = { Key = "Clearance",    UHF = 233.95,  VHF = 119.450, UserFreq = "UHF", Transmitter = "Tonopah_Clearance" },
  ["Tower"] = {     Key = "Ground",       UHF = 257.95,  VHF = 124.750, UserFreq = "UHF", Transmitter = "Tonopah_Tower" },
  ["SFA"] =      {  Key = "Departure",    UHF = 343.725, VHF = 124.95,  UserFreq = "UHF", Transmitter = "Tonopah_Approach" },
  ["NATCF_LEE"] = { Key = "Departure",    UHF = 254.4,   VHF = 119.35,  UserFreq = "UHF", Transmitter = "Tonopah_Approach" },
}
...
AI_ATC2.Procedure = "VFR"
AI_ATC2.Departure.SID = "FYTTR 7"
AI_ATC2.Departure.VFR = "FYTTR"
AI_ATC2.Approach.PatternAltitude = "9"

AI_ATC2.TaxiWay = {  
  ["Alpha"] = {Zone = TAXIWAY_ALPHA2},
  ["Bravo"] = {Zone = TAXIWAY_BRAVO2},
  ["Charlie"] = {Zone = TAXIWAY_CHARLIE2},
  ["Delta"] = {Zone = TAXIWAY_DELTA2},
  ["Echo"] = {Zone = TAXIWAY_ECHO2},
  ["Foxtrot"] = {Zone = TAXIWAY_FOXTROT2},
}


AI_ATC2_SoundFiles = {}
AI_ATC2_SoundFiles.ATIS = {}
AI_ATC2_SoundFiles.Ground = {}
AI_ATC2_SoundFiles.Clearance = {}
AI_ATC2_SoundFiles.Departure = {}

AI_ATC2_SoundFiles.ATIS.Numerical = {
...
AI_ATC2_SoundFiles.Ground.Distance = {
...
AI_ATC2_SoundFiles.Ground.Numerical = {
...
AI_ATC2_SoundFiles.Clearance.Numerical = {
...
AI_ATC2_SoundFiles.Ground.Heading = {
...
AI_ATC2_SoundFiles.Departure.Heading = {
...
AI_ATC2_SoundFiles.Ground.FlightLevel = {
  ["40"] = { filename = "40.ogg", duration = 0.871 },
}

AI_ATC2_SoundFiles.Clearance.FlightLevel = {
...
AI_ATC2_SoundFiles.Departure.FlightLevel = {
...
AI_ATC2_SoundFiles.Departure.Numerical = {
...
AI_ATC2_SoundFiles.Ground.CallsignsNumerical = {
...
AI_ATC2_SoundFiles.Clearance.CallsignsNumerical = {
...
AI_ATC2_SoundFiles.Departure.CallsignsNumerical = {
...
AI_ATC2_SoundFiles.Ground.Oclock = {
...
AI_ATC2_SoundFiles.Departure.Oclock = {
...
AI_ATC2_SoundFiles.Departure.Cardinal2 = {
...
AI_ATC2_SoundFiles.Ground.Runway = {
...
AI_ATC2_SoundFiles.Departure.Runway = {
...
AI_ATC2_SoundFiles.Departure.SID = {
  ["ESSAA ONE"]     = {filename = "ESSAA ONE.ogg",     duration = 1.312, Subtitle = "ESSAA ONE Departure"},
  ["JAYSN ONE"]     = {filename = "JAYSN ONE.ogg",     duration = 1.300, Subtitle = "JAYSN ONE Departure"},
  ["LEAHI ONE"]     = {filename = "LEAHI ONE.ogg",     duration = 1.509, Subtitle = "LEAHI ONE Departure"},
  ["RANGE TWO"]     = {filename = "RANGE TWO.ogg",     duration = 1.207, Subtitle = "RANGE TWO Departure"},
  ["SILVER ONE"]    = {filename = "SILVER ONE.ogg",    duration = 1.358, Subtitle = "SILVER ONE Departure"},
  ["STOFF TWO"]     = {filename = "STOFF TWO.ogg",     duration = 1.196, Subtitle = "STOFF TWO Departure"},
  ["TONOPAH THREE"] = {filename = "TONOPAH THREE.ogg", duration = 1.521, Subtitle = "TONOPAH THREE Departure"},
}
  
AI_ATC2_SoundFiles.Departure.VFR = {
...
AI_ATC2_SoundFiles.Departure.NavPoint = {
  ...
  ["ESSAA"] = {filename = "ESSAA.ogg", duration = 0.481},
  ["LEAHI"] = {filename = "LEAHI.ogg", duration = 0.641},
  ["STOFF"] = {filename = "STOFF.ogg", duration = 0.557},
  ...
  ["TPHTCN"] = {filename = "Tonopah.ogg", duration = 0.647},
  ["Tonopah Test Range"] = {filename = "Tonopah Test Range.ogg", duration = 0.714},
}

AI_ATC2_SoundFiles.ATIS.PhoneticAlphabet = {
  ["A"] = "Alpha",
  ["B"] = "Bravo",
  ["C"] = "Charlie",
  ["D"] = "Delta",
...
AI_ATC2_SoundFiles.ATIS.Phonetic = {
...
AI_ATC2_SoundFiles.Ground.Phonetic = {
...
AI_ATC2_SoundFiles.Ground.ParkingRamp = {
...
AI_ATC2_SoundFiles.Ground.Aircraft = {
...
AI_ATC2_SoundFiles.Clearance.Callsigns = {
...
AI_ATC2_SoundFiles.Ground.Callsigns = {
...
AI_ATC2_SoundFiles.Departure.Callsigns = {
...
AI_ATC2_SoundFiles.ATIS.Airbase = {
...
AI_ATC2_MSRS.Numerical2 = {
  [0] = "zero", [1] = "one",   [2] = "two",   [3] = "three", [4] = "four",
  [5] = "five", [6] = "six",   [7] = "seven", [8] = "eight", [9] = "niner",
}

AI_ATC2_MSRS.RunwaySuffix = {
  ["L"] = "left",
  ["R"] = "right",
}
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
do 
  local Coord = AI_ATC2_Airbase:GetCoordinate()
  if Coord:IsDay()==true then
    AI_ATC2.Procedure = "VFR"
  else
    AI_ATC2.Procedure = "IFR"
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- Example usage
--local ZoneObject = AI_ATC2.TaxiWay["Alpha"].Zone
...
--local ZoneObject = AI_ATC2.TaxiWay["Mike"].Zone
--SaveVerticesToFile(ZoneObject, "TAXIWAY_MIKE.lua")

-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************************PRE CALCULATE TERMINAL COORDS***********************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:PrecalculateCoords(filename)
  if AI_ATC2.TerminalCoordinates then
    env.info("AI_ATC2.TerminalCoordinates already exists, not reinitializing.")
  else
    env.info("AI_ATC2.TerminalCoordinates does not exist, initializing with default values.")
  end

  AI_ATC2.TerminalCoordinates = AI_ATC2.TerminalCoordinates or {
    ["Alpha"] = {Foxtrot = {} },
    ["Bravo"] = {Foxtrot = {} },
    ["Charlie"] = {Foxtrot = {} },
    ["Echo"] = {Foxtrot = {} },
  ...
  for startTaxiway, connections in pairs(AI_ATC2.TerminalCoordinates) do
    local PrimaryVertices = AI_ATC2.TaxiWay[startTaxiway].Zone

    for endTaxiway, _ in pairs(connections) do
      local TerminalVertices = AI_ATC2.TaxiWay[endTaxiway].Zone
      ...
      AI_ATC2.TerminalCoordinates[startTaxiway][endTaxiway] = TerminalCoord
    end
  end

  return self:SaveTableToFile(AI_ATC2.TerminalCoordinates, filename)
end

function AI_ATC2:SaveTableToFile(tbl, filename)
  if io then
    local Path = "C:\\Users\\Avala\\Saved Games\\DCS\\Mods\\"
...
--  AI_ATC2:PrecalculateCoords("TerminalCoords.lua")
--end, {}, 1)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************************INITIALISE TAXIWAY TABLE****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CoordConstructor(inputTable)
  local coords = {}
...
function AI_ATC2:InitTaxiwayCoords()
  for taxiwayName, taxiwayData in pairs(AI_ATC2.TaxiWay) do
    local zoneData = taxiwayData.Zone
    local coordinates = AI_ATC2:CoordConstructor(zoneData)
    AI_ATC2.TaxiWay[taxiwayName].Zone = coordinates
  end
end

AI_ATC2:InitTaxiwayCoords()

RUNWAY_14 = AI_ATC2:CoordConstructor(RUNWAY_14)

AI_ATC2_Vec3 = COORDINATE:NewFromVec3({x=-226553.796875, y=1686.8143310547, z=-174680.25})
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--******************************************************************************EXTRACT ZONE DATA********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ExtractNavpointCoordinatesAndSave()
  ...
  AI_ATC2:SaveTableToFile(NavpointCoordinates, "NavpointCoordinates.lua")
end
--AI_ATC2:ExtractNavpointCoordinatesAndSave()
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--******************************************************************************GENERATE NAVPOINTS*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GenerateNavpoints()
  local startTime = timer.getTime()
  ...
  if not (y and m and d) then
    env.info("[AI_ATC2] Mission date string '"..tostring(dateStr).."' is invalid.")
    return
  end
  local missionNum = y * 10000 + m * 100 + d 
  
  local function GetMagDec(year)
    local v = (year and AI_ATC2_MagDec and AI_ATC2_MagDec[year]) or nil
    if v ~= nil then
      AI_ATC2.MagDec = v
      env.info(string.format("[AI_ATC2] Mission Date (%s) MagDec set from table: %.1f", dateStr, AI_ATC2.MagDec))
    else
      AI_ATC2.MagDec = 5.9
      env.info(string.format("[AI_ATC2] Mission Date (%s) MagDec missing; using fallback: %.1f", dateStr, AI_ATC2.MagDec))
    end
  end
  ...
  ATC_Coroutine:AddCoroutine(function()
    if not AI_ATC_Navpoints_Claimed then
      ...
      env.info(string.format("[AI_ATC2] Completed processing all navpoints in %.2f seconds.", elapsedTime))
    ...
    ATC_Coroutine:AddCoroutine(function()
      if missionNum < CUTOFF_NUM then
        env.info("[AI_ATC2] Legacy mission date detected ("..dateStr..") --> Using legacy charts.")
        AI_ATC2.LegacyProcedures = true
        AI_ATC2:GenerateSID()
        AI_ATC2:GenerateCharts()
      else
        env.info("[AI_ATC2] Modern mission date detected ("..dateStr..") --> Using Modern charts.")
        AI_ATC2.LegacyProcedures = false
        AI_ATC2:GenerateSID()
        AI_ATC2:GenerateCharts()
      end
...
AI_ATC2:GenerateNavpoints()
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--******************************************************************************GENERATE NAVPOINTS*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GenerateCGRS()
  local startTime = timer.getTime()
  local CUTOFF_Y, CUTOFF_M, CUTOFF_D = 2010, 5, 6
  local CUTOFF_NUM = CUTOFF_Y * 10000 + CUTOFF_M * 100 + CUTOFF_D
  local dateStr = UTILS.GetDCSMissionDate()
  ...
  ATC_Coroutine:AddCoroutine(function()
    ...
    for agencyName, agencyTable in pairs(CGRS or {}) do
      if type(agencyTable) == "table" then
          ...
          if type(cell) == "table" then
            ...
            if cell.Coord then
              ...
              elseif type(cell.Coord) ~= "table" then
                ...
                env.info(string.format(
                  "[AI_ATC2] CGRS[%s][%s].Coord not Vec2 (missing x/y).",
                  tostring(agencyName), tostring(gridName)
                ))
              end
            else
              env.info(string.format(
                "[AI_ATC2] CGRS[%s][%s] missing .Coord field.",
                tostring(agencyName), tostring(gridName)
              ))
            end
            ...
            if cell.Keypad then
              if type(cell.Keypad) == "table" then
                ...
                env.info(string.format(
                  "[AI_ATC2] CGRS[%s][%s].Keypad is not a table.",
                  tostring(agencyName), tostring(gridName)
                ))
              end
            else
              env.info(string.format(
                "[AI_ATC2] CGRS[%s][%s] missing .Keypad field.",
                tostring(agencyName), tostring(gridName)
              ))
            end
            ...
            env.info(string.format(
              "[AI_ATC2] CGRS[%s][%s] is not a table.",
              tostring(agencyName), tostring(gridName)
            ))
          end
        ...
        env.info(string.format("[AI_ATC2] CGRS[%s] is not a table.", tostring(agencyName)))
      end
    end
    if AI_C2_ then AI_C2_.PermitStart = true end
    local elapsed = timer.getTime() - startTime
    env.info(string.format(
      "[AI_ATC2] Completed processing CGRS: agencies=%d grids=%d convertedCells=%d convertedKeypads=%d in %.2f seconds.",
...
--******************************************************************************SPAWN TRANSMITTERS*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--AI_ATC2_Transmitter_Data = AI_ATC2:CoordConstructor(AI_ATC2_Transmitter_Data)
--AI_ATC2_Repeater_Data = AI_ATC2:CoordConstructor(AI_ATC2_Repeater_Data)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_ATIS"
Template.x = ATIS_Coord2.x
Template.y = ATIS_Coord2.y
Template.units[1].x = ATIS_Coord2.x
Template.units[1].y = ATIS_Coord2.y
Template.units[1].name = "Tonopah_ATIS"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_Tower"
Template.x = Tower_Coord2.x
Template.y = Tower_Coord2.y
Template.units[1].x = Tower_Coord2.x
Template.units[1].y = Tower_Coord2.y
Template.units[1].name = "Tonopah_Tower"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_Ground"
Template.x = Ground_Coord2.x
Template.y = Ground_Coord2.y
Template.units[1].x = Ground_Coord2.x
Template.units[1].y = Ground_Coord2.y
Template.units[1].name = "Tonopah_Ground"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_Approach"
Template.x = Approach_Coord2.x
Template.y = Approach_Coord2.y
Template.units[1].x = Approach_Coord2.x
Template.units[1].y = Approach_Coord2.y
Template.units[1].name = "Tonopah_Approach"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_Departure"
Template.x = Departure_Coord2.x
Template.y = Departure_Coord2.y
Template.units[1].x = Departure_Coord2.x
Template.units[1].y = Departure_Coord2.y
Template.units[1].name = "Tonopah_Departure"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_Clearance"
Template.x = Clearance_Coord2.x
Template.y = Clearance_Coord2.y
Template.units[1].x = Clearance_Coord2.x
Template.units[1].y = Clearance_Coord2.y
Template.units[1].name = "Tonopah_Clearance"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_ATIS_Repeater"
Template.x = ATIS_REPEATER_Coord2.x
Template.y = ATIS_REPEATER_Coord2.y
Template.units[1].x = ATIS_REPEATER_Coord2.x
Template.units[1].y = ATIS_REPEATER_Coord2.y
Template.units[1].name = "Tonopah_ATIS_Repeater"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

local Template = GENERIC_TRANSMITTER
Template.name = "Tonopah_Generic_Repeater"
Template.x = Generic_Repeater_Coord2.x
Template.y = Generic_Repeater_Coord2.y
Template.units[1].x = Generic_Repeater_Coord2.x
Template.units[1].y = Generic_Repeater_Coord2.y
Template.units[1].name = "Tonopah_Generic_Repeater"
coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)

if not AI_ATC_Transmitters then
  AI_ATC_Transmitters = AI_ATC2_Transmitters
  
  for index, transmitterData in pairs(AI_ATC2_Transmitters) do
    local CoordData = AI_ATC2_Transmitter_Data[index]
    local Template
    ...
    coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)
    AI_ATC2_Transmitters[index].COMM1 = Template.units[1].name
  end
  
  for index, transmitterData in pairs(AI_ATC2_Transmitters) do
    local CoordData = AI_ATC2_Repeater_Data[index]
    local Template
    Template = GENERIC_TRANSMITTER
    ...
    coalition.addGroup(country.id.CJTF_BLUE, Group.Category.GROUND, Template)
    AI_ATC2_Transmitters[index].Repeater = Template.units[1].name
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--********************************************************************************MSRS INTEGRATION*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Set_MSRS(Agency, MSRS, speed, voices)
  if AI_ATC2_MSRS and AI_ATC2_MSRS[Agency] then
    AI_ATC2_MSRS[Agency].MSRS = MSRS
    AI_ATC2_MSRS[Agency].Active = true
    AI_ATC2_MSRS[Agency].Queue = MSRSQUEUE:New(Agency)
    AI_ATC2_MSRS[Agency].Speed = speed
    if voices then
...
--********************************************************************************MSRS INTEGRATION*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TransmitSRS(Agency, text, delay, speed, radioObject, subtitle, duration)
  if AI_ATC2_MSRS and AI_ATC2_MSRS[Agency] and AI_ATC2_MSRS[Agency].Queue then
    local Radio = AI_ATC2_MSRS[Agency].Queue
    local msrs  = AI_ATC2_MSRS[Agency].MSRS
    if not speed then
      speed = AI_ATC2_MSRS[Agency].Speed
    end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertHeading(hdg)
...
--*****************************************************************************MSRS CONVERT DIGITS*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertDigits(str)
  if not str then return "" end
  str = tostring(str)
  local words = {}
  for i = 1, #str do
    local c = str:sub(i, i)
    if AI_ATC2_MSRS.Numerical[c] then
      words[#words + 1] = AI_ATC2_MSRS.Numerical[c]
    elseif c == "." then
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertFrequency(agency)
  if not agency or not AI_ATC2.Radio[agency] then return "" end
  local radio = AI_ATC2.Radio[agency]
...
--*****************************************************************************MSRS CONVERT RUNWAY*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertRunway(rwy)
  ...
  for i = 1, #rwy do
    ...
    if AI_ATC2_MSRS.Numerical[c] then
      words[#words + 1] = AI_ATC2_MSRS.Numerical[c]
    elseif AI_ATC2_MSRS.RunwaySuffix[c:upper()] then
      words[#words + 1] = AI_ATC2_MSRS.RunwaySuffix[c:upper()]
    end
  end
  return table.concat(words, " ")
end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertAltitude(alt)
  ...
  if thousands > 0 then
    if thousands >= 10 then
      ...
      words[#words + 1] = AI_ATC2_MSRS.Numerical2[thousands]
    end
    words[#words + 1] = "thousand"
  end
  if hundreds > 0 then
    words[#words + 1] = AI_ATC2_MSRS.Numerical2[hundreds]
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertCallsign(cs)
  if not cs then return "" end
  cs = tostring(cs)
  if cs == "" then return "" end

  local numerical = (AI_ATC2_MSRS and AI_ATC2_MSRS.Numerical) or {}
...
--********************************************************************************MSRS DEPARTURES********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertNavFix(fix)
  if not fix then return "" end
  return AI_ATC2_MSRS.NavFix[fix] or fix
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*************************************************************************MSRS CONVERT APPROACH TEXT****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertApproachInstruction(text, runway)
  ...
  if spokenRunway ~= "" then
    spokenText = spokenText:gsub("[Rr]unway%s+%d%d?[LRC]?", "runway " .. spokenRunway)
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertClockBearing(bearing)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertAircraftType(aircraftType, radioKey)
  if not aircraftType then return "traffic" end
  radioKey = radioKey or "Ground"

  local radioSounds = AI_ATC2_SoundFiles[radioKey]
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SRS_ConvertSpotNumber(spot)
  if not spot then return "" end
  local inputString = nil

  for _, parkingTable in ipairs({ Tonopah_ParkingSpot }) do
  ...
  if string.match(first, "%a") then
    local phonetic = AI_ATC2_SoundFiles.ATIS.PhoneticAlphabet[first]
    if phonetic then
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ConvertTerminalCoordinates()
  for startTaxiway, destinations in pairs(AI_ATC2_TerminalCoordinates) do
    for endTaxiway, vec3Data in pairs(destinations) do
      AI_ATC2_TerminalCoordinates[startTaxiway][endTaxiway] = COORDINATE:New(vec3Data.x, vec3Data.y, vec3Data.z)
    end
  end
end
AI_ATC2:ConvertTerminalCoordinates()
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*******************************************************************************HOLD SHORT ZONES********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HoldShortZones()
  for runway, positions in pairs(HoldShortData2) do
    for index, coord in ipairs(positions) do
      ...
      HoldShortData2[runway][index] = zone
    end
  end
end
AI_ATC2:HoldShortZones()
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*******************************************************************************HOLD SHORT ZONES********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RunwayGuardZones()
  for runway, positions in pairs(RunwayGuard2) do
    for index, coord in ipairs(positions) do
      local zoneName = string.format("RunwayGuard_%s_%d", runway, index)
      local zone = ZONE_RADIUS:New(zoneName, {x = coord.x, y = coord.y}, 50)
      RunwayGuard2[runway][index] = zone
    end
  end
end
AI_ATC2:RunwayGuardZones()
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************************ATC STANDARD INTERNATIONAL DEPARTURE***************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GenerateSID()
  AI_ATC2.SID = {
    ["14"] = {
      ["ESSAA ONE"] = {
        Altitude = "18",
        Radial = "214",
        Instruction = {file = "RightESSAA.ogg",    duration = 1.393, Subtitle = "Turn right direct ESSAA"},
        NAVPOINTS = {
      ...
      ["JAYSN ONE"] = {
        Altitude = "18",
        Radial = "204",
        Instruction = {file = "DirectJAYSN.ogg",    duration = 2.171, Subtitle = "Proceed direct JAYSN"},
        NAVPOINTS = {
      ...
      ["LEAHI ONE"] = {
        Altitude = "18",
        Radial = "204",
        Instruction = {file = "DirectLEAHI.ogg",    duration = 2.402, Subtitle = "Proceed direct LEAHI"},
        NAVPOINTS = {
      ...
      ["RANGE TWO"] = {
        Altitude = "10",
        Radial = "204",
        Instruction = {file = "DirectTONOPAH.ogg",    duration = 1.625, Subtitle = "Proceed direct Tonopah"},
        NAVPOINTS = {
      ...
      ["STOFF TWO"] = {
        Altitude = "10",
        Radial = "204",
        Instruction = {file = "137Radial.ogg",    duration = 2.183, Subtitle = "Intercept the 137 radial"},
        NAVPOINTS = {
    ...
    ["32"] = {
      ["ESSAA ONE"] = {
        Altitude = "18",
        Radial = "214",
        Instruction = {file = "LeftESSAA.ogg",    duration = 2.078, Subtitle = "Turn left direct ESSAA"},
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.ESSAA
        },
      },
      ["JAYSN ONE"] = {
        Altitude = "18",
        Radial = "204",
        Instruction = {file = "LeftJAYSN.ogg",    duration = 2.171, Subtitle = "Left turn, direct JAYSN"},
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.JAYSN,
        }
      },
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GenerateVFR()
  AI_ATC2.VFR = {
    ["Fixed"] = {
      ["14"] = {
        Altitude = "7000",
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints["14_FAF"],
        }
      },
      ["32"] = {
        Altitude = "7000",
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints["32_FAF"],
        }
      }
    },
    ["Helo"] = {
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GeneratePlates()
  AI_ATC2.ApproachPlates = {
    ["Fixed"] = {
      ["14"] = {
        Altitude = "7000",
        NAVPOINTS = {
...
--****************************************************************************ATC APPROACH CHARTS********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GenerateCharts()
  AI_ATC2.Charts = {
    ["14"] = {
      ["TACAN"] = {
        Altitude = "12.5",
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.COPAR,
          [2] = AI_ATC_Navpoints.LOZMO,
          [3] = AI_ATC_Navpoints.HUGER,
        }
      },
      ["ILS"] = {
        Altitude = "12.5",
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.JEPAR,
          [2] = AI_ATC_Navpoints.JANAV,
          [3] = AI_ATC_Navpoints.OSRIE,
        }
      },
      ["RNAV"] = {
        Altitude = "9.8",
    ...
    ["32"] = {
      ["TACAN"] = {
        Altitude = "12.5",
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.HUBON,
          [2] = AI_ATC_Navpoints.IRAVE,
          [3] = AI_ATC_Navpoints.ITAVE,
          [4] = AI_ATC_Navpoints.ITOGE,
        }
      },
      ["ILS"] = {
        Altitude = "12.5",
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.JESVO,
          [2] = AI_ATC_Navpoints.JIREM,
          [3] = AI_ATC_Navpoints.DRAKO,
          [4] = AI_ATC_Navpoints.PALAE,
          [5] = AI_ATC_Navpoints.WATLU,
        }
      },
      ["RNAV"] = {
        Altitude = "9.8",
        NAVPOINTS = {
          [1] = AI_ATC_Navpoints.JIREM,
          [2] = AI_ATC_Navpoints.DRAKO,
          [3] = AI_ATC_Navpoints.RUDII,
          [4] = AI_ATC_Navpoints.FALAK,
        }
      },
    }
  }
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*************************************************************************TONOPAH RUNWAY INITIALISE****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
AI_ATC2.Runways.Landing = {"32", true}
AI_ATC2.Runways.LandingZone = RUNWAY_14
AI_ATC2.Runways.Takeoff = {"14", false}
AI_ATC2.Runways.TakeoffZone = RUNWAY_32
AI_ATC2.Runways.TakeoffHold = false
--AI_ATC2.Runways.HoldShort = {"03R_HoldShort_1", "03R_HoldShort_2"}
--AI_ATC2.Runways.RunwayGuard = {"03R_Guard_1", "03R_Guard_2"}
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SCHEDULER:New(nil, function()
  coalition.addGroup(country.id.CJTF_BLUE, Group.Category.AIRPLANE, Tonopah_Runway_init)
end, {}, 3)
...
SCHEDULER:New(nil, function()
  ...
  local ReferenceTable = {
    ["14"] = {
      trueHeading    = 157,
      ZoneObject     = RUNWAY_14,
      Coordinate     = RUNWAY_14[13],
      Waypoint       = "DRAKO",
      SID            = "JAYSN ONE",
      Transition     = "",
      Recovery       = "COPAR",
    ...
    ["32"] = {
      trueHeading    = 337,
      ZoneObject     = RUNWAY_32,
      Coordinate     = RUNWAY_32[1],
      Waypoint       = "JANAV",
      SID            = "JAYSN ONE",
      Transition     = "",
      Recovery       = "HUBON",
  ...
  local unit = UNIT:FindByName("Tonopah_Runway_init")
  ...
  AI_ATC2.Runways.Takeoff     = { bestRunway, true,  bestData.Coordinate, bestData.trueHeading }
  AI_ATC2.Runways.Takeoff[5]  = AI_ATC2:CalculateRunwayHeading(bestData.trueHeading)
  AI_ATC2.Runways.TakeoffZone = bestData.ZoneObject

  local wpZone = AI_ATC_Navpoints and AI_ATC_Navpoints[bestData.Waypoint]
  if wpZone then
    AI_ATC2.Runways.Waypoint = wpZone:GetCoordinate()
  end

  AI_ATC2.Departure = AI_ATC2.Departure or {}
  if AI_ATC2.LegacyProcedures == true then
    AI_ATC2.Departure.SID        = "BAGRAM ONE"
    AI_ATC2.Departure.Transition = "LEIGH"
  else
    AI_ATC2.Departure.SID        = bestData.SID
    AI_ATC2.Departure.Transition = bestData.Transition
  end

  AI_ATC2.Runways.Landing     = { bestRunway, false, bestData.Coordinate, bestData.trueHeading }
  AI_ATC2.Runways.Landing[5]  = AI_ATC2:CalculateRunwayHeading(bestData.trueHeading)
  AI_ATC2.Runways.LandingZone = bestData.ZoneObject

  AI_ATC2.Runways.Heliport = { bestData.HeliportRunway, false, bestData.HeliportCoord, bestData.trueHeading }
  AI_ATC2.Runways.Heliport[5] = AI_ATC2:CalculateRunwayHeading(bestData.trueHeading)
  AI_ATC2.Runways.HeliportZone = bestData.HeliportZone

  AI_ATC2.Recovery = bestData.Recovery
  
end, {}, 7)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*****************************************************************************CALCULATE RUNWAY HEADING**************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CalculateRunwayHeading(num)
  if not num or not AI_ATC2.MagDec then return nil end

  local heading = num - AI_ATC2.MagDec
...
--***********************************************************************************ATIS STOP**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:StopATIS()
  AI_ATC2.ATIS.Data.FC3switch = true
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--****************************************************************************Silverbow ATIS***************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
AI_ATC2.ATIS.Data = {
  AirBase       = AI_ATC2.Airbase,
  Information   = nil,
  ZULU          = nil,
  WindSpeed     = nil,
  WindDirection = nil,
...
--****************************************************************************INITIALIZE ATIS************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:InitATIS()
  local Frequecy = AI_ATC2.Radio.ATIS[AI_ATC2.Radio.ATIS.UserFreq]
  local startTime = timer.getTime()
  ...
  if atisRepeaterUnit then
    ...
    if transmitterRadio then
      local radioObject = transmitterRadio:NewUnitTransmission("UHF_NOISE.ogg", nil, nil, AI_ATC2.Radio.ATIS[Frequecy], radio.modulation.AM, true)
      radioObject:Broadcast()
    end
  end

  ATC_Coroutine:AddCoroutine(function()
    local data   = AI_ATC2.ATIS.Data
    local base   = AI_ATC2_Airbase
    local pres   = AI_ATC2_CloudPresets
    local runDep = AI_ATC2.Runways and AI_ATC2.Runways.Takeoff
    local runArr = AI_ATC2.Runways and AI_ATC2.Runways.Landing

    if not base or not runDep or not runArr then
      env.warning("AI_ATC2:InitATIS -> Missing essential references (AI_ATC2_Airbase or Runways).")
      return
    end
    ...
    local natoLetter = AI_ATC2_NatoTime[hourIdx]
    ...
    local windDirection = AI_ATC2:RectifyHeading(tostring(math.floor(windDirRaw + 0.5)))
    ...
    env.info(string.format("AI_ATC2:InitATIS -> ATIS data calculated in %.2f seconds.", duration))
  end)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--****************************************************************************INITIALISE RADIOS**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:InitRadios()
  local Frequency = AI_ATC2.RadioFrequency
  
  ATIS_RADIO2 = RADIOQUEUE:New(AI_ATC2.Radio.ATIS[AI_ATC2.Radio.ATIS.UserFreq], 0)
  ATIS_RADIO2:SetSenderUnitName(AI_ATC2.Radio.ATIS.Transmitter)
  ATIS_RADIO2:Start()

  ATIS_REPEATER2 = RADIOQUEUE:New(AI_ATC2.Radio.ATIS[AI_ATC2.Radio.ATIS.UserFreq], 0)
  ATIS_REPEATER2:SetSenderUnitName("ATIS_Repeater2")
  ATIS_REPEATER2:Start()
  
  GROUND_RADIO2 = RADIOQUEUE:New(AI_ATC2.Radio.Ground[AI_ATC2.Radio.Ground.UserFreq], 0)
  GROUND_RADIO2:SetSenderUnitName(AI_ATC2.Radio.Ground.Transmitter)
  GROUND_RADIO2:Start()
  
  CLEARANCE_RADIO2 = RADIOQUEUE:New(AI_ATC2.Radio.Clearance[AI_ATC2.Radio.Clearance.UserFreq], 0)
  CLEARANCE_RADIO2:SetSenderUnitName(AI_ATC2.Radio.Clearance.Transmitter)
  CLEARANCE_RADIO2:Start()
  
  TOWER_RADIO2 = RADIOQUEUE:New(AI_ATC2.Radio.Tower[AI_ATC2.Radio.Tower.UserFreq], 0)
  TOWER_RADIO2:SetSenderUnitName(AI_ATC2.Radio.Tower.Transmitter)
  TOWER_RADIO2:Start()
...
--***********************************************************************************SET RADIOS TO VHF **************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SetRadioFrequency(Agency, Range)
  if AI_ATC2.Radio[Agency] and (Range=="UHF" or Range=="VHF") then
    AI_ATC2.Radio[Agency].UserFreq = Range
  else
...
--***********************************************************************************FUNCTION DELAY******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:FunctionDelay(Alias, Object, Transmitter, delay)
  local Delay = delay or 3.0
  local currentTime = timer.getTime()
  
  AI_ATC2[Transmitter] = AI_ATC2[Transmitter] or {}
  AI_ATC2[Transmitter].TimeSinceLastCall = AI_ATC2[Transmitter].TimeSinceLastCall or 0
  if currentTime < AI_ATC2[Transmitter].TimeSinceLastCall + Delay then
    if Object~=nil then
      AI_ATC2.PendingRetry = AI_ATC2.PendingRetry or {}
      local retryKey = Alias .. "_" .. Transmitter
      if not AI_ATC2.PendingRetry[retryKey] then
        AI_ATC2.PendingRetry[retryKey] = true
        SCHEDULER:New(nil, function()
          AI_ATC2.PendingRetry[retryKey] = nil
          Object()
        end, {}, Delay)
      end
    end
    ...
    if Object then
      AI_ATC2[Transmitter].TimeSinceLastCall = currentTime
    end
    return true
  end
end
...
--*********************************************************************************INIT MENUS************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:InitMenus(Alias)
  local ClientData = ATM2.ClientData[Alias]
  ...
  local DepartureMenu = MENU_GROUP:New(Group, "NATCF (Departure)", AI_ATC_Menu)
  local ApproachMenu = MENU_GROUP:New(Group, "NATCF (Approach)", AI_ATC_Menu)
  ...
  ATM2.ClientData[Alias].ClearanceMenu = AI_ATC_Clearance_Menu
  ATM2.ClientData[Alias].GroundMenu = AI_ATC_Ground_Menu
  ATM2.ClientData[Alias].TowerMenu = AI_ATC_Tower_Menu
  ATM2.ClientData[Alias].DepartureMenu = DepartureMenu
  ATM2.ClientData[Alias].OtherAgency = Agency
  ATM2.ClientData[Alias].ApproachMenu = ApproachMenu
  ATM2.ClientData[Alias].RepeatMenu = RepeatMenu
  ATM2.ClientData[Alias].JoinGroupMenu = JoinGroupMenu
  
  AI_ATC2:JoinGroup(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*********************************************************************************RESET MENUS***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ResetMenus(Alias)
  local Client = ATM2.ClientData[Alias]
...
--*********************************************************************************REMOVE MENUS***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RemoveMenus(Alias)
  local Client = ATM2.ClientData[Alias]
...
--*********************************************************************************RESET MENUS***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GenerateEmptyMenu(Alias, Transmitter, count)
  local Unit = ATM2.ClientData[Alias].Unit
  local Group = Unit:GetGroup()
  local MenuObject, Variable, Blank
  
  if Transmitter == "Approach" or Transmitter == "SFA" then
    MenuObject = ATM2.ClientData[Alias].ApproachMenu
  elseif Transmitter == "Tower" then
    MenuObject = ATM2.ClientData[Alias].TowerMenu
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RepeatLastTransmission(Alias, Object)
  local Unit = ATM2.ClientData[Alias].Unit
  local Group = Unit:GetGroup()
  local MenuObject = ATM2.ClientData[Alias].RepeatMenu
...
--***********************************************************************************CLEARANCE SUB MENU**************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ClearanceSubMenu(Alias)

  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local Helo = ATM2.ClientData[Alias].Helo
  local Runway = AI_ATC2.Runways.Takeoff[1]
  local AI_ATC2_Menu = ATM2.ClientData[Alias].ParentMenu
  local AI_ATC2_Clearance_Menu = ATM2.ClientData[Alias].ClearanceMenu
  local AI_ATC2_Departure_Menu = MENU_GROUP:New(Group, "Departure...", AI_ATC2_Clearance_Menu)
  local AI_ATC2_VFR_Menu, AI_ATC2_IFR_Menu
  
  local function GenerateSIDMenus()
    local takeoffRWY = AI_ATC2.Runways.Takeoff[1]
    local sidSet     = AI_ATC2.SID[takeoffRWY]
    if not sidSet then return end

    local sidNames = {}
    for sidName in pairs(sidSet) do
      table.insert(sidNames, sidName)
    end
    table.sort(sidNames)
  
    for _, sidName in ipairs(sidNames) do
      local sidRecord = sidSet[sidName]
      if sidRecord.NAVPOINTS then
        MENU_GROUP_COMMAND:New(Group, sidName, AI_ATC2_IFR_Menu, function() AI_ATC2:IFR_Clearance(Alias, sidName, nil) end, Group)
      else
        local sidMenu = MENU_GROUP:New(Group, sidName, AI_ATC2_IFR_Menu)
        local transitionNames = {}
        for transName in pairs(sidRecord) do
          table.insert(transitionNames, transName)
        end
        table.sort(transitionNames)
    
        for _, transName in ipairs(transitionNames) do
          MENU_GROUP_COMMAND:New(Group, transName, sidMenu, function() AI_ATC2:IFR_Clearance(Alias, sidName, transName) end, Group)
        end
      end
    end
  end
  ...
  if Helo==false then
    if AI_ATC2.Procedure == "VFR" then

      MENU_GROUP_COMMAND:New(Group, "VFR...", AI_ATC2_Departure_Menu, function() AI_ATC2:VFR_Clearance(Alias) end, Group)
      AI_ATC2_IFR_Menu = MENU_GROUP:New(Group, "IFR...", AI_ATC2_Departure_Menu)

      GenerateSIDMenus()
    elseif AI_ATC2.Procedure == "IFR" then
      MENU_GROUP_COMMAND:New(Group, "", AI_ATC2_Departure_Menu, function() end, Group)
      GenerateSIDMenus()
    end
  elseif Helo==true then
    if Runway=="32" then
      AI_ATC2_VFR_Menu = MENU_GROUP_COMMAND:New(Group, "VFR...", AI_ATC2_Departure_Menu, function() AI_ATC2:VFR_Clearance(Alias) end, Group)
    else
      AI_ATC2_VFR_Menu = MENU_GROUP_COMMAND:New(Group, "VFR...", AI_ATC2_Departure_Menu, function() AI_ATC2:VFR_Clearance(Alias) end, Group)
    end
  end
  
  local OptionsMenu = MENU_GROUP:New(Group, "Options...", AI_ATC2_Clearance_Menu)
  ...
  ----------------------------------------------------------------------------------------------------------------------
  if not Helo then
    MENU_GROUP_COMMAND:New(Group, "Aspen", Menu1, function() AI_ATC2:SetCallsign(Alias, "Aspen",   "11") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Mig",   Menu2, function() AI_ATC2:SetCallsign(Alias, "Mig",   "11") end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, "Pedro", Menu1, function() AI_ATC2:SetCallsign(Alias, "Pedro",   "11") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Razor", Menu2, function() AI_ATC2:SetCallsign(Alias, "Razor",   "11") end, Group)
  end
  MENU_GROUP_COMMAND:New(Group, "Chaos", Menu1, function() AI_ATC2:SetCallsign(Alias, "Chaos",           "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Cylon", Menu1, function() AI_ATC2:SetCallsign(Alias, "Cylon",           "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Dragon", Menu1, function() AI_ATC2:SetCallsign(Alias, "Dragon",         "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "GunFighter", Menu1, function() AI_ATC2:SetCallsign(Alias, "GunFighter", "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Nightmare", Menu1, function() AI_ATC2:SetCallsign(Alias, "Nightmare",   "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Eagle",  Menu1, function() AI_ATC2:SetCallsign(Alias, "Eagle",          "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Viper",  Menu1, function() AI_ATC2:SetCallsign(Alias, "Viper",          "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Hornet", Menu1, function() AI_ATC2:SetCallsign(Alias, "Hornet",         "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Slayer", Menu1, function() AI_ATC2:SetCallsign(Alias, "Slayer",         "11") end, Group)
  ----------------------------------------------------------------------------------------------------------------------
  MENU_GROUP_COMMAND:New(Group, "Stalin",  Menu2, function() AI_ATC2:SetCallsign(Alias, "Stalin",        "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Flanker", Menu2, function() AI_ATC2:SetCallsign(Alias, "Flanker",       "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Fulcrum", Menu2, function() AI_ATC2:SetCallsign(Alias, "Fulcrum",       "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Flogger", Menu2, function() AI_ATC2:SetCallsign(Alias, "Flogger",       "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Ivan",    Menu2, function() AI_ATC2:SetCallsign(Alias, "Ivan",          "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Grape",    Menu2, function() AI_ATC2:SetCallsign(Alias, "Grape",        "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Strelka",  Menu2, function() AI_ATC2:SetCallsign(Alias, "Strelka",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Skalpel",  Menu2, function() AI_ATC2:SetCallsign(Alias, "Skalpel",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Rapier",   Menu2, function() AI_ATC2:SetCallsign(Alias, "Rapier",       "11") end, Group)
  ----------------------------------------------------------------------------------------------------------------------
  MENU_GROUP_COMMAND:New(Group, "Sniper",  Menu3, function() AI_ATC2:SetCallsign(Alias, "Sniper",        "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Rage",  Menu3, function() AI_ATC2:SetCallsign(Alias, "Rage",            "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Venom", Menu3, function() AI_ATC2:SetCallsign(Alias, "Venom",           "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Jedi", Menu3, function() AI_ATC2:SetCallsign(Alias, "Jedi",             "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Sting", Menu3, function() AI_ATC2:SetCallsign(Alias, "Sting",           "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Snake",    Menu3, function() AI_ATC2:SetCallsign(Alias, "Snake",        "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Heavy",    Menu3, function() AI_ATC2:SetCallsign(Alias, "Heavy",        "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Raygun",  Menu3, function() AI_ATC2:SetCallsign(Alias, "Raygun",        "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Cupcake",  Menu3, function() AI_ATC2:SetCallsign(Alias, "Cupcake",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Hawk",   Menu3, function() AI_ATC2:SetCallsign(Alias, "Hawk",           "11") end, Group)
  ----------------------------------------------------------------------------------------------------------------------
  MENU_GROUP_COMMAND:New(Group, "Simca",      Menu4, function() AI_ATC2:SetCallsign(Alias, "Simca",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Comet",      Menu4, function() AI_ATC2:SetCallsign(Alias, "Comet",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Razor",      Menu4, function() AI_ATC2:SetCallsign(Alias, "Razor",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Digger",     Menu4, function() AI_ATC2:SetCallsign(Alias, "Digger",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Sabre",      Menu4, function() AI_ATC2:SetCallsign(Alias, "Sabre",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Pirate",     Menu4, function() AI_ATC2:SetCallsign(Alias, "Pirate",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Cannon",     Menu4, function() AI_ATC2:SetCallsign(Alias, "Cannon",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Buckshot",   Menu4, function() AI_ATC2:SetCallsign(Alias, "Buckshot",   "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Maple",      Menu4, function() AI_ATC2:SetCallsign(Alias, "Maple",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Hellcat",    Menu4, function() AI_ATC2:SetCallsign(Alias, "Hellcat",    "11") end, Group)
  ----------------------------------------------------------------------------------------------------------------------
  MENU_GROUP_COMMAND:New(Group, "Sundowner",  Menu5, function() AI_ATC2:SetCallsign(Alias, "Sundowner",  "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Camelot",    Menu5, function() AI_ATC2:SetCallsign(Alias, "Camelot",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Witchita",   Menu5, function() AI_ATC2:SetCallsign(Alias, "Witchita",   "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Dog",         Menu5, function() AI_ATC2:SetCallsign(Alias, "Dog",       "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Lion",        Menu5, function() AI_ATC2:SetCallsign(Alias, "Lion",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Tomcat",      Menu5, function() AI_ATC2:SetCallsign(Alias, "Tomcat",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Retro",       Menu5, function() AI_ATC2:SetCallsign(Alias, "Retro",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Ghostrider",  Menu5, function() AI_ATC2:SetCallsign(Alias, "Ghostrider","11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Dealer",      Menu5, function() AI_ATC2:SetCallsign(Alias, "Dealer",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Dagger",      Menu5, function() AI_ATC2:SetCallsign(Alias, "Dagger",    "11") end, Group)
  ----------------------------------------------------------------------------------------------------------------------
  MENU_GROUP_COMMAND:New(Group, "Hammer",     Menu6, function() AI_ATC2:SetCallsign(Alias, "Hammer",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Voodoo",     Menu6, function() AI_ATC2:SetCallsign(Alias, "Voodoo",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Wildman",    Menu6, function() AI_ATC2:SetCallsign(Alias, "Wildman",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Ugly",       Menu6, function() AI_ATC2:SetCallsign(Alias, "Ugly",       "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Gunstar",    Menu6, function() AI_ATC2:SetCallsign(Alias, "Gunstar",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Felix",       Menu6, function() AI_ATC2:SetCallsign(Alias, "Felix",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Gypsy",       Menu6, function() AI_ATC2:SetCallsign(Alias, "Gypsy",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Black",       Menu6, function() AI_ATC2:SetCallsign(Alias, "Black",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Knight",      Menu6, function() AI_ATC2:SetCallsign(Alias, "Knight",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Black Knight",Menu6, function()AI_ATC2:SetCallsign(Alias, "Black Knight","11")end, Group)
  ----------------------------------------------------------------------------------------------------------------------
  MENU_GROUP_COMMAND:New(Group, "Phantom",     Menu7, function() AI_ATC2:SetCallsign(Alias, "Phantom",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Bogey",       Menu7, function() AI_ATC2:SetCallsign(Alias, "Bogey",      "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Wolf",     Menu7, function() AI_ATC2:SetCallsign(Alias, "Wolf",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Vixen",    Menu7, function() AI_ATC2:SetCallsign(Alias, "Vixen",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Cargo",    Menu7, function() AI_ATC2:SetCallsign(Alias, "Cargo",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Warrior",  Menu7, function() AI_ATC2:SetCallsign(Alias, "Warrior",  "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Anvil",    Menu7, function() AI_ATC2:SetCallsign(Alias, "Anvil",    "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Apache",   Menu7, function() AI_ATC2:SetCallsign(Alias, "Apache",   "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Hawg",     Menu7, function() AI_ATC2:SetCallsign(Alias, "Hawg",     "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Boar",     Menu7, function() AI_ATC2:SetCallsign(Alias, "Boar",     "11") end, Group)
  ----------------------------------------------------------------------------------------------------------------------
  MENU_GROUP_COMMAND:New(Group, "1",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "11") end, Group)
  MENU_GROUP_COMMAND:New(Group, "2",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "21") end, Group)
  MENU_GROUP_COMMAND:New(Group, "3",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "31") end, Group)
  MENU_GROUP_COMMAND:New(Group, "4",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "41") end, Group)
  MENU_GROUP_COMMAND:New(Group, "5",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "51") end, Group)
  MENU_GROUP_COMMAND:New(Group, "6",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "61") end, Group)
  MENU_GROUP_COMMAND:New(Group, "7",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "71") end, Group)
  MENU_GROUP_COMMAND:New(Group, "8",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "81") end, Group)
  MENU_GROUP_COMMAND:New(Group, "9",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "91") end, Group)
  MENU_GROUP_COMMAND:New(Group, "0",   Menu10, function() AI_ATC2:SetCallsign(Alias, nil, "01") end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************************CLEARANCE READBACK SUBMENU**************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadBackSubMenu(Alias)

  local ClientData              = ATM2.ClientData[Alias]
  local Group                   = ClientData.Group
  local Unit                    = ClientData.Unit
  local Group                   = Unit:GetGroup()
  local AI_ATC2_Menu             = ClientData.ParentMenu
  local AI_ATC2_Clearance_Menu   = ClientData.ClearanceMenu
  local SchedulerObjects        = ClientData.SchedulerObjects
  local Helo                    = ClientData.Helo
  local squawk                  = ClientData.Squawk
  
  local AI_ATC2_Readback_Menu = MENU_GROUP:New(Group, "ReadBack...", AI_ATC2_Clearance_Menu)
  local OptionsMenu    = MENU_GROUP:New(Group, "Options...", AI_ATC2_Clearance_Menu)
  local CallsignMenu   = MENU_GROUP:New(Group, "Set Callsign...", OptionsMenu)
  
  if squawk and string.find(squawk, "001", 1, true) then
    MENU_GROUP_COMMAND:New(Group, "Squawk 1001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "1001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 2001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "2001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 3001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "3001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 4001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "4001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 5001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "5001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 6001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "6001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 7001",   AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, "7001") end, Group)
  else
    local Subtitle = string.format("Squawk %s", squawk)
    local Squawking = tostring(squawk)
    MENU_GROUP_COMMAND:New(Group, Subtitle, AI_ATC2_Readback_Menu, function() AI_ATC2:ClearanceReadBack(Alias, Squawking) end, Group)
  end
...
--***********************************************************************************CLEARANCE SUB MENU**************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SeperateFromGroup(Alias)
  local Group = GROUP:FindByName(Alias)
  local Menu = MENU_GROUP:New(Group, "Seperate from Group", AI_ATC2.ParentMenu)
  
  MENU_GROUP_COMMAND:New(Group, "Seperate from group", Menu, function() AI_ATC2:SeperateGroup(Alias, Menu) end, Group)
  
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************GROUND -  ENGINE START SUBMENU**************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GroundStartSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Ground_Menu = ATM2.ClientData[Alias].GroundMenu
  MENU_GROUP_COMMAND:New(Group, "Request Engine Start", AI_ATC2_Ground_Menu, function() AI_ATC2:EngineStart(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************GROUND - TAXI SUB MENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local Helo = ATM2.ClientData[Alias].Helo
  
  local AI_ATC2_Ground_Menu = ATM2.ClientData[Alias].GroundMenu
  local AI_ATC2_Tower_Menu = ATM2.ClientData[Alias].TowerMenu
  if Helo==false then
    MENU_GROUP_COMMAND:New(Group, "Request Engine Start", AI_ATC2_Ground_Menu, function() AI_ATC2:EngineStart(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Taxi clearance", AI_ATC2_Ground_Menu, function()AI_ATC2:TaxiClearance(Alias) end, Group)
  elseif Helo==true then
    MENU_GROUP_COMMAND:New(Group, "Request Engine Start", AI_ATC2_Ground_Menu, function() AI_ATC2:EngineStart(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Taxi clearance", AI_ATC2_Ground_Menu, function()AI_ATC2:TaxiClearance(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Hover check", AI_ATC2_Ground_Menu, function()AI_ATC2:HoverCheck(Alias, "Ground") end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Takeoff from parking", AI_ATC2_Tower_Menu, function()AI_ATC2:TakeoffFromParking(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER TAKEOFF SUB MENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CrossRunwaySubMenu(Alias, Runway)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Tower_Menu = ATM2.ClientData[Alias].TowerMenu
  
  local Menu = string.format("Request clearance to cross %s", Runway)
  MENU_GROUP_COMMAND:New(Group, Menu, AI_ATC2_Tower_Menu, function() AI_ATC2:CrossRunway(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER TAKEOFF SUB MENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:LandingHoldSubMenu(Alias, Runway)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Ground_Menu = ATM2.ClientData[Alias].GroundMenu
  
  local Menu = string.format("Request clearance to cross %s", Runway)
  MENU_GROUP_COMMAND:New(Group, Menu, AI_ATC2_Ground_Menu, function() AI_ATC2:CrossRunwayLanding(Alias, Runway) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER JOLLYPAD SUBMENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CrossPadSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Tower_Menu = ATM2.ClientData[Alias].TowerMenu
  
  MENU_GROUP_COMMAND:New(Group, "Request clearance to pad", AI_ATC2_Tower_Menu, function() AI_ATC2:TakePad(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************GROUND - HOVER CHECK**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HoverSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Tower_Menu = ATM2.ClientData[Alias].TowerMenu
  local HoverMenu = MENU_GROUP_COMMAND:New( Group, "Request hover check", AI_ATC2_Tower_Menu, function()AI_ATC2:HoverCheck(Alias, "Tower") end, Group)
  
  ATM2.ClientData[Alias].TowerMenu = AI_ATC2_Tower_Menu
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER TAKEOFF SUB MENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeloTakeOffSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Tower_Menu = ATM2.ClientData[Alias].TowerMenu
  
  MENU_GROUP_COMMAND:New(Group, "Request Takeoff", AI_ATC2_Tower_Menu, function()AI_ATC2:HeloTakeoff(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER TAKEOFF SUB MENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TakeOffSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AI_ATC2_Tower_Menu = ATM2.ClientData[Alias].TowerMenu
  local Helo = ATM2.ClientData[Alias].Helo
  
  MENU_GROUP_COMMAND:New(Group, "Request Takeoff", AI_ATC2_Tower_Menu, function()AI_ATC2:TakeoffClearance(Alias) end, Group)
  if not Helo then
    local ClimbMenu = MENU_GROUP:New(Group, "Unrestricted climb", AI_ATC2_Tower_Menu)
    ...
    MENU_GROUP_COMMAND:New(Group, "5000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "5000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "6000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "6000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "7000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "7000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "8000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "8000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "9000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "9000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "10000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "10000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "11000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "11000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "12000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "12000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "13000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "13000") end, Group)
  
    MENU_GROUP_COMMAND:New(Group, "14000", ClimbMenu1, function() AI_ATC2:TakeoffClearance(Alias, "14000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "15000", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "15000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "16000", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "16000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "17000", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "17000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL180", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "18000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL190", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "19000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL200", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "20000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL210", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "21000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL220", ClimbMenu2, function() AI_ATC2:TakeoffClearance(Alias, "22000") end, Group)
  
    MENU_GROUP_COMMAND:New(Group, "FL230", ClimbMenu3, function() AI_ATC2:TakeoffClearance(Alias, "23000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL240", ClimbMenu3, function() AI_ATC2:TakeoffClearance(Alias, "24000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL250", ClimbMenu3, function() AI_ATC2:TakeoffClearance(Alias, "25000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL260", ClimbMenu3, function() AI_ATC2:TakeoffClearance(Alias, "26000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL270", ClimbMenu3, function() AI_ATC2:TakeoffClearance(Alias, "27000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL280", ClimbMenu3, function() AI_ATC2:TakeoffClearance(Alias, "28000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL290", ClimbMenu3, function() AI_ATC2:TakeoffClearance(Alias, "29000") end, Group)
  
    MENU_GROUP_COMMAND:New(Group, "FL300", ClimbMenu4, function() AI_ATC2:TakeoffClearance(Alias, "30000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL310", ClimbMenu4, function() AI_ATC2:TakeoffClearance(Alias, "31000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL320", ClimbMenu4, function() AI_ATC2:TakeoffClearance(Alias, "32000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL330", ClimbMenu4, function() AI_ATC2:TakeoffClearance(Alias, "33000") end, Group)
    MENU_GROUP_COMMAND:New(Group, "FL340", ClimbMenu4, function() AI_ATC2:TakeoffClearance(Alias, "34000") end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************DEPARTURE SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:DepartureSubMenu(Alias, missed)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local DepartureMenu = ATM2.ClientData[Alias].DepartureMenu
  local AppraochMenu = ATM2.ClientData[Alias].ApproachMenu
  local Randomizer = math.random(1,3)
  
  if Randomizer==1 and missed~=true then
    MENU_GROUP_COMMAND:New(Group, "Check in", DepartureMenu, function() AI_ATC2:DepartureIdent(Alias) end, Group)
  elseif Randomizer~=1 and missed~=true then
    MENU_GROUP_COMMAND:New(Group, "Check in", DepartureMenu, function() AI_ATC2:DepartureCheckin(Alias) end, Group)
  elseif missed==true then
    MENU_GROUP_COMMAND:New(Group, "Check in", AppraochMenu, function() AI_ATC2:MissedApproach(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************DEPARTURE IDENT SUB MENU********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IdentSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local DepartureMenu = ATM2.ClientData[Alias].DepartureMenu
  
  MENU_GROUP_COMMAND:New(Group, "Flash", DepartureMenu, function() AI_ATC2:DepartureCheckin(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************DEPARTURE SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:NavigationSubMenu(Alias, Modifier)

  local ClientData = ATM2.ClientData[Alias]
  if not ClientData or not ClientData.Unit then
    env.warning(("AI_ATC2:NavigationSubMenu --> bad ClientData for '%s'"):format(Alias))
    return
  end
  ...
  if Procedure == "VFR" then
    ...
    local vfrBranch  = AI_ATC2.VFR[branch][Runway]
    ...
    if branch == "Helo" then
      for _, navpoint in ipairs(navTable) do
        if navpoint and navpoint.GetName then
          ...
          MENU_GROUP_COMMAND:New(Group, "Report "..name, ReportMenu, function() AI_ATC2:RadarTerminate(Alias) end, Group)
          MENU_GROUP_COMMAND:New(Group, "Vectors for "..name, NavPoint, function() AI_ATC2:NavAssist(Alias, name, Transmitter) end, Group)
        end
      end

    else
      MENU_GROUP_COMMAND:New(Group, "Report Anchor point", ReportMenu, function() AI_ATC2:RadarTerminate(Alias) end, Group)
  ...
  elseif Procedure=="IFR" then
    SID = ClientData.SID
    local SIDNode = AI_ATC2.SID[Runway][SID]
    ...
    MENU_GROUP_COMMAND:New(Group, Report, ReportMenu, function()AI_ATC2:RadarTerminate(Alias) end, Group)
    ...
    for index, navpoint in ipairs(Navpoints) do
      if navpoint and navpoint.GetName then
        ...
        elseif Name=="BLANK" then
          ...
          MENU_GROUP_COMMAND:New(Group, Subtitle, NavPoint, function() AI_ATC2:NavAssist(Alias, Name, Transmitter) end, Group)
        end
      end
    end
  end
  ...
  AI_ATC2:AirfieldMenus(Transmitter, Alias, AirfieldMenu)

  MENU_GROUP_COMMAND:New(Group, "Request Approach", DepartureMenu, function() AI_ATC2:RequestApproach(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************APPROACH SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ApproachSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local Helo = ATM2.ClientData[Alias].Helo
  local Procedure = AI_ATC2.Procedure
  
  local AppraochMenu = ATM2.ClientData[Alias].ApproachMenu
  local CheckInMenu = MENU_GROUP:New(Group, "Check in...", AppraochMenu)
  if Helo then
    MENU_GROUP_COMMAND:New(Group, "VFR", CheckInMenu, function() AI_ATC2:ApproachCheckIn(Alias, "VFR") end, Group)
  else
    if Procedure=="VFR" then
      MENU_GROUP_COMMAND:New(Group, "VFR", CheckInMenu, function() AI_ATC2:ApproachCheckIn(Alias, "VFR") end, Group)
      MENU_GROUP_COMMAND:New(Group, "IFR", CheckInMenu, function() AI_ATC2:ApproachCheckIn(Alias, "IFR") end, Group)
    else
      MENU_GROUP_COMMAND:New(Group, "VFR", CheckInMenu, function() AI_ATC2:ApproachCheckIn(Alias, "VFR") end, Group)
      MENU_GROUP_COMMAND:New(Group, "IFR", CheckInMenu, function() AI_ATC2:ApproachCheckIn(Alias, "IFR") end, Group)
    end
...
--***********************************************************************APPROACH TYPE MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ApproachTypeMenu(Alias)

  local Group        = ATM2.ClientData[Alias].Unit:GetGroup()
  local Procedure    = AI_ATC2.Procedure
  local Runway       = AI_ATC2.Runways.Landing[1]
  local ApproachMenu = ATM2.ClientData[Alias].ApproachMenu
  local IFRMenu      = MENU_GROUP:New(Group, "IFR...", ApproachMenu)
  
  MENU_GROUP_COMMAND:New(Group, "Cancel IFR", ApproachMenu, function() AI_ATC2:CancelIFR(Alias) end, Group)
  
  local function GenerateIFRMenus()
    if Runway == "14" then
      MENU_GROUP_COMMAND:New(Group, "",               IFRMenu, function()                                             end, Group)
      MENU_GROUP_COMMAND:New(Group, " ",              IFRMenu, function()                                             end, Group)
      MENU_GROUP_COMMAND:New(Group, "TAC14",          IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "TACAN")    end, Group)
      MENU_GROUP_COMMAND:New(Group, "TAC14 Final",    IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "TACAN")    end, Group)
      MENU_GROUP_COMMAND:New(Group, "ILS\\LOC",       IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "ILS")      end, Group)
      MENU_GROUP_COMMAND:New(Group, "ILS\\LOC Final", IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "ILS")      end, Group)
      MENU_GROUP_COMMAND:New(Group, "  ",             IFRMenu, function()                                             end, Group)
      MENU_GROUP_COMMAND:New(Group, "RNAV",           IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "RNAV")     end, Group)
    elseif Runway == "32" then
      MENU_GROUP_COMMAND:New(Group, "",               IFRMenu, function()                                             end, Group)
      MENU_GROUP_COMMAND:New(Group, " ",              IFRMenu, function()                                             end, Group)
      MENU_GROUP_COMMAND:New(Group, "TAC32",          IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "TACAN")    end, Group)
      MENU_GROUP_COMMAND:New(Group, "TAC32 Final",    IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "TACAN")    end, Group)
      MENU_GROUP_COMMAND:New(Group, "ILS\\LOC",       IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "ILS")      end, Group)
      MENU_GROUP_COMMAND:New(Group, "ILS\\LOC Final", IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "ILS")      end, Group)
      MENU_GROUP_COMMAND:New(Group, "  ",             IFRMenu, function()                                             end, Group)
      MENU_GROUP_COMMAND:New(Group, "RNAV",           IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "RNAV")     end, Group)
    end
    MENU_GROUP_COMMAND:New(Group, "Request GCA", IFRMenu, function() AI_ATC2:PushGCA(Alias) end, Group)
  end
...
--***************************************************************************GCA SUBMENU****************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GCASubMenu(Alias, missed, modifier)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  
  local AppraochMenu = ATM2.ClientData[Alias].ApproachMenu
  if not modifier then
    MENU_GROUP_COMMAND:New(Group, "GCA Check in", AppraochMenu, function() AI_ATC2:IFRApproachType5(Alias, "PAR") end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, "GCA Check in", AppraochMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "PAR") end, Group)
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:B2CheckInSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local AppraochMenu = ATM2.ClientData[Alias].ApproachMenu

  MENU_GROUP_COMMAND:New(Group, "Check in", AppraochMenu, function() AI_ATC2:B2RCheckIn(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--******************************************************************APPROACH BACK TO RADAR SUB MENU******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:BackToRadarSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local ActiveRunway = AI_ATC2.Runways.Landing[1]
  ...
  if ActiveRunway=="14" then
    MENU_GROUP_COMMAND:New(Group, TacSub, IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, TacFinal, IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, "ILS\\LOC", IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "ILS") end, Group)
    MENU_GROUP_COMMAND:New(Group, "ILS\\LOC Final", IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "ILS") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request GCA", IFRMenu, function() AI_ATC2:PushGCA(Alias, true, true) end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, TacSub, IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, TacFinal, IFRMenu, function() AI_ATC2:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, "", IFRMenu, function()  end, Group)
...
--***********************************************************************APPROACH NAV ASSIST*************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ApproachAssistMenu(Alias, report)
  local Transmitter = "NATCF_LEE"
  local ClientData = ATM2.ClientData[Alias]
  local Group = ClientData.Unit:GetGroup()
  local Helo = ClientData.Helo
  ...
  local function SetApproachType(Type)
    ATM2.ClientData[Alias].Approach.Type = Type
  end
  ...
  if Procedure=="VFR" then
    if Helo then
      ReferenceTable = AI_ATC2.ApproachPlates["Helo"][Runway].NAVPOINTS
      MENU_GROUP_COMMAND:New(Group, "", ApproachMenu, function() end, Group)
    else
      ReferenceTable = AI_ATC2.ApproachPlates["Fixed"][Runway].NAVPOINTS
      MENU_GROUP_COMMAND:New(Group, "Request IFR Pickup", ApproachMenu, function() SetApproachType("IFR") AI_ATC2:IFRApproach(Alias) end, Group)
    end
  elseif Procedure=="IFR" then
    Recovery = ATM2.ClientData[Alias].Recovery
    Chart = ATM2.ClientData[Alias].Chart
    if AI_ATC2.Charts[Runway][Chart] then
      ReferenceTable = AI_ATC2.Charts[Runway][Chart].NAVPOINTS
    end
    if report then
      if arc==true then
      ...
      MENU_GROUP_COMMAND:New(Group, MenuTxt, ApproachMenu, function() AI_ATC2:ApproachReportFix(Alias, true) end, Group)
    else
      MENU_GROUP_COMMAND:New(Group, "Cancel IFR", ApproachMenu, function() AI_ATC2:CancelIFR(Alias) end, Group)
    end
  end
  ...
  if ReferenceTable then
    for index, navpoint in ipairs(ReferenceTable) do
      if navpoint and navpoint.GetName then
        ...
        if Name=="14_FAF" or Name=="32_FAF" then
          Subtitle = "Final"
        else
          Subtitle = Name
        end
        ...
        elseif Name=="BLANK" then
          ...
          local Subtitle = "Vectors for " .. Name
          MENU_GROUP_COMMAND:New(Group, Subtitle, VectorMenu, function() AI_ATC2:NavAssist(Alias, Name, Transmitter) end, Group)
        end
      end
    end
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:VectorToFinal(Alias, Tbl, Transmitter)

  local CleintData = ATM2.ClientData[Alias]
  local Group = CleintData.Unit:GetGroup()
  local AI_ATC2_Menu = CleintData.ParentMenu
  ...
  MENU_GROUP_COMMAND:New(Group, "Radar Downwind", VectorMenu, function() AI_ATC2:NavAssist(Alias, Downwind, Transmitter, "Downwind") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Radar Base", VectorMenu, function() AI_ATC2:NavAssist(Alias, Base, Transmitter, "Base") end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************APPROACH SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CancelIFRSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:MissedApproachMenu(Alias)
  local Transmitter = "NATCF_LEE"
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local ApproachMenu = ATM2.ClientData[Alias].ApproachMenu
  local IFRMenu = MENU_GROUP:New(Group, "IFR", ApproachMenu)
  local Type = ATM2.ClientData[Alias].Chart
  local Runway = AI_ATC2.Runways.Landing[1]
  local Modifier
  if AI_ATC2.LegacyProcedures==true then
    Modifier = "Legacy"
  ...
  local ApproachData = ApproachSettings2[Modifier][Runway][Type]
  ...
  if Runway == "14" then
    MENU_GROUP_COMMAND:New(Group, Procedure1,       IFRMenu, function() AI_ATC2:NavAssist(Alias, Navpoint, Transmitter)     end, Group)
    MENU_GROUP_COMMAND:New(Group, Procedure4,       IFRMenu, function() AI_ATC2:RequestDeparture(Alias)                     end, Group)
    MENU_GROUP_COMMAND:New(Group, "TAC05",          IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "TACAN", true)      end, Group)
    MENU_GROUP_COMMAND:New(Group, "TAC05 Final",    IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "TACAN")            end, Group)
    MENU_GROUP_COMMAND:New(Group, "ILS\\LOC",       IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "ILS", true)        end, Group)
    MENU_GROUP_COMMAND:New(Group, "ILS\\LOC Final", IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "ILS")              end, Group)
  elseif Runway == "32" then
    MENU_GROUP_COMMAND:New(Group, Procedure1,       IFRMenu, function() AI_ATC2:NavAssist(Alias, Navpoint, Transmitter)     end, Group)
    MENU_GROUP_COMMAND:New(Group, Procedure4,       IFRMenu, function() AI_ATC2:RequestDeparture(Alias)                     end, Group)
    MENU_GROUP_COMMAND:New(Group, "TAC23",          IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "TACAN", true)      end, Group)
    MENU_GROUP_COMMAND:New(Group, "TAC23 Final",    IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "TACAN")            end, Group)
    MENU_GROUP_COMMAND:New(Group, "ILS\\LOC",       IFRMenu, function() AI_ATC2:IFRApproachType4(Alias, "ILS", true)        end, Group)
    MENU_GROUP_COMMAND:New(Group, "ILS\\LOC Final", IFRMenu, function() AI_ATC2:IFRApproachType3(Alias, "ILS")              end, Group)
  end
  MENU_GROUP_COMMAND:New(Group, "Request GCA", IFRMenu, function() AI_ATC2:PushGCA(Alias, true) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*******************************************************************TOWER LANDING SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:LandingSubMenu(Alias, Modifier)
  local ClientData    = ATM2.ClientData[Alias]
  local Group         = ClientData.Unit:GetGroup()
  ...
  if Helo~=true then
    if ApproachType == "VFR" then
      MENU_GROUP_COMMAND:New(Group, "Straight In", CommandMenu, function() AI_ATC2:StraightIn(Alias) end, Group)
      MENU_GROUP_COMMAND:New(Group, "Overhead", CommandMenu, function() AI_ATC2:Overhead(Alias) end, Group)
      MENU_GROUP_COMMAND:New(Group, "SFO", CommandMenu, function() AI_ATC2:SFO(Alias) end, Group)
      MENU_GROUP_COMMAND:New(Group, "High Tactical Overhead", CommandMenu, function() AI_ATC2:Deadside(Alias) end, Group)
      if Modifier then
        MENU_GROUP_COMMAND:New(Group, "Request Departure", CommandMenu, function() AI_ATC2:RadarVectorDeparture(Alias) end, Group)
      end
    elseif ApproachType == "IFR" then
      MENU_GROUP_COMMAND:New(Group, "Instrument Straight In", CommandMenu, function() AI_ATC2:InstrumentStraightIn(Alias) end, Group)
      if Modifier then
        MENU_GROUP_COMMAND:New(Group, "  ", CommandMenu, function() end, Group)
        MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function() AI_ATC2:RadarVectorDeparture(Alias) end, Group)
      end
    end
  else
    MENU_GROUP_COMMAND:New(Group, "Straight In", CommandMenu, function() AI_ATC2:HeloRequestLanding(Alias, "Straight In") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Closed traffic", CommandMenu, function() AI_ATC2:HeloRequestLanding(Alias, "Closed traffic") end, Group)
  end
  ATM2.ClientData[Alias].TowerMenu = TowerMenu
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER REPORT INITIAL************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:InitialSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Report", TowerMenu)
  local InitialMenu = MENU_GROUP:New(Group, "Report 5 mile", CommandMenu)
  MENU_GROUP_COMMAND:New(Group, "Full Stop", InitialMenu, function() AI_ATC2:RequestFullStop(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", InitialMenu, function() AI_ATC2:RequestTouchGo(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", InitialMenu, function() AI_ATC2:RequestLowApproach(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", InitialMenu, function() AI_ATC2:RequestOption(Alias) end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER REPORT INITIAL************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:OverheadInitialSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local Procedure = ATM2.ClientData[Alias].Landing.Procedure
  local MenuText
  if Procedure=="Deadside" then
    MenuText = "Report ready overhead"
  else
    MenuText = "Report initial"
  end
  local CommandMenu = MENU_GROUP:New(Group, "Report", TowerMenu)
  MENU_GROUP_COMMAND:New(Group, MenuText, CommandMenu, function() AI_ATC2:Report5MileInitial(Alias) end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER REPORT HIGH KEY***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReportHighKeyMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Report", TowerMenu)
  MENU_GROUP_COMMAND:New(Group, "Report High Key", CommandMenu, function() AI_ATC2:ReportKey(Alias, "High") end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER REPORT LOW KEY***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReportLowKeyMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Report", TowerMenu)
  MENU_GROUP_COMMAND:New(Group, "Report Low Key", CommandMenu, function() AI_ATC2:ReportKey(Alias, "Low") end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER REPORT INITIAL************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReportBaseSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Report", TowerMenu)
  local BaseMenu = MENU_GROUP:New(Group, "Report base", CommandMenu)
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu, function() AI_ATC2:RequestFullStop(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu, function() AI_ATC2:RequestTouchGo(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu, function() AI_ATC2:RequestLowApproach(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu, function() AI_ATC2:RequestOption(Alias) end, Group)
  AI_ATC2:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************HELO REPORT BASE************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeloBaseSubMenu(Alias, Type)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  if Type=="Closed traffic" then
    MENU_GROUP_COMMAND:New(Group, "Report base", TowerMenu, function() AI_ATC2:HeloBase(Alias) end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, "Report 3 miles", TowerMenu, function() AI_ATC2:HeloBase(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*******************************************************************TOWER WINGMAN REPORT INITIAL********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:WingmanBaseSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local Agency = ATM2.ClientData[Alias].OtherAgency
  local Wingman2Menu = MENU_GROUP:New(Group, "Wingman #2", Agency)
  local CommandMenu = MENU_GROUP:New(Group, "Report", Wingman2Menu)
  local BaseMenu = MENU_GROUP:New(Group, "Report base", CommandMenu)
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu, function() AI_ATC2:WingmanReportBase(Alias, "Full Stop", "2") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu, function() AI_ATC2:WingmanReportBase(Alias, "Touch and Go", "2") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu, function() AI_ATC2:WingmanReportBase(Alias, "Low Approach", "2") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu, function() AI_ATC2:WingmanReportBase(Alias, "Option", "2") end, Group)
  
  ATM2.ClientData[Alias].Wingman2Menu = Wingman2Menu
  ...
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu3, function() AI_ATC2:WingmanReportBase(Alias, "Full Stop", "3") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu3, function() AI_ATC2:WingmanReportBase(Alias, "Touch and Go", "3") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu3, function() AI_ATC2:WingmanReportBase(Alias, "Low Approach", "3") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu3, function() AI_ATC2:WingmanReportBase(Alias, "Option", "3") end, Group)
  
  ATM2.ClientData[Alias].Wingman3Menu = Wingman3Menu
  ...
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu4, function() AI_ATC2:WingmanReportBase(Alias, "Full Stop", "4") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu4, function() AI_ATC2:WingmanReportBase(Alias, "Touch and Go", "4") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu4, function() AI_ATC2:WingmanReportBase(Alias, "Low Approach", "4") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu4, function() AI_ATC2:WingmanReportBase(Alias, "Option", "4") end, Group)
  
  ATM2.ClientData[Alias].Wingman4Menu = Wingman4Menu
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--******************************************************************TOWER WINGMAN REQUEST CLOSED*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:WingmanClosedSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local Agency = ATM2.ClientData[Alias].OtherAgency
  
  local Wingman2Menu = ATM2.ClientData[Alias].Wingman2Menu
  if Wingman2Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", Command2Menu, function() AI_ATC2:WingmanClosedTraffic(Alias, "2") end, Group)
  end
  
  local Wingman3Menu = ATM2.ClientData[Alias].Wingman3Menu
  if Wingman3Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", Command3Menu, function() AI_ATC2:WingmanClosedTraffic(Alias, "3") end, Group)
  end
  
  local Wingman4Menu = ATM2.ClientData[Alias].Wingman4Menu
  if Wingman4Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", Command4Menu, function() AI_ATC2:WingmanClosedTraffic(Alias, "4") end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--**************************************************************************TOWER GO AROUND**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GoAroundSubMenu(Alias, modifier)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local Runway = AI_ATC2.Runways.Landing[1]
  local ApproachType = ATM2.ClientData[Alias].Approach.Type
  local Proceedure = AI_ATC2.Procedure
  ...
  local function SetApproachType(type)
    ATM2.ClientData[Alias].RequestedProcedure = type
    ATM2.ClientData[Alias].Recovery =Recovery
    ATM2.ClientData[Alias].Approach.Type = type
    ATM2.ClientData[Alias].Chart = "TACAN"
  end
  ...
  if Proceedure=="VFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function()  end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", CommandMenu, function() SetApproachType("VFR") AI_ATC2:ClosedTraffic(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function() SetApproachType("IFR") AI_ATC2:BackToRadar(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Missed Approach", CommandMenu, function() SetApproachType("IFR") AI_ATC2:GoAround(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, Subtitle, CommandMenu, function() SetApproachType("VFR") AI_ATC2:GoAround(Alias) end, Group)
  elseif Proceedure=="IFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function()  end, Group)
    MENU_GROUP_COMMAND:New(Group, " ", CommandMenu, function()  end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function()SetApproachType("IFR") AI_ATC2:BackToRadar(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Missed Approach", CommandMenu, function()SetApproachType("IFR") AI_ATC2:GoAround(Alias, "IFR") end, Group)
    MENU_GROUP_COMMAND:New(Group, "  ", CommandMenu, function()  end, Group)
  end
  
  if modifier then
    MENU_GROUP_COMMAND:New(Group, "Full stop", CommandMenu, function() AI_ATC2:RollOutLanding(Alias) end, Group)
  end
...
--**************************************************************************TOWER GO AROUND**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GCAGoAroundSubMenu(Alias, RadioObject)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local ApproachMenu = ATM2.ClientData[Alias].ApproachMenu
  local Runway = AI_ATC2.Runways.Landing[1]
  local ApproachType = ATM2.ClientData[Alias].Approach.Type
  ...
  MENU_GROUP_COMMAND:New(Group, "Cancel IFR", ApproachMenu, function() AI_ATC2:CancelIFR(Alias, "Tower") end, Group)
  ...
  if Proceedure=="VFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function() end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", CommandMenu, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Missed Approach", CommandMenu, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
    MENU_GROUP_COMMAND:New(Group, Subtitle, CommandMenu, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
  elseif Proceedure=="IFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function() end, Group)
    MENU_GROUP_COMMAND:New(Group, " ", CommandMenu, function()  end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function()AI_ATC2:GCAPushTower(Alias, RadioObject) end, Group)
...
--**************************************************************************TOWER CHECK IN***************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TowerCheckIn2Menu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Request", TowerMenu)

  MENU_GROUP_COMMAND:New(Group, "Check In", CommandMenu, function() AI_ATC2:GCATowerCheckIn(Alias) end, Group)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:NavpointSubMenu(Alias)
  local Group = ATM2.ClientData[Alias].Unit:GetGroup()
  local Runway = AI_ATC2.Runways.Landing[1]
  local Subtitle
  
  Subtitle = "Report Initial"
  
  local TowerMenu = ATM2.ClientData[Alias].TowerMenu
  MENU_GROUP_COMMAND:New(Group, Subtitle, TowerMenu, function() AI_ATC2:SayIntentions(Alias) end, Group)

end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************************AI_ATC2 TOWER ANCILLARY MENU*************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TowerAncilleryMenu(Alias)
  ...
  local NavPoint
  local TowerController = ATM2.TowerControl[Alias]
  if TowerController and TowerController.RequestedApproach=="SFO" then
    NavPoint = "NORTH POINT"
  end
  
  MENU_GROUP_COMMAND:New(Group,"Traffic in sight", AncilaryMenu, function() AI_ATC2:AcknowledgeTraffic(Alias, true) end, Group)
  MENU_GROUP_COMMAND:New(Group,"No Joy", AncilaryMenu, function() AI_ATC2:AcknowledgeTraffic(Alias, false) end, Group)
  MENU_GROUP_COMMAND:New(Group,"Acknowledge Extend Downwind", AncilaryMenu, function() AI_ATC2:AcknowledgeExtend(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group,"Say Winds", AncilaryMenu, function() AI_ATC2:TowerWinds(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group,"Break Out", AncilaryMenu, function() AI_ATC2:BreakOut(Alias, NavPoint) end, Group)

end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*************************************************************************PARKING SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ParkingSubMenu(Alias)
  local ClientData = ATM2.ClientData[Alias]
  local Group = ClientData.Unit:GetGroup()
  ...
  if Helo==false then
    MENU_GROUP_COMMAND:New(Group, "Taxi to Parking", GroundMenu, function() AI_ATC2:TaxiParking(Alias) end, Group)
  elseif Helo==true then
    MENU_GROUP_COMMAND:New(Group, "Taxi to Parking", GroundMenu, function() AI_ATC2:TaxiParking(Alias) end, Group)
  end
end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:VFR_Clearance(Alias, Direction)
  ATM2.ClientData[Alias].RequestedProcedure = "VFR"
  --ATM2.ClientData[Alias].DepartureDirection = Direction
  AI_ATC2:ClearanceDelivery(Alias)
end


function AI_ATC2:IFR_Clearance(Alias, sidName, transName)
  ATM2.ClientData[Alias].RequestedProcedure = "IFR"
  ATM2.ClientData[Alias].SID = sidName
  ATM2.ClientData[Alias].Transition = transName
  AI_ATC2:ClearanceDelivery(Alias, sidName, transName)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--****************************************************************************ATC TOWER CHECKIN MENU*****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:InstrumentStraightIn(Alias)
  ATM2.ClientData[Alias].Landing.Procedure = "Instrument Straight in"
  AI_ATC2:Tower_Checkin(Alias)
end

function AI_ATC2:RequestPAR(Alias)
  ATM2.ClientData[Alias].Landing.Procedure = "Instrument Straight in"
  AI_ATC2:TowerPAR(Alias)
end

function AI_ATC2:StraightIn(Alias)
  ATM2.ClientData[Alias].Landing.Procedure = "Straight in"
  AI_ATC2:Tower_Checkin(Alias)
end

function AI_ATC2:Overhead(Alias)
  ATM2.ClientData[Alias].Landing.Procedure = "Overhead"
  AI_ATC2:Tower_Checkin(Alias)
end

function AI_ATC2:SFO(Alias)
  ATM2.ClientData[Alias].Landing.Procedure = "SFO"
  AI_ATC2:Tower_Checkin(Alias)
end

function AI_ATC2:Deadside(Alias)
  ATM2.ClientData[Alias].Landing.Procedure = "Deadside"
  AI_ATC2:Tower_Checkin(Alias)
end

function AI_ATC2:RequestFullStop(Alias)
  ATM2.ClientData[Alias].Landing.Type = "Full Stop"
  AI_ATC2:ReportInitial(Alias)
end

function AI_ATC2:RequestTouchGo(Alias)
  ATM2.ClientData[Alias].Landing.Type = "Touch and Go"
  AI_ATC2:ReportInitial(Alias)
end

function AI_ATC2:RequestLowApproach(Alias)
  ATM2.ClientData[Alias].Landing.Type = "Low Approach"
  AI_ATC2:ReportInitial(Alias)
end

function AI_ATC2:RequestOption(Alias)
  ATM2.ClientData[Alias].Landing.Type = "Option"
  AI_ATC2:ReportInitial(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************************AI_ATC2 SET CALLSIGN*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SetCallsign(Alias, Callsign, Integer, squawk)
  ...
  local function NormalizeSquawk(squawk)
    ...
    if not string.match(squawk, "^[0-7][0-7][0-7][0-7]$") then
      env.warning(string.format("AI_ATC2:SetCallsign -> Invalid squawk code '%s' for %s. Expected four octal digits 0000-7777.", squawk, Alias))
      return nil
    end
  ...
  if SquawkCode then
    ...
    env.info(string.format("AI_ATC2:SetCallsign -> Stored custom transponder %s for %s", SquawkCode, Alias))
  end
  ...
  if not Callsign and Integer then
    ...
    elseif CurrentCallsign then
      ...
      env.warning(string.format("AI_ATC2:SetCallsign -> Cannot update callsign number for %s. No existing callsign and group object not available.", Alias))
    end
  ...
  if NewCallsign then
    ...
    env.info(string.format("AI_ATC2:SetCallsign -> Stored custom callsign %s for %s", NewCallsign, Alias))
  end

  if not GroupObject then
    env.info(string.format("AI_ATC2:SetCallsign -> Group object for %s not currently available. Custom callsign/transponder will be applied by InitClients when active.", Alias))
    return
  end

  if ATM2.ClientData[Alias] then
    local Unit = ATM2.ClientData[Alias].Unit
    if Unit then
    ...
    if NewCallsign then
      ATM2.ClientData[Alias].Callsign = NewCallsign
    end

    if SquawkCode then
      ATM2.ClientData[Alias].Squawk = SquawkCode
      env.info(string.format("AI_ATC2:SetCallsign -> Updated active transponder for %s to %s", Alias, SquawkCode))
    end
  ...
  if AI_ATC and ATM and ATM.ClientData[Alias] then
    ...
    env.info(string.format("AI_ATC2:SetCallsign -> Mirrored callsign/transponder to AI_ATC for %s", Alias))
  end
  ...
  if AI_ATC3 and ATM3.ClientData[Alias] then
    ...
    env.info(string.format("AI_ATC2:SetCallsign -> Mirrored callsign/transponder to AI_ATC3 for %s", Alias))
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*****************************************************************************AI_ATC2 VALIDATE FLIGHTGROUP**********************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ValidateFlightGroups()
  ...
  for groupName, groupTable in pairs(AI_ATC_.FlightGroup) do
    ...
    if not hostExists then
      ...
      for initiatorAlias, _ in pairs(groupTable) do
        env.info(string.format("AI_ATC2:ValidateFlightGroups -> Host '%s' no longer exists, removing initiator '%s'", groupName, initiatorAlias))
      end
      ...
      for initiatorAlias, data in pairs(groupTable) do
        ...
        if not playerGroup or not playerGroup:IsAlive() or not playerUnit or not playerUnit:IsAlive() then
          env.info(string.format("AI_ATC2:ValidateFlightGroups -> Initiator '%s' no longer valid, removing from group '%s'", initiatorAlias, groupName))
      ...
      if TableIsEmpty(groupTable) then
        AI_ATC_.FlightGroup[groupName] = nil
        env.info(string.format("AI_ATC2:ValidateFlightGroups -> Flight group '%s' is now empty, removing", groupName))
      end
    end
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*********************************************************************************AI_ATC2 JOIN GROUP MENU***********************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:JoinGroup(Alias)
  local ClientData = ATM2.ClientData[Alias]
  ...
  SchedulerObject = SCHEDULER:New(nil, function()
    if not ATM2.ClientData[Alias] or not Unit or not Unit:IsAlive() then
    ...
    local ClientTbl = {}
      ...
      for alias, data in pairs(ATM2.ClientData) do
      ...
      for i = 1, maxItems do
        ...
        if GroupMenu and ATM2.ClientData[ClientName] and not isInYourGroup then
          MENU_GROUP_COMMAND:New(Group, ClientName, GroupMenu, function()
            ...
            if not HostGroup then
              env.info(("AI_ATC2:AddPlayerToGroup -> Group not found '%s'."):format(ClientName))
              return
            end
          
            local clientData = ATM2.ClientData[Alias]
            if not clientData then
              env.info(("AI_ATC2:AddPlayerToGroup -> No ClientData found for '%s'."):format(Alias))
              return
            end
          
            local PlayerGroup = clientData.Group or (clientData.Unit and clientData.Unit:GetGroup())
            if not PlayerGroup then
              env.info(("AI_ATC2:AddPlayerToGroup -> No group for player '%s'."):format(Alias))
              return
            end
            
            if AI_ATC_.FlightGroup[Alias] and AI_ATC_.FlightGroup[Alias][ClientName] then
              env.info(("AI_ATC2:AddPlayerToGroup -> Unable to Join group %s, Client is already in YOUR group '%s'."):format(ClientName, Alias))
              return
            end
            
            AI_ATC2:AddPlayerToGroup(ClientName, Alias) 
            SchedulerObject:Stop()
            SchedulerObject = nil
          end, Group)
        end
...
--***************************************************************************AI_ATC2 SET GROUP************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AddPlayerToGroup(GroupName, PlayerAlias)
  local HostGroup = GROUP:FindByName(GroupName)
  if not HostGroup then
    env.info(("AI_ATC2:AddPlayerToGroup -> Group not found '%s'."):format(GroupName))
    return
  end

  local clientData = ATM2.ClientData[PlayerAlias]
  if not clientData then
    env.info(("AI_ATC2:AddPlayerToGroup -> No ClientData found for '%s'."):format(PlayerAlias))
    return
  end

  local PlayerGroup = clientData.Group or (clientData.Unit and clientData.Unit:GetGroup())
  if not PlayerGroup then
    env.info(("AI_ATC2:AddPlayerToGroup -> No group for player '%s'."):format(PlayerAlias))
    return
  end

  local Unit = clientData.Unit
  AI_ATC2:RemoveMenus(PlayerAlias)
  AI_ATC2:SeperateFromGroup(PlayerAlias)

  if Unit and Unit:IsAlive() then
    USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  end
  
  if ATM2.ClientData[PlayerAlias].CrewChief then
    ATM2.ClientData[PlayerAlias].CrewChief:Destroy()
  end

  ATM2.ClientData[PlayerAlias] = nil
  ATM2.GroundControl[PlayerAlias] = nil
  ATM2.TaxiController[PlayerAlias] = nil
  ATM2.TowerControl[PlayerAlias] = nil
  ...
  env.info(("AI_ATC2:AddPlayerToGroup -> '%s' joined flight group '%s'."):format(PlayerAlias, GroupName))
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************************AI_ATC2 SEPERATE GROUP*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SeperateGroup(Alias, Menu)
  local function TableIsEmpty(t)
    if not t then
      return true
    end
...
--***************************************************************************FIND TRANSMITTER************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:FindTransmitter(Alias, Agency)

  if not ATM2.ClientData[Alias] or not AI_ATC2.Radio[Agency] then
    return
  end
  
  local Frequecy = AI_ATC2.Radio[Agency].UserFreq
  local TransmitFrequency = AI_ATC2.Radio[Agency][Frequecy]
  local PlayerCoord = ATM2.ClientData[Alias].Unit:GetCoordinate()
...
--******************************************************************************CHANNEL OPEN*************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ChannelOpen(delay, agency, Alias)
  local Type = ATM2.ClientData[Alias].Type
  local Frequency, TransmitFrequency
  
  if agency ~= nil then 
    Frequency = AI_ATC2.Radio[agency].UserFreq
    TransmitFrequency = AI_ATC2.Radio[agency][Frequency]
  end
  ...
  if Type == "F-16C_50" or Type == "AH-64D_BLK_II" then
    if (agency=="Clearance" or agency=="Ground" or agency=="Tower") then
      ...
      local AI_ATC2_Transmitter = Unit:GetRadio()
      AI_ATC2_ChannelOpen = AI_ATC2_Transmitter:NewUnitTransmission("UHF_NOISE.ogg", nil, nil, TransmitFrequency, radio.modulation.AM, true)
      AI_ATC2_ChannelOpen:Broadcast()
    else
      ...
      AI_ATC2_ChannelOpen:Broadcast()
      SCHEDULER:New( nil, function()
        if AI_ATC2_ChannelOpen then
          AI_ATC2_ChannelOpen:StopBroadcast()
          AI_ATC2_ChannelOpen = nil
        end
      end,{}, delay)
    end
  end
...
--*****************************************************************************FIND AAR TANKERS**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:FindTankerUnits()
  AI_ATC2.Tankers = {
    [0] = {},
    [1] = {},
  }
  ...
  TankerUnits:ForEach(function(UnitObject)
    ...
    if TypeName=="KC130" then
      table.insert(AI_ATC2.Tankers[1], UnitName)
    elseif TypeName=="KC-135" then 
      table.insert(AI_ATC2.Tankers[0], UnitName)
...
--***************************************************************************ENABLE CREW CHIEF***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:EnableCrewChief(Boolean)
  if Boolean==true then
    AI_ATC2.CrewChief = true
  else
    AI_ATC2.CrewChief = false
  end
end
...
--***************************************************************************SPAWN CREW CHIEF*********-**************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SpawnCrewChief(Alias)
  if AI_ATC2.CrewChief~=true then
    return
  end
  ...
  if not chiefTemplate then
    env.info("AI_ATC2: 'CrewChief' template not found. Using default static object.")
    ...
    if not staticObj then
      env.warning("AI_ATC2: Failed to spawn default static object for '" .. tostring(Alias) .. "'.")
      return
    else
      SCHEDULER:New(nil, function()
        ATM2.ClientData[Alias].CrewChief = STATIC:FindByName(name)
      end, {}, 1)
    end
    ...
    CrewChief:OnSpawnGroup(function(spawnGroup)
      ...
      ATM2.ClientData[Alias].CrewChief = chiefUnit

      ChiefSchedule = SCHEDULER:New(nil, function()

        if not ATM2.ClientData[Alias] then
          spawnGroup:Destroy()
          ChiefSchedule:Stop()
          return
        end
...
--***************************************************************************INITIALISE CLIENTS**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:InitClients()
  
  if ATC_CLIENTS then
    ATC2_CLIENTS = ATC_CLIENTS
  else
    ATC2_CLIENTS = SET_CLIENT:New():FilterActive():FilterStart()
  end
  
  local TCN = AI_ATC_Navpoints.TQQTCN and AI_ATC_Navpoints.TQQTCN:GetCoordinate()
  if not TCN then
    env.warning("AI_ATC2:InitClients -> 'AI_ATC_Navpoints.TQQTCN' or its coordinate is nil.")
  end
  ...
  local function LogClients()
    --ATC_Coroutine:AddCoroutine(function()
      local activeClients = {}
      ATC2_CLIENTS:ForEachClient(function(clientObject)
        local function ProcessClient()
          ...
          if ATM2.ClientData[clientAlias] then
            ...
            if group and group:IsAlive() then
              ...
              if flightUnits > 1 or wingmanAlive or hasFlightGroup then
                ATM2.ClientData[clientAlias].Flight = true
                AI_ATC2:UpdateFlightCallsign(clientAlias)
              else
                ATM2.ClientData[clientAlias].Flight = false
              end
            end
            ...
            ATM2.ClientData[clientAlias] = {
              ...
              Procedure         = AI_ATC2.Procedure,
              Heliport          = false,
              RequestedProcedure= AI_ATC2.Procedure,
              SID               = AI_ATC2.Departure.SID,
              VFR               = AI_ATC2.Departure.VFR,
              RequestedProcedure= "VFR",
              State             = "Parked",
              Chart             = "TACAN",
              Recovery          = "ARCOE",
              RecoveryPlate     = "ARCOE",
              Approach          = { Type = AI_ATC2.Procedure },
            ...
            if isHelo then
              ATM2.ClientData[clientAlias].RequestedProcedure = "VFR"
            end
            ...
            if AI_ATC_.CustomCallsigns[clientAlias] and AI_ATC_.CustomCallsigns[clientAlias].Transponder then
              ...
              env.info(string.format("AI_ATC2:InitClients -> Assigned custom transponder %s to %s", Squawk, clientAlias))
            else
              Random = tostring(math.random(1, 7))
              Squawk = string.format("%s001", Random)
            end

            ATM2.ClientData[clientAlias].Squawk = Squawk

            AI_ATC2:UpdateFlightCallsign(clientAlias)

            if group:IsAirborne() then
              ATM2.ClientData[clientAlias].State = "AirBorne"
              local parentMenu = AI_ATC2.ParentMenu
              ATM2.ClientData[clientAlias].ParentMenu = parentMenu
              AI_ATC2:InitMenus(clientAlias)
              AI_ATC2:ResetMenus(clientAlias)
              if TCN then
                local range = coord:Get2DDistance(TCN)
                if range >= 24076 then
                  ATM2.ClientData[clientAlias].Approach.Type = "IFR"
                  AI_ATC2:ApproachSubMenu(clientAlias)
                else
                  AI_ATC2:LandingSubMenu(clientAlias)
                  AI_ATC2:DepartureSubMenu(clientAlias)
                end
              end
            else
              local parentMenu = AI_ATC2.ParentMenu
              ...
              if TCN then
                ...
                if isHelo then
                  ...
                  elseif range >= 18520 then
                    ...
                    ATM2.ClientData[clientAlias].State = "Parked"
                    AI_ATC2:ClearanceSubMenu(clientAlias)
                    AI_ATC2:GroundStartSubMenu(clientAlias)
                    SetHomeAirfield(clientAlias, "Tonopah Test Range")
                  end
                else
                  if range < 5556 then
                    AI_ATC2:ClearanceSubMenu(clientAlias)
                    AI_ATC2:GroundStartSubMenu(clientAlias)
                    AI_ATC2:SpawnCrewChief(clientAlias)
                    SetHomeAirfield(clientAlias, "Tonopah Test Range")
                  else
                    ATM2.ClientData[clientAlias].Approach.Type = "IFR"
                    AI_ATC2:ApproachSubMenu(clientAlias)
            ...
            local function ProcessingComplete(clientAlias)
              local cdata = ATM2.ClientData[clientAlias]
              if not cdata then return end
              local taxiway = cdata.Taxi
              if taxiway and taxiway[1] then
                local zone = AI_ATC2.TaxiWay[taxiway[1]] and AI_ATC2.TaxiWay[taxiway[1]].Zone
                if zone then
                  AI_ATC2:CalculateTaxiEntry(clientAlias, cdata.Coord, zone, true)
                end
              end
            end
            ...
            local function process()
              ...
              while not completed do
                ...
                if not cdata or not cdata.Unit then
                  env.info("AI_ATC2:InitClients -> Missing client data or unit, stopping coroutine.")
                  return
                end

                local groupObj = cdata.Unit:GetGroup()
                if not groupObj then
                  env.info("AI_ATC2:InitClients -> Missing group object, stopping coroutine.")
                  return
                end
                ...
                if isHelo then
                  ...
                  if Heliport then
                    ...
                    if HeliportDist <= 610 then
                      Rwy = AI_ATC2.Runways.Heliport[1]
                      ReferenceAirbase = AI_ATC2_Heliport
                      ParkingTbl = Tonopah_ParkingSpot
                      cdata.Heliport = true
                    else
                      Rwy = AI_ATC2.Runways.Takeoff[1]
                      ReferenceAirbase = AI_ATC2_Airbase
                      ParkingTbl = Tonopah_ParkingSpot
                    end
                  else
                    Rwy = AI_ATC2.Runways.Takeoff[1]
                ...
                if not groupObj:IsAirborne() then
                  ...
                  cdata.SpotNumber = 69
                  local spotData   = ReferenceAirbase:GetParkingSpotData(69)
                  if spotData then
      ...
      for oldAlias in pairs(ATM2.ClientData) do
        local function ProcessCleanup()
          if not activeClients[oldAlias] and oldAlias~="Test F-16" then
            ...
            AI_ATC2:CleanupClient(oldAlias)
          end
        end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:UpdateClient(Alias, Debug)

  if not ATM2.ClientData or not ATM2.ClientData[Alias] then
    if Debug then
      env.info(("AI_ATC2:UpdateClient -> No data found for alias '%s'."):format(Alias))
    end
    return
  end
  ...
  if Heliport then
    airbase    = AI_ATC2_Heliport
    spotsTable = Tonopah_ParkingSpot
    runways    = AI_ATC2.Runways and AI_ATC2.Runways.Heliport or {}
  else
    airbase    = AI_ATC2_Airbase
    spotsTable = Tonopah_ParkingSpot
    runways    = AI_ATC2.Runways and AI_ATC2.Runways.Takeoff or {}
  end


  if not (Unit and Group and UnitCoord and airbase and runways[1] and spotsTable) then
    if Debug then
      env.info(("AI_ATC2:UpdateClient -> Missing essential data for alias '%s'."):format(Alias))
    end
    return
  end
  ...
  local function ProcessingComplete()
    ...
    if taxiway and taxiway[1] then
      local zone = AI_ATC2.TaxiWay[taxiway[1]] and AI_ATC2.TaxiWay[taxiway[1]].Zone
      if zone then
        AI_ATC2:CalculateTaxiEntry(Alias, UnitCoord, zone, false)
      end
    end
  end
...
--***************************************************************************CALCULATE TAXI ENTRY *******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CalculateTaxiEntry(Alias, Coordinate, PolyZone, Debug)

  if not Alias or not Coordinate or not PolyZone or #PolyZone == 0 then
    if Debug then
      env.info(
        ("AI_ATC2:CalculateTaxiEntry -> Missing required parameters for alias '%s'."):format(tostring(Alias))
      )
    end
    return
  end

  local clientData = ATM2.ClientData and ATM2.ClientData[Alias]
  if not clientData then
    if Debug then
      env.info(("AI_ATC2:CalculateTaxiEntry -> No client data found for alias '%s'."):format(tostring(Alias)))
    end
    return
  end
...
--***************************************************************************GET PARKINGSPOT*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GetParkingSpot(Alias, Coord, Debug)

  if not Alias or not Coord then
    if Debug then
      env.info(("AI_ATC2:GetParkingSpot -> Missing Alias or Coord. Alias='%s'"):format(tostring(Alias)))
    end
    return false
  end

  if not AI_ATC2_Airbase or not ATM2.GroundControl or not ATM2.GroundControl[Alias] then
    if Debug then
      env.info(("AI_ATC2:GetParkingSpot -> Missing required data or ground control for alias '%s'."):format(Alias))
    end
    return false
  end
  ...
  if ATM2.GroundControl[Alias].Heliport then
    airbase    = AI_ATC2_Heliport
    spotsTable = Tonopah_ParkingSpot
    Rwy    = AI_ATC2.Runways and AI_ATC2.Runways.Heliport or {}
  else
    airbase    = AI_ATC2_Airbase
    spotsTable = Tonopah_ParkingSpot
    Rwy    = AI_ATC2.Runways and AI_ATC2.Runways.Takeoff or {}
  end
  ...
  ATM2.GroundControl[Alias].SpotNumber = terminalID
  ...
  ATC_Coroutine:AddCoroutine(function()
    ...
    while not foundSpot do
      for spot, info in pairs(spotsTable) do
        if info.Number == ATM2.GroundControl[Alias].SpotNumber then
          if Rwy and Rwy[1] and info.Taxi then
            ATM2.GroundControl[Alias].Taxi = info.Taxi[Rwy[1]]
          end

          ATM2.GroundControl[Alias].Spot = spot

          if Rwy and Rwy[3] then
            local distance2Runway = Coord:Get2DDistance(Rwy[3])
            ATM2.GroundControl[Alias].Distance2Runway = math.floor(distance2Runway + 0.5)
          end
...
--***************************************************************************TOWER CONTROLLER***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TowerController(Debug)
  local AirbaseCoord = AI_ATC2_Vec3
  ...
  SCHEDULER:New(nil, function()
    --ATC_Coroutine:AddCoroutine(function()
      local Runway = AI_ATC2.Runways.Landing[1]
      local RunwayHeading = AI_ATC2.Runways.Landing[5]
      ...
      TowerRadar:ForEachGroup(function(GroupObject)
        local function ProcessPrune()
          ...
          local Heading = AI_ATC2:CorrectHeading(GroupObject:GetHeading())
          if ATM2.TowerControl[Alias] then
            return
          end
      ...
      TowerRadar:ForEachGroup(function(GroupObject)
        local function ProcessState()
          ...
          local Angle = AI_ATC2:AngularDifference(Heading, RunwayHeading)
          local Bearing = AI_ATC2:AngularDifference(Heading, Coord:HeadingTo(DepartureCoord))

          if not ATM2.TowerControl[Alias] then
            ...
            if ATM2.TowerControl[Alias].State=="On Approach" and Bearing > 150 then
              ATM2.TowerControl[Alias].State = "On Departure"
            end

            return
          elseif ATM2.TowerControl[Alias] and GroupObject:IsAlive() and Range<=18520 then

            if ATM2.TowerControl[Alias].State==string.format("Landed on runway %s", Runway) then
              if not Client then
                ATM2.TowerControl[Alias] = nil
              end
              return
            end
            ...
            if not Airborne then
              if ATM2.TowerControl[Alias] then
                ATM2.RunwayOccupied[Alias] = {}
                SCHEDULER:New(nil, function()
                  if ATM2.RunwayOccupied[Alias] then
                    ATM2.RunwayOccupied[Alias] = nil
                  end
                end, {}, 60)
                if ATM2.TowerControl[Alias].State~="On Departure" then
                  ATM2.TowerControl[Alias].State = string.format("Landed on runway %s", Runway)
                end
                return
              end
            end

            if (ATM2.TowerControl[Alias].RequestedApproach=="Straight in" or ATM2.TowerControl[Alias].RequestedApproach=="Instrument Straight in")
            and (ATM2.TowerControl[Alias].State=="On Approach"
            or ATM2.TowerControl[Alias].State=="Re-entering pattern") then
              if Angle <= 15 and Range <= 11112 then
                ATM2.TowerControl[Alias].State = "On Final Approach"
                return
              end

            elseif (ATM2.TowerControl[Alias].RequestedApproach=="Overhead"
            and ATM2.TowerControl[Alias].State=="On Approach") then
              if Angle <= 15 and Range <= 9260 then
                ATM2.TowerControl[Alias].State = "Initial"
                return
              end

            elseif (ATM2.TowerControl[Alias].RequestedApproach=="Overhead"
            and ATM2.TowerControl[Alias].State=="Initial") then
              if (Angle >= 30 and Angle <= 130) and Range <= 9260 then
                ATM2.TowerControl[Alias].State = "in the Break"
                return
              end

            elseif (ATM2.TowerControl[Alias].RequestedApproach=="Overhead"
            and ATM2.TowerControl[Alias].State=="in the Break") then
              if Angle >= 160 and Range <= 9260 then
                ATM2.TowerControl[Alias].State = string.format("%s Downwind", Break)
                return
              end

            elseif (ATM2.TowerControl[Alias].RequestedApproach=="Overhead"
            and ATM2.TowerControl[Alias].State==string.format("%s Downwind", Break)) then
              if (Angle >= 70 and Angle <= 160) and Range <= 12964 then
                ATM2.TowerControl[Alias].State = string.format("%s Base", Break)
                return
              end

            elseif ((ATM2.TowerControl[Alias].RequestedApproach == "Overhead"
            or ATM2.TowerControl[Alias].RequestedApproach == "SFO")
            and ATM2.TowerControl[Alias].State == string.format("%s Base", Break)) then
              if Angle <= 15 and Range <= 9260 then
                ATM2.TowerControl[Alias].State = "On Final Approach"
                return
              end

            elseif ATM2.TowerControl[Alias].State=="On Final Approach" then
              if Angle <= 15 and Range <= 1852 and Altitude >= 152 then
                ATM2.TowerControl[Alias].State = "Going around"
                return
              end

            elseif ATM2.TowerControl[Alias].State=="Going around" then
              ATM2.TowerControl[Alias].CycleCount = (ATM2.TowerControl[Alias].CycleCount or 0) + 1
              local CycleCount = ATM2.TowerControl[Alias].CycleCount
              if CycleCount > 10 then

                if Angle >=80 and Angle <=181 and Altitude <= 670 then
                  ATM2.TowerControl[Alias].State = "Outside Downwind"
                  ATM2.TowerControl[Alias].CycleCount = 0
                  return
                end

                if Angle >=1 and Angle <= 170 and Altitude >= 670 then
                  ATM2.TowerControl[Alias].State = "Missed Approach"
                  ATM2.TowerControl[Alias].CycleCount = 0
                  return
                end
              else
                ATM2.TowerControl[Alias].CycleCount = CycleCount
                return
              end

            elseif ATM2.TowerControl[Alias].State=="Outside Downwind" then
              if Angle >= 20 and Angle <= 80 and Range >= 9260 then
                ATM2.TowerControl[Alias].State = "Re-entering pattern"
                return
              end
            end
      ...
      local RemoveTbl = {}
      for alias, data in pairs(ATM2.TowerControl) do
        local function ProcessCleanup()
...
--***************************************************************************GROUND CONTROLLER*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GroundController(Debug)
  
  local AirbaseVec2 = AI_ATC2_Vec3:GetVec2()
  local AirbaseZone = ZONE_RADIUS:New("AirbaseZone", AirbaseVec2, 3000)
  local TakeoffRunway = AI_ATC2.Runways.Takeoff[1]
  local LandingRunway = AI_ATC2.Runways.Landing[1]
    ...
    ATC_Coroutine:AddCoroutine(function()
      GroundControlSet:ForEachGroupAlive(function(GroupObject)
        ...
        if (not isHelo and not GroupObject:IsAirborne()) or (isHelo and altitude <= 50) then
          if not ATM2.GroundControl[alias] then
            local coord = GroupObject:GetCoordinate()

            ATM2.GroundControl[alias] = {
            ...
            if velocity <= 1 then
              if isHelo then
                ...
                if Heliport then
                  ...
                  if HeliportDist <= 610 then 
                    ATM2.GroundControl[alias].Heliport = true
                  end
                end
              end
              ATC_Coroutine:AddCoroutine(function()
                AI_ATC2:GetParkingSpot(alias, coord, true)
              end)
            else
              ATM2.GroundControl[alias].Taxi            = {"Juliett", "Golf"}
              ATM2.GroundControl[alias].Spot            = "T01"
              ATM2.GroundControl[alias].SpotNumber      = 171
              ATM2.GroundControl[alias].Distance2Runway = 556.8
            end
  ...
  SCHEDULER:New(nil, function()
    TakeoffRunway = AI_ATC2.Runways.Takeoff[1]
    LandingRunway = AI_ATC2.Runways.Landing[1]
  ...
  SCHEDULER:New(nil, function()
    ...
    --ATC_Coroutine:AddCoroutine(function()
      for alias, data in pairs(ATM2.GroundControl) do
        local function ProcessAlias()
          ...
          if not coord and not client then
            if ATM2.TaxiController and ATM2.TaxiController[alias] then
              for _, sched in pairs(ATM2.TaxiController[alias]) do
                if sched and sched.Stop then sched:Stop() end
              end
              ATM2.TaxiController[alias] = nil
            end
            ATM2.GroundControl[alias] = nil
            return
          end
          ...
          if taxi and ((not isHelo and not isAirborne) or (isHelo and altitude <= 50)) then
            if velocity < 1 and data.State ~= "Parked" and data.State ~= "Taxiing to runway" then
              local gotSpot = AI_ATC2:GetParkingSpot(alias, coord, false)
              if gotSpot then
                data.State    = "Parked"
                ...
                if client and client.State ~= "Parked" then
                  client.State = "Parked"
                  --AI_ATC2:RepeatLastTransmission(alias, nil)
                  AI_ATC2:UpdateClient(alias, false)
                  if ATM2.TaxiQueue[alias] then
                    ATM2.TaxiQueue[alias] = nil
                  end
                end
              end
            ...
            elseif velocity > 25 and data.State == "Taxiing to runway" then
              ...
              if client and client.TakeoffClearance==true then
                ...
                AI_ATC2.Runways.TakeoffHold = true
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ForceGroundRegistration(Alias)
  local client = ATM2.ClientData[Alias]
  if not client or not client.Unit or not client.Unit:IsAlive() then
    env.info(string.format("AI_ATC2:ForceGroundRegistration -> No live client for '%s'.", Alias))
    return false
  end
  ...
  local distance = (AI_ATC2_Vec3 and coord) and AI_ATC2_Vec3:Get2DDistance(coord) or nil
  ...
  if not onGround or not distance or distance > 3000 then
    env.info(string.format("AI_ATC2:ForceGroundRegistration -> '%s' not on the ground at %s (alt=%.0f, dist=%s). Aborting.",
      Alias, AI_ATC2.AirbaseAlias, altitude, tostring(distance and math.floor(distance))))
    return false
  end
  ...
  if not ATM2.GroundControl[Alias] then
    ...
    env.info(string.format("AI_ATC2:ForceGroundRegistration -> Created GroundControl entry for '%s'.", Alias))
  end

  local data = ATM2.GroundControl[Alias]
  data.GroupObject = Group

  AI_ATC2:GetParkingSpot(Alias, coord, false)
  ...
  env.info(string.format("AI_ATC2:ForceGroundRegistration -> '%s' registered and aligned to Parked (v=%.1f, spot=%s).",
...
--***************************************************************************TAXI MANAGER****************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiManager(Alias)

  if not Alias then
    env.info("AI_ATC2:TaxiManager -> Alias is nil. Aborting.")
    return
  end

  local groundData = ATM2.GroundControl and ATM2.GroundControl[Alias]
  if not groundData then
    env.info(("AI_ATC2:TaxiManager -> No ground control data found for alias '%s'."):format(tostring(Alias)))
    return
  end

  local groupObject = groundData.GroupObject
  if not groupObject then
    env.info(("AI_ATC2:TaxiManager -> No group object for alias '%s'."):format(tostring(Alias)))
    return
  end
  ...
  if not ATM2.TaxiQueue then
    ATM2.TaxiQueue = {}
  end

  local function UpdateTaxiQueue(targetAlias)
    ATM2.TaxiQueue[targetAlias] = {
      Name     = Alias,
      Type     = initiatorType,
    ...
    ATM2.GroundControl[targetAlias].TaxiAuthority = false
  end

  for otherAlias, otherData in pairs(ATM2.GroundControl) do
    ...
    if otherAlias ~= Alias then
      if otherData.IsPlayer then
        ...
        if otherData.TaxiAuthority == false then
          ...
          if not ATM2.TaxiQueue[otherAlias] then
            UpdateTaxiQueue(otherAlias)

          elseif
            ATM2.TaxiQueue[otherAlias]
            and ATM2.TaxiQueue[otherAlias].Taxi ~= otherTaxiWay
          ...
          elseif
            ...
            and ATM2.TaxiQueue[otherAlias].Taxi == otherTaxiWay
            and initiatorTaxiWay == otherTaxiWay
            and initiatorParking >= ATM2.TaxiQueue[otherAlias].Distance
            and ATM2.TaxiQueue[otherAlias].Name ~= Alias
          then
              UpdateTaxiQueue(otherAlias)
          end

          local queuedTaxi    = ATM2.TaxiQueue[otherAlias].Taxi
          local queuedGroup   = ATM2.TaxiQueue[otherAlias].Name
...
--***************************************************************************TAXI CONTROLLER*************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiControl(Client, Taxiway, Alias)

  if not Client or not Taxiway or not Alias then
    env.warning("AI_ATC2:TaxiControl -> Missing Client, Taxiway, or Alias.")
    return
  end

  ATM2.TaxiController[Client] = ATM2.TaxiController[Client] or {}
  if ATM2.TaxiController[Client][Alias] then
    ATM2.TaxiController[Client][Alias]:Start()
    return
  end

  local clientData = ATM2.ClientData[Client]
  local groundData = ATM2.GroundControl[Alias]
  local ownGround  = ATM2.GroundControl[Client]

  if not clientData or not groundData or not ownGround then
    env.warning(("AI_ATC2:TaxiControl -> Missing data for Client='%s' or Alias='%s'."):format(tostring(Client), tostring(Alias)))
    return
  end

  local groupObject = groundData.GroupObject
  if not groupObject then
    env.warning(("AI_ATC2:TaxiControl -> GroupObject is nil for Alias='%s'."):format(tostring(Alias)))
    return
  end
  ...
  if clientData.Taxi and #clientData.Taxi > 1 then
    ...
    terminalCoord = AI_ATC2_TerminalCoordinates[Taxiway]
                and AI_ATC2_TerminalCoordinates[Taxiway][terminalTaxiZone]
  else
    terminalCoord = AI_ATC2.Runways.Takeoff[3]
  end

  if not terminalCoord then
    env.warning(("AI_ATC2:TaxiControl -> TerminalCoord is nil for Client='%s' at Taxiway='%s'"):format(Client, Taxiway))
    return
  end
  ...
  newScheduler = SCHEDULER:New(nil, function()
    ...
    if firstUnit 
       ...
       and ATM2.GroundControl[Client] 
       and ATM2.TaxiQueue[Client]
    then
      ...
      if objectDistance <= terminalDistance or hasStopped then
        ...
        ATM2.TaxiQueue[Client].Stopped = hasStopped
        newScheduler:Stop()
      end
    else
      newScheduler:Stop()
  ...
  ATM2.TaxiController[Client][Alias] = newScheduler
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************************TAXI SUBTITLE*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiSubtitle(Alias)
  if not ATM2.ClientData or not ATM2.ClientData[Alias] then
    env.warning(("AI_ATC2:TaxiSubtitle -> No ClientData found for alias '%s'."):format(tostring(Alias)))
    return ""
  end

  local taxiways = ATM2.ClientData[Alias].Taxi
...
--***********************************************************************************HOLD SHORT**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HoldShort(Alias)

  if not Alias then
    env.warning("AI_ATC2:HoldShort -> Alias is nil.")
    return "14" 
  end

  if not (ATM2 and ATM2.ClientData and ATM2.ClientData[Alias]) then
    env.warning(("AI_ATC2:HoldShort -> Missing ATM2.ClientData for alias '%s'."):format(tostring(Alias)))
    return "14"
  end
  ...
  if Heliport then
    activeRunway    = (AI_ATC2.Runways and AI_ATC2.Runways.Heliport and AI_ATC2.Runways.Heliport[1]) or "14"
  else
    activeRunway    = (AI_ATC2.Runways and AI_ATC2.Runways.Takeoff and AI_ATC2.Runways.Takeoff[1]) or "14"
  end
  ...
  if ATM2.GroundControl and ATM2.GroundControl[Alias] then
    ATM2.GroundControl[Alias].HoldShort = holdShort, TaxiHold
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HoldShortLanding(Alias)

  local DEFAULT_RUNWAY = "14"
  if not Alias then
    env.warning("AI_ATC2:HoldShortLanding -> 'Alias' is nil.")
    return DEFAULT_RUNWAY
  end

  if not (ATM2 and ATM2.ClientData and ATM2.ClientData[Alias]) then
    env.warning(("AI_ATC2:HoldShortLanding -> Missing ATM2.ClientData for alias '%s'."):format(tostring(Alias)))
    return DEFAULT_RUNWAY
  end
  ...
  if Heliport then
    activeRunway = (AI_ATC2.Runways and AI_ATC2.Runways.Heliport and AI_ATC2.Runways.Heliport[1]) or DEFAULT_RUNWAY
  else
    activeRunway = (AI_ATC2.Runways and AI_ATC2.Runways.Landing and AI_ATC2.Runways.Landing[1]) or DEFAULT_RUNWAY
  end
  ...
  if ATM2.GroundControl and ATM2.GroundControl[Alias] then
    ATM2.GroundControl[Alias].HoldShortLanding = holdShort
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ExtractRunwayHeading(runway)
...
--***********************************************************************************ATC EXTRACT RUNWAY HEADING******************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AngularDifference(heading1, heading2)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TerminateSchedules(Alias)
  if not ATM2.ClientData[Alias] then return end
  local SchedulerObjects = ATM2.ClientData[Alias].SchedulerObjects
...
--***********************************************************************************CLEANUP CLIENT*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CleanupClient(Alias)
  -- Stop all tracked schedulers
  AI_ATC2:TerminateSchedules(Alias)

  -- Stop PAR tick schedulers if they exist
  if AI_ATC2.PAR_TickSchedulers and AI_ATC2.PAR_TickSchedulers[Alias] then
    for _, sched in ipairs(AI_ATC2.PAR_TickSchedulers[Alias]) do
      if sched and sched.Stop then sched:Stop() end
    end
    AI_ATC2.PAR_TickSchedulers[Alias] = nil
  end
  ...
  if ATM2.TowerControl and ATM2.TowerControl[Alias] then
    if ATM2.TowerControl[Alias].Schedules then
      for _, sched in ipairs(ATM2.TowerControl[Alias].Schedules) do
        if sched and sched.Stop then sched:Stop() end
      end
    end
    ATM2.TowerControl[Alias] = nil
  ...
  -- Destroy CrewChief
  if ATM2.ClientData[Alias] and ATM2.ClientData[Alias].CrewChief then
    ATM2.ClientData[Alias].CrewChief:Destroy()
  end

  -- Remove marks
  if ATM2.ClientData[Alias] and ATM2.ClientData[Alias].Mark then
    COORDINATE:RemoveMark(ATM2.ClientData[Alias].Mark)
  end

  -- Nil all ATM2 sub-tables
  AI_ATC2.PARdata[Alias]       = nil
  ATM2.ClientData[Alias]       = nil
  ATM2.GroundControl[Alias]    = nil
  ATM2.TaxiController[Alias]   = nil
  ATM2.TowerControl[Alias]     = nil
end
...
--***********************************************************************************ATC CLOCK BEARING***************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeadingToClockBearing(heading)
  heading = heading % 360
...
--*****************************************************************************ATC RECTIFY HEADING*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RectifyHeading(String)
  if #String == 1 then
    String = "00" .. String
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CorrectHeading(heading)
  local MagDec = AI_ATC2.MagDec
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadCardinal(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Cardinal[String]
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GetClosestAirbase(coord)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AirfieldMenus(Agency, Alias, Menu)
  local ClientData = ATM2.ClientData[Alias]
  local Unit = ClientData.Unit
  local Group = Unit:GetGroup()
  local SchedulerObjects = ClientData.SchedulerObjects
  ...
  SchedulerObject = SCHEDULER:New(nil, function()
    ...
    local Coord = Unit:GetCoordinate()
    local closestAirfields = AI_ATC2:GetClosestAirbase(Coord)
    local ok = pcall(function()
      Menu:RemoveSubMenus()
      for i, data in ipairs(closestAirfields) do
        local airfieldName = data.Name
        if Agency == "Attila" then
          MENU_GROUP_COMMAND:New(Group, airfieldName, Menu, function() AI_ATC2:Vector(Alias, airfieldName) end, Group)
        else
          MENU_GROUP_COMMAND:New(Group, airfieldName, Menu, function() AI_ATC2:NavAssist(Alias, airfieldName, Agency) end, Group)
        end
      end
    end)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:DepartureCardinal(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Cardinal2[String]
  if matchedValue then
...
--***********************************************************************************ATC HEADING*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Heading(String, RadioObject, transmitter, audio)
  ...
  if audio==true then  
    for i = 1, #String do
      ...
      local matchedValue = AI_ATC2_SoundFiles[RadioKey][digit]
...
--*********************************************************************ATC READ HEADING*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadHeading(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  ...
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Heading[String]
  if matchedValue then
...
--*****************************************************************************ATC READ DISTANCE*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadDistance(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Distance[String]
  if matchedValue then
...
--*******************************************************************************ATC READ DIGITS*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadDigits(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  
  for i = 1, #String do
    local digit = String:sub(i, i)
    local matchedValue = AI_ATC2_SoundFiles[RadioKey].Numerical[digit]
...
--*******************************************************************************ATC READ NUMBER*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadNumber(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Numerical[String]
  if matchedValue then
    RadioObject:NewTransmission(string.format("Numerical/%s", matchedValue.filename), matchedValue.duration, string.format("Airbase_ATC/%s/", RadioKey), nil, 0.01)
  else
    AI_ATC2:ReadDigits(String, RadioObject, transmitter)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*******************************************************************************ATC READ RANGE*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadRange(numberString, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter] and AI_ATC2.Radio[transmitter].Key 
  ...
  while i <= length do
    ...
    if soundKey and AI_ATC2_SoundFiles[RadioKey].Numerical[soundKey] then
      local matchedValue = AI_ATC2_SoundFiles[RadioKey].Numerical[soundKey]
...
--*******************************************************************************ATC READ THOUSANDS******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadThousands(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local firstDigit = string.sub(String, 1, 1)
  local firstValue = AI_ATC2_SoundFiles[RadioKey].Numerical[firstDigit]
  if firstValue then
  ...
  if tonumber(String) >= 10000 then
    ...
    local secondValue = AI_ATC2_SoundFiles[RadioKey].Numerical[secondDigit]
    if secondValue then
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadFlightLevel(String, RadioObject, transmitter, audio)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  ...
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].FlightLevel[audioKey]
  ...
  if Hundreds then
    local matchedValue2 = AI_ATC2_SoundFiles[RadioKey].Numerical[Hundreds]
...
--***********************************************************************************ATC READ DIGITS*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ClockBearing(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Oclock[String]
  if matchedValue then
...
--***********************************************************************************ATC READ SID*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadSID(string, RadioObject, transmitter, audio)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].SID[string]
...
--***********************************************************************************ATC READ VFR*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadVFR(string, RadioObject, transmitter, audio)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].VFR[string]
  if matchedValue then
    if audio==true then
      RadioObject:NewTransmission(string.format("SoundFiles/%s", matchedValue.filename), matchedValue.duration, string.format("Airbase_ATC/%s/", RadioKey), nil, 0.02)
    end
...
--***********************************************************************************ATC AIRBASE NAME****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AirbaseName(string, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Airbase[string]
  if matchedValue then
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***************************************************************AI_ATC2 READ ALTITUDE BLOCK*************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadAltitudeBlock(string, delay, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].AltitudeBlock[string]
  if matchedValue then
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************AI_ATC2 READ WEATHER*************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Weather(RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local weather = env.mission and env.mission.weather or {}
  local Clouds = weather.clouds.preset
  local CloudData = AI_ATC2_CloudPresets[Clouds].Cloud
  local AudioDate = AI_ATC2_SoundFiles[RadioKey].Clouds[CloudData]
  ...
  if CloudData=="Clear clouds" then
    ...
    if AudioDate then
      ...
      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Departure/SoundFiles/", nil, nil, Subtitle, 3)
      RadioObject:NewTransmission(string.format("SoundFiles/%s", AudioDate.filename), AudioDate.duration, string.format("Airbase_ATC/%s/", RadioKey), nil, 0.1)
      AI_ATC2:ReadFlightLevel(CloudBase, RadioObject, transmitter, true)
    end
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*********************************************************************************ATC CALLSIGN*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Callsign(inputString, RadioObject, transmitter, flight)
  ...
  RadioKey = AI_ATC2.Radio[transmitter].Key
  ...
  local Entry = AI_ATC2_SoundFiles[RadioKey].Callsigns[prefix]
  ...
  if Entry then
    ...
    if not ExcludedStrings[inputString] and CountNumerical==2 and not flight then
      File = AI_ATC2_SoundFiles[RadioKey].CallsignsNumerical[numerical].filename
      Duration = AI_ATC2_SoundFiles[RadioKey].CallsignsNumerical[numerical].duration
    ...
    elseif flight and numerical then
      local File = AI_ATC2_SoundFiles[RadioKey].CallsignsNumerical[numerical]
      if File then
    ...
    File = AI_ATC2_SoundFiles[RadioKey].CallsignsNumerical["11"].filename
    Name = File.filename
...
--****************************************************************************ATC FLIGHT CALLSIGN********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:UpdateFlightCallsign(Alias)

  local ClientObject = ATM2.ClientData[Alias]
...
--****************************************************************************ATC WIND DIRECTION*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:WindDirection(numberString, RadioObject, transmitter)
...
--*********************************************************************************ATC WIND SPEED*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:WindSpeed(number, String, RadioObject, transmitter)
  
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, transmitter)
  ...
  if number >= 13 and number <= 24 then
    ...
    AI_ATC2:WindDirection(String, RadioObject, transmitter)
  end
  if number >= 25 then
...
--*********************************************************************************ATC PRESSURE*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Pressure(number, RadioObject, transmitter)
  ...
  for i = 1, #numStr do
    ...
    elseif c == '.' then
      if not lastCharWasNine then
        local matchedValue = AI_ATC2_SoundFiles[RadioKey].Numerical[c]
        if matchedValue then
          RadioObject:NewTransmission(string.format("Numerical/%s", matchedValue.filename), matchedValue.duration, string.format("Airbase_ATC/%s/", RadioKey), nil, nil)
        end
      end
...
--*****************************************************************************ATC PROCESS TIME*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ProcessTime(String, RadioObject, transmitter)
...
--*******************************************************************************ATC ANGLE DELTA*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AngleDelta(angle1, angle2)
...
--***********************************************************************************ATC RUNWAY*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Runway(String, RadioObject, transmitter)
  
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].Runway[String]
  if matchedValue then
...
--***********************************************************************************ATC NAVPOINT-*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadNavpoint(String, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local matchedValue = AI_ATC2_SoundFiles[RadioKey].NavPoint[String]
  if matchedValue then
...
--***********************************************************************************ATC RUNWAY*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Runway2(String, RadioObject, transmitter)
  ...
  if #AlphaString > 0 then
    local matchedValue = AI_ATC2_SoundFiles[RadioKey].Direction[AlphaString]
    if matchedValue then
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReadTaxiInstructions(Alias, RadioObject, transmitter)
  
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local TaxiData = ATM2.ClientData[Alias].Taxi
  ...
  for i = 1, NumberOfTaxiways do
    ...
    local Entry = AI_ATC2_SoundFiles[RadioKey].Phonetic[TaxiName]
...
--***********************************************************************************ATC SPOT NUMBER*****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SpotNumber(spot, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local Iteration = 10
  local Count = 0
  local inputString
  ...
  local function Execute(inputString)
    ...
    local Phonetic = AI_ATC2_SoundFiles.ATIS.PhoneticAlphabet[AlphaString]
    if Phonetic then 
      AI_ATC2:Phonetic(Phonetic, RadioObject, transmitter)
    end
  ...
  ATC_Coroutine:AddCoroutine(function()
    local inputString = nil
    for key, value in pairs(Tonopah_ParkingSpot) do
      Count = Count + 1
      if value.Number == spot then
        inputString = key
        Execute(inputString)
...
function AI_ATC2:SpotNumber(spot, RadioObject, transmitter)
  ...
  local function SpeakDesignator(str)
    ...
    if #letters == 1 then
      local phonetic = AI_ATC2_SoundFiles.ATIS.PhoneticAlphabet[letters:upper()]
      if phonetic then
        AI_ATC2:Phonetic(phonetic, RadioObject, transmitter)
      end
    elseif #letters > 1 then
      AI_ATC2:ParkingRamp(letters, RadioObject, transmitter)
    end
    for i = 1, #digits do
      local d      = digits:sub(i, i)
      local sound  = AI_ATC2_SoundFiles[RadioKey].Numerical[d]
      if sound then
  ...
  ATC_Coroutine:AddCoroutine(function()
    for key, val in pairs(Tonopah_ParkingSpot) do
      counter = counter + 1
...
--***********************************************************************************ATC PHONETIC*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Phonetic(AlphaString, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key

  local Entry = AI_ATC2_SoundFiles[RadioKey].Phonetic[AlphaString]
  if Entry then
    RadioObject:NewTransmission(string.format("Phonetic/%s", Entry.filename), Entry.duration, string.format("Airbase_ATC/%s/", RadioKey), nil, 0.1)
  end
end
...
--***********************************************************************************ATC PARKING RAMP****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ParkingRamp(AlphaString, RadioObject, transmitter)
  local RadioKey = AI_ATC2.Radio[transmitter].Key

  local Entry = AI_ATC2_SoundFiles[RadioKey].ParkingRamp[AlphaString]
  if Entry then
...
--***********************************************************************************ATC TAXI QUEUE******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiQueue(Alias, RadioObject, transmitter, Audio)
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, transmitter)
  local Count = 0
  local FullSubtitle = ""
  ...
  if Count > 1 and ATM2.TaxiQueue[Alias] then
    local Type = ATM2.TaxiQueue[Alias].Type
    local TypeName = AI_ATC2:SRS_ConvertAircraftType(Type, RadioKey)
    local Taxiway = ATM2.TaxiQueue[Alias].Taxi
    local Queue = tostring(Count)

    local Subtitle1 = string.format("Your number %s in line for departure", Queue)
    local Subtitle2 = ""

    if Taxiway == ATM2.ClientData[Alias].Taxi[1] then
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS["Ground"] and AI_ATC2_MSRS["Ground"].Active then
    ...
    if Audio == true then
      ...
      local matchedValue = AI_ATC2_SoundFiles[RadioKey].Numerical[Queue]
      if matchedValue then
        RadioObject:NewTransmission(string.format("Numerical/%s", matchedValue.filename), matchedValue.duration, string.format("Airbase_ATC/%s/", RadioKey), nil, nil)
        RadioObject:NewTransmission("InLine.ogg", 1.068, string.format("Airbase_ATC/%s/SoundFiles/", RadioKey), nil, 0.3)
      end

      local UnitType = ATM2.TaxiQueue[Alias].Type
      local Entry = AI_ATC2_SoundFiles[RadioKey].Aircraft[UnitType]
      ...
      if Taxiway == ATM2.ClientData[Alias].Taxi[1] then
        ...
        local Entry = AI_ATC2_SoundFiles[RadioKey].Phonetic[Taxiway]
        if Entry then
          RadioObject:NewTransmission(string.format("Phonetic/%s", Entry.filename), Entry.duration, string.format("Airbase_ATC/%s/", RadioKey), nil, 0.1)
        end
      end
...
--***********************************************************************************TAXI TO PARKING*****************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiToParking(Alias, RadioObject, transmitter, Audio)
  
  local RadioKey = AI_ATC2.Radio[transmitter].Key
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, transmitter)
  local Unit = ATM2.ClientData[Alias].Unit
  local UnitHeading = Unit:GetHeading()
  local InitiatorCoord = ATM2.ClientData[Alias].Coord
  local TaxiData = ATM2.ClientData[Alias].Taxi[1]
  local PlayerEntry = ATM2.ClientData[Alias].TaxiEntry
  local Heliport = ATM2.ClientData[Alias].Heliport
  local ActiveRunway, Runway, RunwayHeading
  if Heliport then
    ActiveRunway = AI_ATC2.Runways.HeliportZone
    Runway = AI_ATC2.Runways.Heliport[1]
  else
    ActiveRunway = AI_ATC2.Runways.LandingZone
    Runway = AI_ATC2.Runways.Takeoff[1]
  end
  ...
  if Runway=="14" or Runway=="14" then
    RunwayHeading = AI_ATC2.Runways.Landing[5]
  else
    RunwayHeading = AI_ATC2.Runways.Landing[5]
  end
  ...
  -------------------------------------------
  local TaxiTable = AI_ATC2_TaxiToPark[Runway][TaxiData].Route
  ...
  local compareZone = AI_ATC2.TaxiWay[TaxiTable[1]].Zone
  ...
  for i = 1, NumberOfTaxiways do
    ...
    local currentZone = AI_ATC2.TaxiWay[currentTaxiway].Zone
    local currentVertices = currentZone

    local compareZone
    local compareVertices
    if i < NumberOfTaxiways then
      compareZone = AI_ATC2.TaxiWay[TaxiTable[i + 1]].Zone
      compareVertices = compareZone
    else
      compareZone = AI_ATC2.Runways.TakeoffZone
...
--  --------------------------------------------------------------------
  ...
  for i = 1, NumberOfTaxiways do
    ...
    local SpokenTaxiName = AI_ATC2:SRS_ConvertNavFix(TaxiName)
    
    if iterations == 1 then
      Subtitle = TurnDirection .. " turn " .. SpokenTaxiName
    else
  ...
  for i = 1, NumberOfTaxiways do
    ...
    local matchingKey
    for key, _ in pairs(AI_ATC2_SoundFiles[RadioKey].Phonetic) do
    ...
    if matchingKey then
      local matchedEntry = AI_ATC2_SoundFiles[RadioKey].Phonetic[matchingKey]
...
--***********************************************************************************TAXI REQUEST********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiRequest(Alias)
  local groundControl = ATM2.GroundControl
  local currentControl = groundControl[Alias]
  
  if not currentControl then
    env.info(string.format("AI_ATC2:TaxiRequest - Alias '%s' not found in GroundControl.", Alias))
    return
  end
  ...
  if not Taxiway then
    env.info(string.format("AI_ATC2:TaxiRequest: %s does not have a valid Taxiway.", Alias))
    return
  end
  ...
  for otherAlias, data in pairs(groundControl) do
    if data and otherAlias ~= Alias and data.TaxiAuthority and data.Taxi and data.Taxi[1] == Taxiway then
      ...
      if Distance >= currentControl.Distance2Runway then
        currentControl.TaxiAuthority = false
        AI_ATC2:TaxiControl(Alias, Taxiway, otherAlias)
        return
      end
    end
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:NavAssist(Alias, NavPoint, Transmitter, Modifier)

  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientObject = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:NavAssist(Alias, NavPoint, Transmitter, Modifier) end, Transmitter)==false then
    return
  end
  
  AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:NavAssist(Alias, NavPoint, Transmitter, Modifier) end)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  ...
  SCHEDULER:New( nil, function()
    ...
    Heading = AI_ATC2:CorrectHeading(UnitCoord:HeadingTo(Destination))
    HeadingSub = AI_ATC2:Heading(Heading, RadioObject, Transmitter, false)
    AI_ATC2:ChannelOpen(6, Transmitter, Alias)
    Subtitle = string.format("%s: %s, Vectors for %s, fly heading %s", Transmitter, CallsignSub, NavSubtitle, HeadingSub)

    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenHeading  = AI_ATC2:SRS_ConvertHeading(Heading)
      local spokenNavFix

      if Modifier~=nil then
        spokenNavFix = "radar " .. Modifier
      else
        spokenNavFix = AI_ATC2:SRS_ConvertNavFix(NavPoint)
      end
      ...
      local msg = string.format("%s, vectors for %s, fly heading %s.",
        spokenCallsign, spokenNavFix, spokenHeading)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
      return
    end

    RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Departure/SoundFiles/", nil, nil, Subtitle, 5)
    AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
    RadioObject:NewTransmission("VectorsFor.ogg", 0.952, "Airbase_ATC/Departure/SoundFiles/", nil, 0.05)
    AI_ATC2:ReadNavpoint(NavpointName, RadioObject, Transmitter)
    RadioObject:NewTransmission("FlyHeading.ogg", 0.801, "Airbase_ATC/Departure/SoundFiles/", nil, 0.03)
    AI_ATC2:ReadHeading(Heading, RadioObject, Transmitter)
  end,{}, Delay)
end
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************************ATIS START**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:StartATIS()

  if AI_ATC2.ATIS.Active or AI_ATC2.ATIS.Data.FC3switch then
    return
  end
  AI_ATC2.ATIS.Active = true

  local RadioObject  = ATIS_RADIO2
  local AirbaseName  = AI_ATC2.AirbaseAlias or "Unknown"
  local Airbase      = string.format("%s Airbase", AirbaseName)
  local Title        = "ATIS"

  local function ATISCoroutine()

    while AI_ATC2 and AI_ATC2.ATIS and AI_ATC2.ATIS.Active do
      ...
      do
        ...
        local NATO = AI_ATC2_NatoTime[tonumber(Zulu[1]) + 1]
        AI_ATC2.ATIS.Data.Information = NATO
        AI_ATC2.ATIS.Data.ZULU = ZULU
      end
      coroutine.yield()

      if not AI_ATC2 or not AI_ATC2.ATIS or not AI_ATC2.ATIS.Active then
        break
      end

      do
        local depRunway = AI_ATC2.Runways.Takeoff and AI_ATC2.Runways.Takeoff[1] or "03L"
        local arrRunway = AI_ATC2.Runways.Landing and AI_ATC2.Runways.Landing[1] or "21L"

        AI_ATC2.ATIS.Data.Departure = depRunway
        AI_ATC2.ATIS.Data.Arrival   = arrRunway

        if depRunway == arrRunway then
          AI_ATC2.ATIS.Data.Active = depRunway
        else
          AI_ATC2.ATIS.Data.Active = nil
        end
      end
      coroutine.yield()
      ...
      do
        local Coord = AI_ATC2_Airbase and AI_ATC2_Airbase:GetCoordinate()
        if not Coord then
          env.warning("AI_ATC2:StartATIS -> Could not get AI_ATC2_Airbase coordinate.")
        else
          local Fog  = AI_ATC2.ATIS.Data.Fog  or false
          local Rain = AI_ATC2.ATIS.Data.Rain or false
          if Coord:IsDay() and not Fog and not Rain then
            AI_ATC2.ATIS.Data.Approach = "VFR"
            AI_ATC2.Procedure          = "VFR"
          else
            AI_ATC2.ATIS.Data.Approach = "IFR"
            AI_ATC2.Procedure          = "IFR"
          end
        end
      end
      ...
      local useMSRS = AI_ATC2_MSRS and AI_ATC2_MSRS["ATIS"] and AI_ATC2_MSRS["ATIS"].Active or false
      if useMSRS then
        ...
        local Information = AI_ATC2.ATIS.Data.Information or "Alpha"
        ...
        local ZuluTime = AI_ATC2.ATIS.Data.ZULU          or "0000"
        local WindDir  = AI_ATC2.ATIS.Data.WindDirection or "000"
        local WindSpd  = AI_ATC2.ATIS.Data.WindSpeed     or "0"
        local Gusting  = AI_ATC2.ATIS.Data.Gusting

        local time = string.format("%s zulu", AI_ATC2:SRS_ConvertDigits(ZuluTime))

        local wind
        if Gusting then
          wind = string.format("Wind %s at %s, gusting",
            AI_ATC2:SRS_ConvertHeading(WindDir), AI_ATC2:SRS_ConvertDigits(WindSpd))
        else
        ...
        local Visibility = AI_ATC2.ATIS.Data.Visibility or "10"
        local Fog        = AI_ATC2.ATIS.Data.Fog        or false
        local Dust       = AI_ATC2.ATIS.Data.Dust       or false
        local Rain       = AI_ATC2.ATIS.Data.Rain       or false
        local Preset     = AI_ATC2.ATIS.Data.Preset     or ""

        local weatherItems = {}

        if Visibility == "10" then
          weatherItems[#weatherItems + 1] = string.format("Visibility greater than %s",
            AI_ATC2:SRS_ConvertDigits(Visibility))
        else
        ...
        if Fog then
          local Thickness = AI_ATC2.ATIS.Data.FogThickness or "1000"
          weatherItems[#weatherItems + 1] = string.format("persistent fog below %s",
            AI_ATC2:SRS_ConvertAltitude(Thickness))
        end
        ...
        if Rain and AI_ATC2_CloudPresets and AI_ATC2_CloudPresets[Preset] and AI_ATC2_CloudPresets[Preset].Rain then
          weatherItems[#weatherItems + 1] = AI_ATC2_CloudPresets[Preset].Rain
        end

        if AI_ATC2_CloudPresets and AI_ATC2_CloudPresets[Preset] and AI_ATC2_CloudPresets[Preset].Thunderstorm then
          local TypeTS = AI_ATC2_CloudPresets[Preset].Thunderstorm
        ...
        do
          local Clouds = AI_ATC2.ATIS.Data.Cloud or "Clear clouds"
          local Base   = AI_ATC2.ATIS.Data.Base  or "1000"
          local spokenBase = AI_ATC2:SRS_ConvertAltitude(Base)
        ...
        local Temperature = AI_ATC2.ATIS.Data.Temperature or "20"
        local DewPoint    = AI_ATC2.ATIS.Data.DewPoint    or "10"
        local tempDew = string.format("Temperature %s, dew point %s",
          AI_ATC2:SRS_ConvertDigits(Temperature), AI_ATC2:SRS_ConvertDigits(DewPoint))
        coroutine.yield()
        ...
        local QNH = AI_ATC2.ATIS.Data.QNH or "29.92"
        local altimeter = string.format("Altimeter %s", AI_ATC2:SRS_ConvertDigits(QNH))
        coroutine.yield()
        ...
        do
          local ActiveRunway    = AI_ATC2.ATIS.Data.Active
          local DepartureRunway = AI_ATC2.ATIS.Data.Departure or "03L"
          local ArrivalRunway   = AI_ATC2.ATIS.Data.Arrival   or "21L"
          local Approach        = AI_ATC2.ATIS.Data.Approach  or "IFR"
          local spokenArr = AI_ATC2:SRS_ConvertRunway(ArrivalRunway)

          local runways
          if not ActiveRunway then
            local spokenDep = AI_ATC2:SRS_ConvertRunway(DepartureRunway)
            runways = string.format("Departure runway %s, arrival runway %s", spokenDep, spokenArr)
          else
            local spokenAct = AI_ATC2:SRS_ConvertRunway(ActiveRunway)
          ...
          AI_ATC2.ATIS.Data.FC3switch = false
          coroutine.yield()
          ...
          AI_ATC2:TransmitSRS("ATIS", fullATIS, 0)
        end
        coroutine.yield()
        ...
        do
          ...
          AI_ATC2:AirbaseName(AirbaseName, RadioObject, Title)
          RadioObject:NewTransmission("Information.ogg", 0.819, "Airbase_ATC/ATIS/SoundFiles/", nil, 0.1)
          AI_ATC2:Phonetic(Information, RadioObject, Title)
        end
        coroutine.yield()
        ...
        do
          local ZuluTime      = AI_ATC2.ATIS.Data.ZULU
          local WindDirection = AI_ATC2.ATIS.Data.WindDirection
          local WindSpeed     = AI_ATC2.ATIS.Data.WindSpeed
          local Gusting       = AI_ATC2.ATIS.Data.Gusting
          ...
          AI_ATC2:ReadDigits(ZuluTime, RadioObject, Title)
          AI_ATC2:Phonetic("Zulu", RadioObject, Title)
          ...
          AI_ATC2:ReadDigits(WindDirection, RadioObject, Title)
          RadioObject:NewTransmission("At.ogg", 0.418, "Airbase_ATC/ATIS/SoundFiles/", nil, 0.05)
          AI_ATC2:ReadDigits(WindSpeed, RadioObject, Title)
        ...
        do
          ...
          if Visibility == "10" then
            ...
            RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/ATIS/SoundFiles/", nil, 0.5, Subtitle, 3)
            RadioObject:NewTransmission("Visibility.ogg", 0.798, "Airbase_ATC/ATIS/SoundFiles/", nil, 0.0)
            AI_ATC2:ReadDigits(Visibility, RadioObject, Title)
          end
          ...
          if Fog then
            ...
            AI_ATC2:ReadThousands(Thickness, RadioObject, Title)
          end
          ...
          if Rain and AI_ATC2_CloudPresets and AI_ATC2_CloudPresets[Preset] and AI_ATC2_CloudPresets[Preset].Rain then
            local TypeRain = AI_ATC2_CloudPresets[Preset].Rain
          ...
          if AI_ATC2_CloudPresets and AI_ATC2_CloudPresets[Preset] and AI_ATC2_CloudPresets[Preset].Thunderstorm then
            ...
            if TypeTS == "Scattered thunderstorms" then
              Subtitle = string.format("%s: Scattered thunderstorms in the vicinity", Title)
              RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/ATIS/SoundFiles/", nil, 0.5, Subtitle, 2)
        ...
        do
          ...
          local function readClouds(titleTrans, oggFile)
            ...
            RadioObject:NewTransmission("At.ogg", 0.418, "Airbase_ATC/ATIS/SoundFiles/", nil, 0.05)
            AI_ATC2:ReadThousands(Base, RadioObject, Title)
          end
        ...
        do
          ...
          AI_ATC2:ReadDigits(Temperature, RadioObject, Title)
          ...
          AI_ATC2:ReadDigits(DewPoint, RadioObject, Title)
        end
        coroutine.yield()
        ...
        do
          ...
          AI_ATC2:ReadDigits(QNH, RadioObject, Title)
        end
        coroutine.yield()
        ...
        do
          ...
          if not ActiveRunway then
            ...
            AI_ATC2:Runway2(DepartureRunway, RadioObject, Title)
            ...
            AI_ATC2:Runway2(ArrivalRunway, RadioObject, Title)
          else
            ...
            AI_ATC2:Runway2(ActiveRunway, RadioObject, Title)
          end
      ...
      if useMSRS then
        ...
        while true do
          local queueEmpty = (ATIS_RADIO2 and ATIS_RADIO2.queue and #ATIS_RADIO2.queue == 0) or false
          if queueEmpty then
            break
          end
      ...
      if AI_ATC2.ATIS.Data.Count > 30 then
        AI_ATC2:InitATIS()
      end
      AI_ATC2.ATIS.Data.Count = (AI_ATC2.ATIS.Data.Count or 0) + 1
      coroutine.yield()

    end

    if AI_ATC2 and AI_ATC2.ATIS then
      AI_ATC2.ATIS.Active = false
    end
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ClearanceDelivery(Alias, Departure, Transition, Audio)

  local Transmitter = "Clearance"
  --local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local RadioObject = CLEARANCE_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  local Unit = ClientData.Unit
  local Group = Unit:GetGroup()
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:ClearanceDelivery(Alias, Departure, Transition, Audio) end, Transmitter)==false then
    return
  end
  
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:GroundStartSubMenu(Alias)
  AI_ATC2:ReadBackSubMenu(Alias)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  local Squawk, FirstDigit, DepartureData, Dsf, Dd, TransitionData, Tsf, Td, Instruction, SubDuration, RequestedProcedure, DepartureSub,
  Sequential
  
  SCHEDULER:New(nil, function()
    AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:ClearanceDelivery(Alias, Departure, Transition, true) end)
    RequestedProcedure = ClientData.RequestedProcedure
    if RequestedProcedure=="VFR" then
      DepartureSub = "cleared departure as filed"
      SubDuration = 9
    else
      DepartureData = ClearanceSoundFiles2[Runway][Departure]
      Dsf = DepartureData.file
      Dd = DepartureData.duration
      if Transition then
        TransitionData = DepartureData[Transition]
        Tsf = TransitionData.file
        Td = TransitionData.duration
        Instruction = Departure.." "..Transition.." transition."
      else
        Instruction = Departure.." departure."
      end
      DepartureSub = "cleared Silverbow airbase via "..Instruction
      SubDuration = 3
    end
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:ChannelOpen(14, Transmitter, Alias)
    local Subtitle = string.format("%s: %s, %s, %s.", Title, CallsignSub, Title, DepartureSub )
    local Subtitle1 = Subtitle..string.format(" Contact Nellis Control on 254.4, Squawk %s%s", Squawk, Sequential)
    if AI_ATC2_MSRS and AI_ATC2_MSRS["Clearance"] and AI_ATC2_MSRS["Clearance"].Active then
      local spokenSquawk   = AI_ATC2:SRS_ConvertDigits(Squawk)
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local msg
      ...
      if RequestedProcedure=="VFR" then
        msg = string.format(
          ...
          .. "Contact Nellis control on two five four decimal four. Squawk %s%s",
          spokenCallsign, AI_ATC2.AirbaseAlias, spokenSquawk, Sequential)
      else
        local spokenDeparture = AI_ATC2:SRS_ConvertNavFix(Departure)
        if Transition then
          local spokenTransition = AI_ATC2:SRS_ConvertNavFix(Transition)
          msg = string.format(
            "%s, %s Clearance. Cleared Silverbow airbase via %s %s transition. "
            .. "Contact Nellis Control on two five four decimal four. Squawk %s%s",
            spokenCallsign, AI_ATC2.AirbaseAlias, spokenDeparture, spokenTransition, spokenSquawk, Sequential)
        else
          msg = string.format(
            "%s, %s Clearance. Cleared Silverbow airbase via %s departure. "
            .. "Contact Nellis control on two five four decimal four. Squawk %s%s",
            spokenCallsign, AI_ATC2.AirbaseAlias, spokenDeparture, spokenSquawk, Sequential)
        end
      end

      AI_ATC2:TransmitSRS("Clearance", msg, 0, nil, RadioObject, Subtitle1, 4 + SubDuration)
      return
    end
    
    RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, nil, Subtitle, 4 + SubDuration)
    AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
    RadioObject:NewTransmission("SilverbowClearance.ogg", 1.115, "Airbase_ATC/Clearance/SoundFiles/", nil, 0.2)
    if RequestedProcedure=="VFR" then
      RadioObject:NewTransmission("AsFiled.ogg", 1.277, "Airbase_ATC/Clearance/SoundFiles/", nil, 0.2)
    else
      RadioObject:NewTransmission("SilverbowVia.ogg", 1.486, "Airbase_ATC/Clearance/SoundFiles/", nil, 0.2)
      RadioObject:NewTransmission(Dsf, Dd, "Airbase_ATC/Clearance/SoundFiles/", nil, nil)
      if Transition then
        RadioObject:NewTransmission(Tsf, Td, "Airbase_ATC/Clearance/SoundFiles/", nil, nil)
      end
    end
    Subtitle = string.format("%s: Contact Nellis Control on 254.4, Squawk %s%s", Title, Squawk, Sequential)
    ...
    if Squawk and string.find(Squawk, "001", 1, true) then
      AI_ATC2:ReadDigits(FirstDigit, RadioObject, Transmitter)
      RadioObject:NewTransmission("ZeroZeroOne.ogg", 1.033, "Airbase_ATC/Clearance/SoundFiles/", nil, 0.05)
    else
      AI_ATC2:ReadDigits(Squawk, RadioObject, Transmitter)
    end
    if Flight then
...
--****************************************************************************CLEARANCE READBACK*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ClearanceReadBack(Alias, code)
  local Transmitter      = "Clearance"
  --local RadioObject      = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local RadioObject      = CLEARANCE_RADIO2
  local Title            = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:ClearanceReadBack(Alias, code) end, Transmitter) == false then
    return
  end
  ...
  if Squawk~=code then
    ...
    local Transition = ClientData.Transition
    AI_ATC2:ClearanceDelivery(Alias, Departure, Transition, true)
    return
  end
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:ClearanceSubMenu(Alias)
  AI_ATC2:GroundStartSubMenu(Alias)
  ...
  local function Execute()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:ClearanceReadBack(Alias, code) end)
      AI_ATC2:ChannelOpen(6, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Readback Correct, Contact Ground control prior to Taxi.", Title, CallsignSub )

      if AI_ATC2_MSRS and AI_ATC2_MSRS["Clearance"] and AI_ATC2_MSRS["Clearance"].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, readback correct. Contact Ground control prior to taxi.", spokenCallsign)
        AI_ATC2:TransmitSRS("Clearance", msg, 0, nil, RadioObject, Subtitle, 6)
        return
      end
...
--*******************************************************************************START AI_ATC2************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:EngineStart(Alias, Audio)

  local Transmitter = "Ground"
  local RadioObject = GROUND_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  local Unit = ClientData.Unit
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:EngineStart(Alias, Audio) end, Transmitter)==false then
    return
  end
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:EngineStart(Alias, true) end)
  
  if Audio ~= true then
    AI_ATC2:ChannelOpen(8, Transmitter, Alias)
    ATM2.ClientData[Alias].GroundMenu:RemoveSubMenus()
    AI_ATC2:TaxiSubMenu(Alias)
  ...
  if ClientData.EngineStart ~= nil then 
    EngineStart = AI_ATC2.MissionStart + ClientData.EngineStart 
  else 
    EngineStart = 0 
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      ...
      if ActualTime >= EngineStart then
        ...
        local msg = string.format("%s, %s ground. Engine start approved, advise when ready to taxi.",
          spokenCallsign, AI_ATC2.AirbaseAlias)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
      else
        ...
        local spokenHour = AI_ATC2:SRS_ConvertDigits(clockParts[1] or "00")
        local spokenMin  = AI_ATC2:SRS_ConvertDigits(clockParts[2] or "00")
        local msg = string.format("%s, negative. Your engine start time is %s %s local, as fragged.",
      ...
      SCHEDULER:New(nil, function()
        if Type=="C-130J-30" then
          if ATM2.ClientData[Alias].CrewChief then
            ATM2.ClientData[Alias].CrewChief:Destroy()
          end
        end
      end,{}, 10)
    ...
    if ActualTime >= EngineStart then
      ...
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      AI_ATC2:AirbaseName(AI_ATC2.Airbase, RadioObject, Transmitter)
      ...
      AI_ATC2:ProcessTime(EngineStartClock, RadioObject, Transmitter)
...
--*******************************************************************************ATC TAXI CLEARANCE******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeloTaxi(Alias, Audio)
  local Transmitter = "Ground"
  local RadioObject = GROUND_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  local Group = Unit:GetGroup()
  local RadioKey = AI_ATC2.Radio[Transmitter].Key
  local Juliett = AI_ATC2_SoundFiles[RadioKey].Phonetic["Juliett"]
  local Kilo = AI_ATC2_SoundFiles[RadioKey].Phonetic["Kilo"]
  local Callsign = ClientData.Callsign
  local FlightCallsign = ClientData.FlightCallsign
  local Flight = ClientData.Flight
  local CallsignSub = Flight and FlightCallsign or Callsign
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:HeloTaxi(Alias, Audio) end, Transmitter)==false then
    return
  end
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:HeloTaxi(Alias, true) end)
  if Audio~=true then
    ATM2.ClientData[Alias].GroundMenu:RemoveSubMenus()
    --AI_ATC2:CrossPadSubMenu(Alias)
    AI_ATC2:HeloHoldShort(Alias)
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, %s ground. Taxi via juliett, kilo. Contact tower holding short of jolly.",spokenCallsign,AI_ATC2.AirbaseAlias)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
      return
    end
...
--*******************************************************************************ATC TAXI CLEARANCE******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiClearance(Alias)
  local Transmitter = "Ground"
  local ClientData = ATM2.ClientData[Alias]
  if not ClientData or not ClientData.Unit then
    env.info(string.format("AI_ATC2:TaxiClearance - Invalid Alias '%s'.", Alias))
    return
  end
  
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TaxiClearance(Alias) end, Transmitter)==false then
    return
  end
  ...
  local gc = ATM2.GroundControl[Alias]
  if not gc or gc.State == "Cold" or gc.State == "Landing" or gc.State == "Airborne" then
    if not AI_ATC2:ForceGroundRegistration(Alias) then
      return
    end
  end

  ATM2.GroundControl[Alias].TaxiRequested = true
  
  SCHEDULER:New(nil, function()
    if ClientData.Heliport==true then
      Runway = AI_ATC2.Runways.Heliport[1]
    end
    TaxiSubtitle = AI_ATC2:TaxiSubtitle(Alias)
    HoldShort = AI_ATC2:HoldShort(Alias)
    AI_ATC2:TaxiRequest(Alias)
  end,{}, 0.5)
  
  local function TaxiPermission()
    local function Audio()
      AI_ATC2:RepeatLastTransmission(Alias, function()Audio() end)
      local Subtitle = string.format("%s: %s, %s. Runway %s. Taxi via %s. ", Title, CallsignSub, Title, Runway, TaxiSubtitle )

      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway   = AI_ATC2:SRS_ConvertRunway(Runway)
        local spokenHold     = AI_ATC2:SRS_ConvertRunway(HoldShort)
        local taxiQueue      = AI_ATC2:TaxiQueue(Alias, RadioObject, Transmitter, false)
        local msg = string.format("%s, %s ground. Runway %s, taxi via %s.%s Contact tower holding short runway %s.",
          spokenCallsign, AI_ATC2.AirbaseAlias, spokenRunway, TaxiSubtitle, taxiQueue or "", spokenHold)
          
        local Subtitle1 = Subtitle..taxiQueue..string.format(". Contact tower holding short runway %s", HoldShort )
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle1, 10)
        return
      end

      AI_ATC2:ChannelOpen(10, Transmitter, Alias)
      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, nil, Subtitle, 6)
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      AI_ATC2:AirbaseName(AI_ATC2.Airbase, RadioObject, Transmitter)
      RadioObject:NewTransmission("Ground.ogg", 0.383, "Airbase_ATC/Ground/SoundFiles/", nil, nil)
      RadioObject:NewTransmission("Runway.ogg", 0.473, "Airbase_ATC/Ground/SoundFiles/", nil, 0.2)
      AI_ATC2:Runway(Runway, RadioObject, Transmitter)
      RadioObject:NewTransmission("Taxivia.ogg", 0.778, "Airbase_ATC/Ground/SoundFiles/", nil, 0.2)
      AI_ATC2:ReadTaxiInstructions(Alias, RadioObject, Transmitter)
      AI_ATC2:TaxiQueue(Alias, RadioObject, Transmitter, true)
      ...
      AI_ATC2:Runway(HoldShort, RadioObject, Transmitter)
    end
    Audio()
    AI_ATC2:ResetMenus(Alias)
    SCHEDULER:New(nil, function()
      AI_ATC2:HoldShortTracker(Alias)
    end,{}, 10)
  ...
  local function HoldPosition()
    local function Audio()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 3)
        return
      end

      AI_ATC2:ChannelOpen(7, Transmitter, Alias)
    ...
    SchedulerObject = SCHEDULER:New(nil, function()
      if ATM2.GroundControl[Alias] then
        if ATM2.GroundControl[Alias].TaxiAuthority == true then
          TaxiPermission()
          SchedulerObject:Stop()
        elseif ATM2.GroundControl[Alias].TaxiAuthority == false then
          AI_ATC2:TaxiRequest(Alias)
        end
      end
    end,{}, 1, 1 )
  ...
  SCHEDULER:New(nil, function()
    if ATM2.GroundControl[Alias] and ATM2.GroundControl[Alias].TaxiAuthority == true then
      TaxiPermission()
    else
      HoldPosition()
    end
...
--*******************************************************************************ATC HELO HOLD SHORT**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeloHoldShort(Alias)
  local Transmitter = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = TOWER_RADIO2
  local ClientObject = ATM2.ClientData[Alias]
  local Unit = ClientObject.Unit
  local Group = Unit:GetGroup()
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:HeloHoldShort(Alias) end, Transmitter)==false then
    return
  end
  ...
  SchedulerObject = SCHEDULER:New(nil, function()
    if Unit and Unit:IsAlive() and ATM2.ClientData[Alias] and ATM2.GroundControl[Alias] then
      if Unit:IsInZone(HoldShort) then
        ...
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          ...
          AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 1)
          AI_ATC2:CrossPadSubMenu(Alias)
          SchedulerObject:Stop()
          return
        end
...
--*******************************************************************************ATC HOLD SHORT**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HoldShortTracker(Alias)
  local Transmitter = "Tower"
  local ClientData = ATM2.ClientData[Alias]

  if not ClientData or not ClientData.Unit then
    env.info(string.format("AI_ATC2:HoldShortTracker - Invalid Alias '%s'.", Alias))
    return
  end
  ...
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local HoldShort, TaxiHold = AI_ATC2:HoldShort(Alias)
  local SchedulerObjects = ClientData.SchedulerObjects or {}
  local Callsign = ClientData.Callsign
  local Flight = ClientData.Flight
  local CallsignSub = Flight and ClientData.FlightCallsign or Callsign

  local HoldShortZones = HoldShortData2[HoldShort]
  if not HoldShortZones or #HoldShortZones == 0 then
    env.info(string.format("AI_ATC2:HoldShortTracker - No HoldShort zones for '%s'.", HoldShort))
    return
  end
  ...
  for index, ZoneObject in ipairs(HoldShortZones) do
    if AI_Wingman_1_Unit then
      ...
      local GuardZone = RunwayGuard2[HoldShort] and RunwayGuard2[HoldShort][index]
      if GuardZone then
        local GuardCoord = GuardZone:GetCoordinate()
        AI_ATC2:SpawnHoldShort(GuardCoord, index)
      end
    end
      ...
      if Unit and Unit:IsAlive() then
        ...
        if Coord:Get2DDistance(ZoneCoord) <= 50 then
          ...
          if Runway ~= HoldShort or TaxiHold then
            AI_ATC2:CrossRunwaySubMenu(Alias, HoldShort)
          else
            AI_ATC2:TakeOffSubMenu(Alias)
          end
...
--*******************************************************************************ATC CROSS RUNWAY********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CrossRunway(Alias, Audio)
  local Transmitter = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = TOWER_RADIO2
  local ClientData = ATM2.ClientData[Alias]
  ...
  local Group = Unit:GetGroup()
  local Runway = AI_ATC2.Runways.Takeoff[1]
  local HoldShort = ATM2.GroundControl[Alias].HoldShort
  local Callsign = ClientData.Callsign
  local FlightCallsign = ClientData.FlightCallsign
  local Flight = ClientData.Flight
  local CallsignSub = Flight and FlightCallsign or Callsign
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:CrossRunway(Alias, Audio) end, Transmitter)==false then
    return
  end
  ...
  if Audio~=true then
    USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:CrossRunway(Alias, true) end)
    AI_ATC2:TakeOffSubMenu(Alias)
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      ...
      local spokenHold     = AI_ATC2:SRS_ConvertRunway(HoldShort)
      local spokenRunway   = AI_ATC2:SRS_ConvertRunway(Runway)
      local msg = string.format("%s, cross runway %s, hold short runway %s.",
...
--*******************************************************************************ATC TAKE PAD************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TakePad(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TakePad(Alias) end, Transmitter)==false then
    return
  end
  
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:HoverSubMenu(Alias)
  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:TakePad(Alias) end)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      ...
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 4)
      return
    end
...
--*******************************************************************************ATC HOVER CHECK*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HoverCheck(Alias, Agency)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:HoverCheck(Alias, Agency) end, Transmitter)==false then
    return
  end

  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:HoverCheck(Alias, Agency) end)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TakeoffFromParking(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TakeoffFromParking(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    WindDirection = AI_ATC2:RectifyHeading(tostring(math.floor(WindDirection + 0.5)))
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:TerminateSchedules(Alias)
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:DepartureSubMenu(Alias)
    AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:TakeoffFromParking(Alias) end)
    Runway = AI_ATC2.Runways.Takeoff[1]
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenRunway   = AI_ATC2:SRS_ConvertRunway(Runway)
      local spokenWindDir  = AI_ATC2:SRS_ConvertHeading(WindDirection)
      local spokenWindSpd  = AI_ATC2:SRS_ConvertDigits(WindSpeed)
      local msg = string.format("%s, %s tower. Depart the field and remain clear of runway %s, use caution. Wind %s at %s. Cleared for takeoff.",
        spokenCallsign, AI_ATC2.AirbaseAlias, spokenRunway, spokenWindDir, spokenWindSpd)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
      return
    end
    ...
    AI_ATC2:ReadHeading(WindDirection, RadioObject, Transmitter)
    RadioObject:NewTransmission("At.ogg", 0.38, "Airbase_ATC/Ground/SoundFiles/", nil, 0.2)
    AI_ATC2:ReadNumber(WindSpeed, RadioObject, Transmitter)
...
--*******************************************************************************ATC TAKEOFF*************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TakeoffClearance(Alias, Climb, Audio)
  local Transmitter = "Tower"
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TakeoffClearance(Alias, Climb, Audio) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    WindDirection = AI_ATC2:RectifyHeading(tostring(math.floor(WindDirection + 0.5)))
    WindSpeed = tostring(math.floor(UTILS.MpsToKnots(WindSpeed) - 0.5))
    AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:TakeoffClearance(Alias, Climb, true) end)
    
    if Audio~=true then
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      if Jester then Jester:Silence() end
      if ATM2.ClientData[Alias].Mark then
        local RM = COORDINATE:RemoveMark(ATM2.ClientData[Alias].Mark)
      end
    end
  ...
  local function Takeoff()
    SCHEDULER:New(nil, function()
      Subtitle = string.format("%s: %s,%s Runway %s, Wind %s at %s. Cleared for takeoff, switch departure.", Title, CallsignSub, Instruction, Runway, WindDirection, WindSpeed)
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        local climbPart = ""
        if Climb then
          local spokenClimb = AI_ATC2:SRS_ConvertAltitude(Climb)
        ...
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
      ...
      if Climb then
        ...
        AI_ATC2:ReadNumber(Climb, RadioObject, Transmitter)
    ...
    if Audio~=true then
      AI_ATC2.Runways.TakeoffHold = true
      if ATM2.GroundControl[Alias] then
        ATM2.GroundControl[Alias].TaxiAuthority = false
        ATM2.GroundControl[Alias].StartedTaxi = false
        ATM2.GroundControl[Alias].TaxiRequested = false
        ClientData.TakeoffClearance = true
      end
      
      if not ATM2.TowerControl[Alias] then
        ATM2.TowerControl[Alias] = {RequestedApproach = "Straight in", State = "On Departure", Type = Type, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
      else
        ATM2.TowerControl[Alias].RequestedApproach = "Straight in"
        ATM2.TowerControl[Alias].State = "On Departure"
      end
      ...
      SchedulerObject = SCHEDULER:New(nil, function()
        ...
        if Group:IsAlive() and Group:IsAirborne() then
          ATM2.ClientData[Alias].State = "Airborne"
          AI_ATC2.Runways.TakeoffHold = false
          SchedulerObject:Stop()
        elseif not ATM2.GroundControl[Alias] or not Group:IsAlive() then
          AI_ATC2.Runways.TakeoffHold = false
          SchedulerObject:Stop()
      ...
      AI_ATC2:ResetMenus(Alias)
      AI_ATC2:LandingSubMenu(Alias)
      AI_ATC2:DepartureSubMenu(Alias)
      AI_ATC2:TowerHandOff(Alias)
    end
  end
  ...
  local function Lineup()
    ...
    if Audio~=true then
      ...
      SchedulerObject2 = SCHEDULER:New(nil, function()
        ...
        elseif AI_ATC2.Runways.TakeoffHold == false then
          AI_ATC2:ChannelOpen(12, Transmitter, Alias)
          Takeoff()
          SchedulerObject2:Stop()
        end
  ...
  if AI_ATC2.Runways.TakeoffHold == false then
    AI_ATC2:ChannelOpen(12, Transmitter, Alias)
    Takeoff()
  else
    AI_ATC2:ChannelOpen(6, Transmitter, Alias)
...
--***********************************************************************************ATC TOWER HAND OFF***********************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TowerHandOff(Alias)
  local Transmitter = "Tower"
  local AirbaseName = AI_ATC2.Airbase
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TowerHandOff(Alias) end, Transmitter)==false then
    return
  end
  ...
  local function HandOff()
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(7, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:TowerHandOff(Alias) end)
      local Subtitle = string.format("%s: %s, Contact Nellis Control on 254.400. ", Title, CallsignSub)
      
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local nellisControl = AI_ATC2:SRS_ConvertFrequency("NATCF_LEE")
        local msg = string.format("%s, Contact Nellis control on %s.", spokenCallsign, nellisControl)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
  ...
  SchedulerObject = SCHEDULER:New(nil, function()
    if not ATM2.ClientData[Alias] or not UnitObject then 
      SchedulerObject:Stop()
      return
    end
...
--***********************************************************************************ATC DEPARTURE_IDENT***********************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:DepartureIdent(Alias, Audio)
  local Transmitter = "NATCF_LEE"
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:DepartureIdent(Alias, Audio) end, Transmitter)==false then
    return
  end
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:DepartureIdent(Alias, true) end)
  if Audio~=true then
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:IdentSubMenu(Alias)
  end
  
  SCHEDULER:New(nil, function()
    AI_ATC2:ChannelOpen(7, Transmitter, Alias)
    local Subtitle = string.format("%s: %s, Nellis Control, Ident. ", Title, CallsignSub, AirbaseName)

    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, Nellis Control, ident.", spokenCallsign)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
      return
    end
    ...
    AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
    AI_ATC2:AirbaseName("Nellis", RadioObject, Transmitter)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:DepartureCheckin(Alias)
  AI_ATC2:ResetMenus(Alias)
  if ATM2.ClientData[Alias].RequestedProcedure=="IFR" then
    AI_ATC2:IFRDeparture(Alias)
  else
    AI_ATC2:VFRDeparture(Alias)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************************ATC DEPARTURE_CHECKIN***********************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:VFRDeparture(Alias, Audio)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:VFRDeparture(Alias, Audio) end, Transmitter)==false then
    return
  end


  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:VFRDeparture(Alias, true) end)
  if Audio~=true then
    AI_ATC2:TerminateSchedules(Alias)
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:NavigationSubMenu(Alias)

    if AI_ATC and ATM.ClientData[Alias] then
  ...
  SCHEDULER:New(nil, function()
    if Helo then
      TerminalRange = 9260
      Instruction = "Remain at or below 500 until clear of Class D airspace. Cleared Scheduled, Contact BLACKJACK, UHF Channel 16."
    else
      TerminalRange = 55559
      Instruction = "Maintain VFR. Cleared Scheduled, Contact BLACKJACK, UHF Channel 16."
    end
    AirbaseName = "Nellis"
    AirbaseCoord = AI_ATC2_Vec3
    AirbaseVec2 = AirbaseCoord:GetVec2()
    VFRAltitude = tostring(math.random(13, 19))
    AltSub = AI_ATC2:ReadFlightLevel(VFRAltitude, RadioObject, Transmitter, false)
    INSTCN = AI_ATC_Navpoints.INSTCN:GetCoordinate()
  end,{}, 0.5 )

  SCHEDULER:New(nil, function()
    DepartureZone = ZONE_RADIUS:New("Departure", AirbaseVec2, 20372, nil)
    DepartureRadar = SET_GROUP:New():FilterZones({DepartureZone}):FilterActive():FilterCoalitions(AI_ATC2.Coalition):FilterCategories("plane"):FilterOnce()
  ...
  local function TrafficReport()
    ...
    local TrafficHeading = AI_ATC2:CorrectHeading(Traffic:GetHeading())
    ...
    local Bearing = tostring(AI_ATC2:HeadingToClockBearing(Heading))
    local TrafficAltitude = string.sub(tostring(math.floor(Traffic:GetAltitude() / 3.281 + 0.5)), 1, 1)
    local TrafficAltitudeSub = AI_ATC2:ReadFlightLevel(TrafficAltitude, RadioObject, Transmitter, false)
    AI_ATC2:ChannelOpen(7, Transmitter, Alias)
    ...
    AI_ATC2:ReadCardinal(TrafficCardinal, RadioObject, Transmitter)
    RadioObject:NewTransmission("Traffic.ogg", 0.511, "Airbase_ATC/Departure/SoundFiles/", nil, nil)
    AI_ATC2:ClockBearing(Bearing, RadioObject, Transmitter)
    AI_ATC2:ReadDigits(Range, RadioObject, Transmitter)
    RadioObject:NewTransmission("Miles.ogg", 0.641, "Airbase_ATC/Departure/SoundFiles/", nil, 0.05)
    AI_ATC2:ReadFlightLevel(TrafficAltitude, RadioObject, Transmitter, true)
  end

  SCHEDULER:New(nil, function()
    local Subtitle = string.format("%s: %s, %s Control, Radar contact. ", Title, CallsignSub, AirbaseName)

    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenBaseCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenCallsign = Flight and (spokenBaseCallsign .. " flight") or spokenBaseCallsign

      local msg = string.format("%s, %s Control, radar contact.", spokenCallsign, AirbaseName)

      local trafficMsg = AI_ATC2:TrafficReport(Alias, RadioObject, Transmitter, false)
      if trafficMsg then
        msg = msg .. " " .. trafficMsg
      end

      if Helo then
        msg = msg .. " Remain at or below five hundred until clear of Class Delta airspace. Cleared scheduled. Contact black jack, U H F Channel sixteen."
      else
        msg = msg .. " Maintain V F R. Cleared scheduled. Contact black jack, U H F Channel sixteen."
      end

      local SRSubtitle = string.format("%s: %s, %s Control, Radar contact. %s", Title, CallsignSub, AirbaseName, Instruction)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, SRSubtitle, 7)
      return
    end
    ...
    RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Departure/SoundFiles/", nil, nil, Subtitle, 7)
    AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
    AI_ATC2:AirbaseName(AirbaseName, RadioObject, Transmitter)
    RadioObject:NewTransmission("Control.ogg", 0.508, "Airbase_ATC/Departure/SoundFiles/", nil, nil)
    ...
    if Helo then
      ...
      RadioObject:NewTransmission("ClearedScheduled2.ogg", 4.423, "Airbase_ATC/Departure/SoundFiles/", nil, 0.11)
    end
...
--***********************************************************************************ATC TRAFFIC REPORT**************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TrafficReport(Alias, RadioObject, Transmitter, delay)
  ...
  if delay~=false then
    if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TrafficReport(Alias, RadioObject, Transmitter, delay) end, Transmitter)==false then
      return nil
    end
  end
  ...
  if Transmitter=="Attila" or Transmitter=="Spartan" then
    ...
    Title = string.format("%s %s", AI_ATC2.Airbase, Transmitter)
  end
  ...
  Radar = SET_GROUP:New():FilterZones({UnitZone}):FilterActive():FilterCoalitions(AI_ATC2.Coalition):FilterCategories({"plane", "helicopter"}):FilterOnce()
  ...
  local function ReportTraffic(Traffic)
    ...
    TrafficHeading = tonumber(AI_ATC2:CorrectHeading(Traffic:GetHeading()))
    ...
    local BearingHeading = tonumber(AI_ATC2:CorrectHeading(UnitCoord:HeadingTo(TrafficCoord)))
    local RelativeHeading = (BearingHeading - UnitHeading) % 360
    Bearing = tostring(AI_ATC2:HeadingToClockBearing(RelativeHeading))
    local feet = Traffic:GetAltitude() / 0.3048
    TrafficAltitude = string.format("%.1f", feet / 1000)
    TrafficAltitudeSub = AI_ATC2:ReadFlightLevel(TrafficAltitude, RadioObject, Transmitter, false)
    AudioData = SoundFiles[RadioKey]

    if delay == false then
      local spokenAlt = AI_ATC2:SRS_ConvertAltitude(TrafficAltitudeSub)
      local spokenBearing = AI_ATC2:SRS_ConvertClockBearing(Bearing)
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenAlt = AI_ATC2:SRS_ConvertAltitude(TrafficAltitudeSub)
      local spokenBearing = AI_ATC2:SRS_ConvertClockBearing(Bearing)
      local msg = string.format("%s bound traffic, %s o'clock, %s miles, at %s.", TrafficCardinal:lower(), spokenBearing, Range, spokenAlt)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
      return nil
    end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RequestApproach(Alias)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local Airbase = AI_ATC2.Airbase
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientObject = ATM2.ClientData[Alias]
  local Unit = ClientObject.Unit
  local Group = Unit:GetGroup()
  ...
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:ApproachSubMenu(Alias)
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:RequestApproach(Alias) end, Transmitter)==false then
    return
  end
  
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Say request", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, radar contact. Say request.", spokenCallsign)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 8)
        return
      end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RadarTerminate(Alias, Audio)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:RadarTerminate(Alias, Audio) end, Transmitter)==false then
    return
  end
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:RadarTerminate(Alias, true) end)
  ...
  if ATM2.TowerControl[Alias] and ATM2.TowerControl[Alias].Schedules then
    for _, sched in ipairs(ATM2.TowerControl[Alias].Schedules) do
      sched:Stop()
    end
    ATM2.TowerControl[Alias] = nil
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:ChannelOpen(8, Transmitter, Alias)
    local Subtitle = string.format("%s: %s, Radar service terminated. Cleared SCHEDULED, Contact BlackJack UHF Channel 16.", Title, CallsignSub)
    
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, radar service terminated, cleared scheduled. Contact black jack U H F Channel sixteen.", spokenCallsign)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
...
--***********************************************************************************ATC IFR DEPARTURE***************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IFRDeparture(Alias, Audio)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:IFRDeparture(Alias) end, Transmitter)==false then
    return
  end
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:IFRDeparture(Alias, true) end)
  ...
  local AirbaseName, TQQTCN, Runway, SchedulerObject, Destination, DestCoord, Filename, Duration, SID, Transition  
  ...
  local function CalculateTurnDirection(Object, TargetHdg)
    local ObjectHeading = tonumber(AI_ATC2:CorrectHeading(Object:GetHeading()))
  ...
  SCHEDULER:New(nil, function()
    AirbaseName = AI_ATC2.Airbase
    TQQTCN = AI_ATC_Navpoints.TQQTCN:GetCoordinate()
    Runway = AI_ATC2.Runways.Takeoff[1]
    SID = ClientData.SID
    ...
    AltSub = AI_ATC2:ReadFlightLevel(Altitude, RadioObject, Transmitter, false)
    Range = TQQTCN:Get2DDistance(DestCoord) + 5556
  end,{}, 0.5 )
  ...
  SCHEDULER:New(nil, function()
    if SIDdata.SpecialInstruction then
      ...
      InstructionSub = InstructionSub.."turn "..Turn.." heading "..Bearing
    end
  end,{}, 1.0 )
  
  SCHEDULER:New(nil, function()
    AI_ATC2:ChannelOpen(14, Transmitter, Alias)
    local Subtitle = string.format("%s: %s, Nellis Control, Radar contact.", Title, CallsignSub)

    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenSID = AI_ATC2:SRS_ConvertNavFix(SID)
      local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(AltSub)
      local spokenDestination = AI_ATC2:SRS_ConvertNavFix(Destination)
      local trafficMsg = AI_ATC2:TrafficReport(Alias, RadioObject, Transmitter, false)
      local spokenInstruction = InstructionSub

      if SIDdata.SpecialInstruction then
        local spokenBearing = AI_ATC2:SRS_ConvertHeading(Bearing)
        spokenInstruction = SIDdata.Instruction.Subtitle .. "turn " .. string.lower(Turn) .. " heading " .. spokenBearing
      end

      local msg = string.format("%s, Nellis Control, radar contact.", spokenCallsign)

      if trafficMsg then
        msg = msg .. " " .. trafficMsg
      end

      msg = msg .. string.format(" %s departure, %s, climb and maintain %s. Report %s.",
    ...
    if SIDdata.SpecialInstruction then
       ...
       AI_ATC2:ReadHeading(Bearing, RadioObject, Transmitter)
    end
    ...
    AI_ATC2:ReadFlightLevel(Altitude, RadioObject, Transmitter, true)
    RadioObject:NewTransmission("Report.ogg", 0.386, "Airbase_ATC/Departure/SoundFiles/", nil, 0.05)
    AI_ATC2:ReadNavpoint(Destination, RadioObject, Transmitter)
  end,{}, Delay )

  local function ServiceTerminate()
    SchedulerObject = SCHEDULER:New(nil, function()
      if Unit and Unit:IsAlive() and ATM2.ClientData[Alias] then
        local UnitCoord = Unit:GetCoord()
        local Failsafe = UnitCoord:Get2DDistance(TQQTCN)
        if Failsafe >= Range then
          AI_ATC2:RadarTerminate(Alias)
          SchedulerObject:Stop()
        end
      else
        SchedulerObject:Stop()
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ApproachCheckIn(Alias, Type)
  if AI_ATC and ATM.ClientData[Alias] then
    AI_ATC:TerminateSchedules(Alias)
    AI_ATC:ResetMenus(Alias)
  end
  ...
  if Type == "VFR" then
    ...
    AI_ATC2:VFRApproach(Alias)
  elseif Type=="IFR" then
    ClientData.Approach.Type="IFR"
    AI_ATC2:IFRApproach(Alias)
  elseif ClientData.Approach.Type=="Generic" then
    --AI_ATC2:GenericApproach(Alias)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*******************************************************************************ATC VFR APPROACH********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:VFRApproach(Alias)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local ClientData = ATM2.ClientData[Alias]
  local Unit = ClientData.Unit
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:VFRApproach(Alias) end, Transmitter)==false then
    return
  end
  ...
  if Heliport then
    ...
    Runway = AI_ATC2.Runways.Landing[1]
  end
  
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:ApproachAssistMenu(Alias, false)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(9, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control. Radar contact. Expect visual approach for runway %s", Title, CallsignSub, Runway )

      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC2:SRS_ConvertRunway(Runway)
        local msg = string.format("%s, Nellis Control. Radar contact. Expect visual approach for runway %s.",
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:Push_Tower(Alias)
  end,{}, 12)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--*************************************************************************ATC IFR APPROACH**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IFRApproach(Alias)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local ClientData = ATM2.ClientData[Alias]
  local Unit = ClientData.Unit
  ...
  local Flight = ClientData.Flight
  local CallsignSub = Flight and FlightCallsign or Callsign
  local Airbase = AI_ATC2.AirbaseAlias
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local Delay = 1.5 + math.random() * (2.5 - 1.5)
  
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:IFRApproach(Alias) end, Transmitter)==false then
    return
  end
  
  AI_ATC2:TerminateSchedules(Alias)
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:ApproachTypeMenu(Alias)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(9, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control. Radar contact. Say request?", Title, CallsignSub)

      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, Nellis Control. Radar contact. Say request?",
          spokenCallsign)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 4)
        return
      end
...
--***************************************************************************GENERIC APPROACH************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GenericApproach(Alias)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local Airbase = AI_ATC2.Airbase
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:GenericApproach(Alias) end, Transmitter)==false then
    return
  end
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      AI_ATC2:ChannelOpen(9, Transmitter, Alias)
      UnitCoord = Unit:GetCoord()
      local TurnHeading = AI_ATC2:CorrectHeading(UnitCoord:HeadingTo(Destination)+0.5)
      local Subtitle = string.format("%s: %s, Nellis Control, fly heading %s, Expect %s approach for runway %s", Title, CallsignSub, TurnHeading, Approach, Runway )

      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading = AI_ATC2:SRS_ConvertHeading(TurnHeading)
        local spokenRunway = AI_ATC2:SRS_ConvertRunway(Runway)
        local msg = string.format("%s, Nellis Control, fly heading %s, expect %s approach for runway %s.",
      ...
      AI_ATC2:ReadHeading(TurnHeading, RadioObject, Transmitter)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IFRApproachType1(Alias, Type, Missed)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:IFRApproachType1(Alias, Type, Missed) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    if Runway~=nil then
      Chart =  AI_ATC2.Charts[Runway][Type]
    ...
    ATM2.ClientData[Alias].Recovery = Recovery
    ATM2.ClientData[Alias].Chart = Approach
    ATM2.ClientData[Alias].Approach.PatternAltitude = Altitude
    PlayerCoord = Unit:GetCoord()
    TurnHeading = AI_ATC2:CorrectHeading(PlayerCoord:HeadingTo(Destination)+0.5)
    TurnSub = AI_ATC2:Heading(TurnHeading, RadioObject, Transmitter, false )
    PlayerAltitude = math.abs(Unit:GetAltitude()* 3.28084)
    Altitude = ATM2.ClientData[Alias].Approach.PatternAltitude
    AltSub = AI_ATC2:ReadFlightLevel(Altitude, RadioObject, Transmitter, false)
  end,{}, 0.5 )
  ...
  SCHEDULER:New(nil, function()
    ...
    Sqwuak = "Maintain current squawk"
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:ApproachAssistMenu(Alias, true, false)
  end, {}, 1.0)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control, fly heading %s. %s. %s. Report %s.", Title, CallsignSub, TurnHeading, AltSubtitle, Sqwuak, Recovery )
      
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(TurnHeading)
        local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(AltSub)
        local spokenRecovery = AI_ATC2:SRS_ConvertNavFix(Recovery)
        local msg = string.format("%s, Nellis Control, fly heading %s, %s %s, maintain current squawk, report %s.",
      ...
      RadioObject:NewTransmission("Report.ogg", 0.386, "Airbase_ATC/Departure/SoundFiles/", nil, 0.05)
      AI_ATC2:ReadNavpoint(Recovery, RadioObject, Transmitter)
    end,{}, Delay )
  end
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:ApproachReportFix(Alias, nil, Missed)
  end,{}, 12 )
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IFRApproachType2(Alias, Type, Missed)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:IFRApproachType2(Alias, Type, Missed) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    AirbaseCoord = AI_ATC2_Vec3
    ApproachBearing = AI_ATC2:CorrectHeading(AirbaseCoord:HeadingTo(UnitCoord))
    CardinalBearing = UTILS.BearingToCardinal(tonumber(ApproachBearing))
    if not LocaliserTable[Runway][CardinalBearing] then
      AI_ATC2:IFRApproachType3(Alias, Type, true)
      return
    else
      ApproachData = LocaliserTable[Runway][CardinalBearing]
      Fix = ApproachData.Navpoint
    end
    ATM2.ClientData[Alias].Recovery = Fix
    ATM2.ClientData[Alias].Chart = Type
    ATM2.ClientData[Alias].Approach.PatternAltitude = Altitude
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:ApproachAssistMenu(Alias, true, true)
  end,{}, 0.5 )
  ...
  local function Message()
    ...
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control. %s. Proceed direct %s and fly the 16DME arc to runway %s.", Title, CallsignSub, AltSubtitle, Fix, Runway )
      
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway   = AI_ATC2:SRS_ConvertRunway(Runway)
        local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(AltSub)
        local spokenFix      = AI_ATC2:SRS_ConvertNavFix(Fix)
      
        local msg = string.format("%s, Nellis control, %s %s, proceed direct %s, fly the sixteen D M E arc to runway %s. Report established on the arc.",
          spokenCallsign, string.lower(condition), spokenAltitude, spokenFix, spokenRunway)
      
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 9)
        return
      end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IFRApproachType3(Alias, Type, Call, Base)
  ...
  local RadioObject    = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local Runway         = AI_ATC2.Runways.Landing[1]
  local TQQTCN         = AI_ATC_Navpoints.TQQTCN:GetCoordinate()
  local AirbaseCoord   = AI_ATC2_Vec3
  local ClientObject   = ATM2.ClientData[Alias]
  local Unit           = ClientObject.Unit
  local Group          = Unit:GetGroup()
  ...
  if Call ~= true then
    USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
    if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:IFRApproachType3(Alias, Type, nil, Base) end, Transmitter) == false then
      return
    end
  end
  ...
  local function CalculateBearing(Object)
    return math.floor(tonumber(AI_ATC2:CorrectHeading(AirbaseCoord:HeadingTo(Object:GetCoordinate()))) + 0.5)
  end
  ...
  local function CalculateSideOfRunway(unitCoord, runwayHdg, airbaseCoord)
    ...
    local bearing = AI_ATC2:CorrectHeading(airbaseCoord:HeadingTo(unitCoord))
  ...
  local function CalculateCardinalBearing(Object)
    local brg = AI_ATC2:CorrectHeading(AirbaseCoord:HeadingTo(Object:GetCoordinate()))
  ...
  local function ClosestNavPoint(Object)
    ...
    local Table = ApproachSettings2[Modifier][Runway][Type].Offset
    local shortestDistance = math.huge
  ...
  local function UpdateVariables()
    local data = ApproachSettings2[Modifier][Runway] 
      and ApproachSettings2[Modifier][Runway][Type]
    ...
    if data.Offset then
      ...
      AI_ATC2:VectorToFinal(Alias, offsetTbl, Transmitter)
      AI_ATC2:CancelIFRSubMenu(Alias)
  ...
  local function CorrectHeading(NewHeading)
    if AI_ATC2:FunctionDelay(Alias, function() CorrectHeading(NewHeading) end, Transmitter) == false then
      return
    end
    AI_ATC2:RepeatLastTransmission(Alias, function() CorrectHeading(NewHeading) end)
    local RadioObject  = AI_ATC2:FindTransmitter(Alias, Transmitter)
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control, fly heading %s.", Title, CallsignSub, NewHeading)

      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(NewHeading)
        local msg = string.format("%s, Nellis Control, fly heading %s.",
      ...
      RadioObject:NewTransmission("Control.ogg", 0.508, "Airbase_ATC/Departure/SoundFiles/", nil, nil)
      RadioObject:NewTransmission("FlyHeading.ogg", 0.801,"Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
      AI_ATC2:ReadHeading(NewHeading, RadioObject, Transmitter)
    end, {}, 0.5)
  end
  ...
  local function HeadingCorrection(Hdg)
    ...
    SchedulerObject3 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        UnitHdg = AI_ATC2:CorrectHeading(Unit:GetHeading())
        UnitCoord = Unit:GetCoordinate()
        HeadingDiff = CalculateHeadingDiff(UnitHdg, AdvisedHeading)
        if HeadingDiff <= 5 then
          Vector = tonumber(AI_ATC2:CorrectHeading(UnitCoord:HeadingTo(FinalCoord)))
  ...
  local function ExecuteBaseTurn()
    if AI_ATC2:FunctionDelay(Alias, function() ExecuteBaseTurn() end, Transmitter) == false then
      return
    end
    UpdateAltitude()
    SchedulerObject3:Stop()
    ...
    local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
    AI_ATC2:RepeatLastTransmission(Alias, function() ExecuteBaseTurn() end)
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(9, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control, %s. %s.", Title, CallsignSub, Airbase, turnSub, AltSubtitle)

      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(Heading)
        local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(AltSub)
        local msg = string.format("%s, Nellis Control, turn %s heading %s, %s %s.",
      ...
      AI_ATC2:ReadHeading(tostring(Heading), RadioObject, Transmitter)
      RadioObject:NewTransmission(AltAudioFile.filename, AltAudioFile.duration, "Airbase_ATC/Departure/SoundFiles/", nil, 0.3)
      AI_ATC2:ReadFlightLevel(Altitude, RadioObject, Transmitter, true)
    end, {}, 0.5)    
    AI_ATC2:ApproachLocalizer(Alias, Type)
  end

  local function VectorToBase()
    local function Message()
      if AI_ATC2:FunctionDelay(Alias, function() Message() end, Transmitter) == false then
        return
      end
      AI_ATC2:RepeatLastTransmission(Alias, function() Message() end)
      UpdateAltitude()
    ...
    SchedulerObject2 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        ...
        local FunctionDelay = AI_ATC2:FunctionDelay(Alias, nil, Transmitter)
  ...
  local function VectorToDownWind()
    local function Message()
      ...
      local finalHeading = AI_ATC2:CorrectHeading(playerCoord:HeadingTo(FinalCoord) + 0.5)
      local turnSub      = AI_ATC2:Heading(finalHeading, RadioObject, Transmitter, false)
      local RadioObject  = AI_ATC2:FindTransmitter(Alias, Transmitter)
      SCHEDULER:New(nil, function()
        AI_ATC2:ChannelOpen(12, Transmitter, Alias)
        local Subtitle = string.format("%s: %s, Nellis Control, fly heading %s. %s. %s", Title, CallsignSub, turnSub, AltSubtitle, Instruction)

        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
          local spokenHeading  = AI_ATC2:SRS_ConvertHeading(finalHeading)
          local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(AltSub)
          local spokenRunway   = AI_ATC2:SRS_ConvertRunway(Runway)
          local msg = string.format("%s, Nellis Control, fly heading %s, %s %s, %s runway %s.",
        ...
        RadioObject:NewTransmission("Control.ogg", 0.508, "Airbase_ATC/Departure/SoundFiles/", nil, nil)
        RadioObject:NewTransmission("FlyHeading.ogg", 0.801,"Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
        AI_ATC2:ReadHeading(finalHeading, RadioObject, Transmitter)
        RadioObject:NewTransmission(AltAudioFile.filename, AltAudioFile.duration, "Airbase_ATC/Departure/SoundFiles/", nil, 0.3)
        AI_ATC2:ReadFlightLevel(Altitude, RadioObject, Transmitter, true)
        if AudioFile2 then
...
--*******************************************************************************APPROACH MANAGER********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IFRApproachType4(Alias, Type, Missed)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:IFRApproachType4(Alias, Type, Missed) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    Sqwuak = "Maintain current squawk"
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:ApproachAssistMenu(Alias, true)
  end, {}, 1.0)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, Nellis Control, fly heading %s. %s. %s. Report %s", Title, CallsignSub,TurnHeading, AltSubtitle, Sqwuak, Navpoint )
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(TurnHeading)
        local spokenAlt      = AI_ATC2:SRS_ConvertAltitude(AltSub)
        local spokenNavpoint = AI_ATC2:SRS_ConvertNavFix(Navpoint)
        local msg = string.format("%s, Nellis Control, fly heading %s. %s %s. %s. Report %s.",
          spokenCallsign, spokenHeading, condition, spokenAlt, Sqwuak, spokenNavpoint)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
      ...
      RadioObject:NewTransmission("MaintainSquawk.ogg", 1.157, "Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
      RadioObject:NewTransmission("Report.ogg", 0.386, "Airbase_ATC/Departure/SoundFiles/", nil, 0.05)
      AI_ATC2:ReadNavpoint(Navpoint, RadioObject, Transmitter)
    end,{}, Delay )
  end
  ...
  if not Missed then
    SCHEDULER:New(nil, function()
      AI_ATC2:ApproachReportFix(Alias)
    end,{}, 12 )
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:IFRApproachType5(Alias, Type, Call, Base)

  local Transmitter    = "NATCF_LEE"
  local Title          = "Nellis Control"
  local Airbase        = "Nellis"
  local AirbaseAlias   = AI_ATC2.AirbaseAlias
  local Runway         = AI_ATC2.Runways.Landing[1]
  local TQQTCN         = AI_ATC_Navpoints.TQQTCN:GetCoordinate()
  local AirbaseCoord   = AI_ATC2_Vec3
  local RadioObject    = AI_ATC2:FindTransmitter(Alias, Transmitter)
  ...
  if Type=="PAR" then
    Title = string.format("%s GCA", AI_ATC2.AirbaseAlias)
    Airbase = AI_ATC2.Airbase
    AirbaseAlias = AI_ATC2.AirbaseAlias
    Transmitter = "SFA"
    RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  else
    RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  end
  ...
  if Call ~= true then
    USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
    if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:IFRApproachType5(Alias, Type, Call, Base) end, Transmitter) == false then
      return
    end
  end
  ...
  local function UpdateVariables()
    local data = ApproachSettings2[Modifier]
      and ApproachSettings2[Modifier][Runway]
      and ApproachSettings2[Modifier][Runway][Type]
    if not data then return end
  ...
  local function CorrectHeading(NewHeading)
    ...
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s GCA, fly heading %s.", Title, CallsignSub, AirbaseAlias, NewHeading)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(NewHeading)
        local msg = string.format("%s, %s G C A, fly heading %s.",
          spokenCallsign, string.lower(AirbaseAlias), spokenHeading)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      end
      ...
      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 5)
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      AI_ATC2:AirbaseName(Airbase, RadioObject, Transmitter)
    ...
    SchedulerObject3 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        ...
        if HeadingDiff <= HEADING_STABLE_DEG then
          Vector        = tonumber(AI_ATC2:CorrectHeading(UnitCoord:HeadingTo(Target)))
          OffsetHeading = CalculateHeadingDiff(AdvisedHeading, Vector)
  ...
  local function ExecuteBaseTurn()
    ...
    local BaseData = ApproachSettings2[Modifier]
      and ApproachSettings2[Modifier][Runway]
      and ApproachSettings2[Modifier][Runway][Type]
    ...
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(9, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s GCA, %s. %s.", Title, CallsignSub, AirbaseAlias, turnSub, AltSubtitle)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(tostring(Heading))
        local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(tostring(math.floor((tonumber(Altitude) or 0) * 1000)))
        local msg = string.format("%s, %s G C A, turn %s heading %s. %s %s.",
          spokenCallsign, string.lower(AirbaseAlias), string.lower(turnDir), spokenHeading, string.lower(cond), spokenAltitude)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
  ...
  local function GCAExecute()
    if AI_ATC2:FunctionDelay(Alias, function() GCAExecute() end, Transmitter)==false then return end
    AI_ATC2:RepeatLastTransmission(Alias, function() GCAExecute() end)
    AI_ATC2:ChannelOpen(8, Transmitter, Alias)
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      ...
      local spokenWindDir  = AI_ATC2:SRS_ConvertHeading(WindDirection)
      local spokenWindSpd  = AI_ATC2:SRS_ConvertDigits(WindSpeed)
      local spokenQNH      = AI_ATC2:SRS_ConvertDigits(QNH)
      local msg = string.format("%s, %s G C A, radar contact. Expect P A R approach to runway %s. Wind %s at %s. Altimeter %s.",
        spokenCallsign, string.lower(AirbaseAlias), spokenRunway, spokenWindDir, spokenWindSpd, spokenQNH)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle1, 10)
    ...
    AI_ATC2:Pressure(QNH, RadioObject, Transmitter)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ApproachReportFix(Alias, Report, Missed)
  ...
  local ReportRange = TQQTCN:Get2DDistance(Fix) - 5556
  local Delay = 1.5 + math.random() * (2.5 - 1.5)
  ...
  local function Execute()
    local function Audio()
      SCHEDULER:New(nil, function()
        ...
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
          local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(AltitudeSub)
          local spokenInstr = AI_ATC2:SRS_ConvertApproachInstruction(ApproachSub, Runway)
          local msg = string.format("%s, Nellis Control, maintain at or above %s, %s",
  ...
  local function ExecuteFunction()
    SchedulerObject2 = SCHEDULER:New(nil, function()
      if Unit and Unit:IsAlive() then
        local Coord = Unit:GetCoordinate()
        local Range = Coord:Get2DDistance(TQQTCN)
        if Range <= 27779 then
          if AI_ATC2:FunctionDelay(Alias, nil, Transmitter)==true then
            Execute()
          end
          SchedulerObject2:Stop()
        end
...
--*****************************************************************************APPROACH LOCALIZER********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ApproachLocalizer(Alias, Type)
  local Transmitter    = "NATCF_LEE"
  local Title          = "Nellis Control"
  local Agency         = "Nellis"
  ...
  local function CalculateTurnDirection(UnitCoord)
    ...
    local unitHeading   = AI_ATC2:CorrectHeading(Unit:GetHeading())
    local headingDiff   = normalizeAngle(LOCALISER - unitHeading)
    local turnDirection = (headingDiff < 0) and "Left" or "Right"

    local vectorHeading = AI_ATC2:CorrectHeading(UnitCoord:HeadingTo(TQQTCN))
  ...
  local function LocalizerIntercept(unitobject, requiredheading)
    ...
    local UnitHeading = AI_ATC2:CorrectHeading(unitobject:GetHeading())
  ...
  local function FinalController()
    ...
    AI_ATC2:RepeatLastTransmission(Alias, function()FinalController() end)
    RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
    AI_ATC2:ChannelOpen(7, Transmitter, Alias)
    local Subtitle = string.format("%s: %s, %s, Standby final controller.", Title, CallsignSub, TurnSub)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenHeading  = AI_ATC2:SRS_ConvertHeading(tostring(RunwayHeading))
      local msg = string.format("%s, %s G C A, turn %s heading %s, standby final controller.",
        spokenCallsign, string.lower(Agency), string.lower(Turn or ""), spokenHeading)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
    ...
    AI_ATC2:ReadHeading(tostring(RunwayHeading), RadioObject, Transmitter)
  ...
  local function Execute(Alternate)
    ...
    local function Audio()
      SCHEDULER:New(nil, function()
        AI_ATC2:RepeatLastTransmission(Alias, function()Audio() end)
        RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
        AI_ATC2:ChannelOpen(13, Transmitter, Alias)
        local Subtitle = string.format("%s: %s, %s, %s", Title, CallsignSub, Title, TurnSub)
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
          local spokenHeading  = AI_ATC2:SRS_ConvertHeading(tostring(Heading))
          local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(AltitudeSub)
          local spokenApproach = AI_ATC2:SRS_ConvertApproachInstruction(ApproachSub, Runway)
        ...
        RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 5)
        AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
        AI_ATC2:AirbaseName(AgencyAudio, RadioObject, Transmitter)
        if Type=="PAR" then
    ...
    local function AlternateAudio()
      SCHEDULER:New(nil, function()
        AI_ATC2:RepeatLastTransmission(Alias, function()AlternateAudio() end)
        RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
        AI_ATC2:ChannelOpen(13, Transmitter, Alias)
        ...
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          ...
          local spokenApproach = AI_ATC2:SRS_ConvertApproachInstruction(ApproachSub, Runway)
          local agencyPhrase = (Type == "PAR") and "G C A" or "Control"
          local msg = string.format("%s, %s %s, maintain at or above %s until %s.",
    ...
    if Type=="PAR" then
      SchedulerObject2 = SCHEDULER:New(nil, function()
        if Unit and Unit:IsAlive() then
          ...
          local Range = Coord:Get2DDistance(TQQTCN)
          local Vector = AI_ATC2:CorrectHeading(Coord:HeadingTo(Localizer))
          local Angle = AI_ATC2:AngularDifference(Vector, RunwayHeading)
  ...
  SchedulerObject = SCHEDULER:New(nil, function()
    if Unit and Unit:IsAlive() then
      local Coord = Unit:GetCoord()
      local Range = Coord:Get2DDistance(TQQTCN)
      local Vector = AI_ATC2:CorrectHeading(Coord:HeadingTo(TQQTCN))
      local Angle = AI_ATC2:AngularDifference(Vector, RunwayHeading)
...
--*************************************************************************ATC MISSED APPROACH***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:MissedApproach(Alias, Audio)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local Airbase = AI_ATC2.Airbase
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:MissedApproach(Alias, Audio) end, Transmitter)==false then
    return
  end
  
  local RadialTable = {
    ["14"] = {
      ["ILS"] = { filename = "340Radial.ogg", duration = 2.148, subtitle = "Intercept the 340 radial." },
      ["RNAV"] = { filename = "340Radial.ogg", duration = 2.148, subtitle = "Intercept the 340 radial." },
      ["TACAN"] = { filename = "340Radial.ogg", duration = 2.148, subtitle = "Intercept the 340 radial." },
    },
    ["32"] = {
      ["TACAN"] = { filename = "325Radial.ogg", duration = 2.113, subtitle = "Intercept the 325 radial." },
      ["ILS"] = { filename = "325Radial.ogg", duration = 2.113, subtitle = "Intercept the 325 radial." },
      ["RNAV"] = { filename = "325Radial.ogg", duration = 2.113, subtitle = "Intercept the 325 radial." },
    },
  }
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:RepeatLastTransmission(Alias, function()AI_ATC2:MissedApproach(Alias, true) end)
    if AI_ATC2.LegacyProcedures==true then
      Modifier = "Legacy"
    else
      Modifier = "Modern"
    ...
    if Audio~=true then
      ...
      AI_ATC2.PARdata[Alias] = nil
      AI_ATC2:ResetMenus(Alias)
      AI_ATC2:MissedApproachMenu(Alias)
    end
  end,{}, 0.5 )
  
  SCHEDULER:New(nil, function()
    local UnitCoord = Unit:GetCoord()
    local Heading = AI_ATC2:CorrectHeading(UnitCoord:HeadingTo(DestCoord))
    local HeadingSub = AI_ATC2:Heading(Heading, RadioObject, Transmitter, false)
    AI_ATC2:ChannelOpen(14, Transmitter, Alias)
    local Subtitle = string.format("%s: %s, Nellis Control, Radar contact.", Title, CallsignSub)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenHeading  = AI_ATC2:SRS_ConvertHeading(HeadingSub)
      local spokenAlt      = AI_ATC2:SRS_ConvertAltitude(AltSub)
      local trafficPart    = AI_ATC2:TrafficReport(Alias, RadioObject, Transmitter, false)
      if trafficPart then
        trafficPart = " " .. trafficPart
      else
        trafficPart = ""
      end
      local spokenRad = tostring(RadSub or ""):gsub("%d+", function(d) return AI_ATC2:SRS_ConvertDigits(d) end)
      local msg = string.format("%s, Nellis Control, radar contact.%s Fly heading %s. %s Climb and maintain %s. Say request.",
        spokenCallsign, trafficPart, spokenHeading, spokenRad, spokenAlt)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
      return
    end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:B2RCheckIn(Alias)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local Airbase = AI_ATC2.Airbase
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  ...
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:BackToRadarSubMenu(Alias)
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:B2RCheckIn(Alias) end, Transmitter)==false then
    return
  end
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, Nellis Control, radar contact. Say request.", spokenCallsign)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 8)
        return
      end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ApproachBackToRadar(Alias, Type)
  local Airbase = AI_ATC2.Airbase
  local ClientObject = ATM2.ClientData[Alias]
  local Unit = ClientObject.Unit
  local Group = Unit:GetGroup()
  ...
  local Transmitter, Agency, AgencySpoken, AgencyOggName
  if Type == "PAR" then
    Transmitter   = "SFA"
    Agency        = "Silverbow GCA"
    AgencySpoken  = "Silverbow G C A"
    AgencyOggName = "Silverbow"
  else
    Transmitter   = "NATCF_LEE"
    Agency        = "Nellis Control"
    AgencySpoken  = "Nellis Control"
    AgencyOggName = "Nellis"
  end
  ...
  AI_ATC2:TerminateSchedules(Alias)
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:GenerateEmptyMenu(Alias, Transmitter)
  AI_ATC2:CancelIFRSubMenu(Alias)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)

  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:ApproachBackToRadar(Alias, Type) end, Transmitter)==false then
    return
  end
  ...
  local RunwayData = {
    ["14"] = {Offset = -90, Altitude = "11", PatternAlt = 15000},
    ["32"] = {Offset = 90, Altitude = "11", PatternAlt = 15000},
  }
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC2:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s, fly heading %s. %s. %s", Agency, CallsignSub, Agency, Heading, AltSubtitle, Instruction)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(Heading)
        local spokenAlt      = AI_ATC2:SRS_ConvertAltitude(AltSub)
        ...
        if Type == "ILS" then
          spokenInstruction = string.format("Vectors for I L S runway %s.", spokenRunway)
        elseif Type == "PAR" then
          spokenInstruction = string.format("Expect P A R approach to runway %s.", spokenRunway)
        elseif Type == "TACAN" then
          spokenInstruction = string.format("Vectors to the TACAN runway %s.", spokenRunway)
        else
          spokenInstruction = AI_ATC2:SRS_ConvertApproachInstruction(Instruction, Runway)
        end
        local msg = string.format("%s, %s, fly heading %s. %s %s. %s",
          spokenCallsign, AgencySpoken, spokenHeading, condition, spokenAlt, spokenInstruction)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 8)
        return
      end
      ...
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      if Type ~= "PAR" then
        AI_ATC2:AirbaseName(AgencyOggName, RadioObject, Transmitter)
        RadioObject:NewTransmission("Control.ogg", 0.508, "Airbase_ATC/Departure/SoundFiles/", nil, nil)
      else
        AI_ATC2:AirbaseName(AgencyOggName, RadioObject, Transmitter)
        RadioObject:NewTransmission("GCA.ogg", 0.987, "Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
  ...
  Message()
  SCHEDULER:New(nil, function()
    AI_ATC2:RadarManager(Alias, Type)
  end, {}, 10)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RadarManager(Alias, Type, Auto)
  local Airbase = AI_ATC2.Airbase
  local TQQTCN = AI_ATC_Navpoints.TQQTCN:GetCoordinate()
  local Runway = AI_ATC2.Runways.Landing[1]
  local RunwayHeading = AI_ATC2.Runways.Landing[5]
  ...
  local Transmitter, Title, AgencySpoken, AgencyOggName, AgencyOggFile, AgencyOggDur
  if Type == "PAR" then
    Transmitter   = "SFA"
    Title         = "Silverbow GCA" 
    AgencySpoken  = "Silverbow G C A" 
    AgencyOggName = "Silverbow"
    AgencyOggFile = "GCA.ogg"
    AgencyOggDur  = 0.987
  else
    Transmitter   = "NATCF_LEE"
    Title         = "Nellis Approach"
    AgencySpoken  = "Nellis Approach"
    AgencyOggName = "Nellis"
    AgencyOggFile = "Control.ogg"
    AgencyOggDur  = 0.508
  end
  ...
  SCHEDULER:New(nil, function()
    if Runway == "14" then
      Zone_1 = AI_ATC_Navpoints.ILS2_1
      Zone_2 = AI_ATC_Navpoints.ILS2_2
      Zone_3 = AI_ATC_Navpoints.ILS2_3
    ...
    elseif Runway == "32" then
      Zone_1 = AI_ATC_Navpoints.ILS2_1
      Zone_2 = AI_ATC_Navpoints.ILS2_4
      Zone_3 = AI_ATC_Navpoints.ILS2_3
      Zone_1:SetRadius(185200)
      Zone_2:SetRadius(185200)
      Zone_3:SetRadius(185200)
  ...
  local function TurnInstruction(heading)
    if AI_ATC2:FunctionDelay(Alias, function()TurnInstruction(heading) end, Transmitter)==false then return  end
    local UnitCoord = Unit:GetCoordinate()
    Turn, Vector = CalculateTurnDirection(heading)
    TurnAudioFile = TurnTable[Turn]
    TurnSub = string.format("Turn %s heading %s", Turn, Heading)
    AI_ATC2:RepeatLastTransmission(Alias, function()TurnInstruction(heading) end)
    RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
    ...
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(Heading)
        local spokenAlt      = AI_ATC2:SRS_ConvertAltitude(AltSub)
        local msg = string.format("%s, %s, turn %s heading %s. %s %s.",
          spokenCallsign, AgencySpoken, string.lower(Turn or ""), spokenHeading, condition, spokenAlt)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
      ...
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      AI_ATC2:AirbaseName(AgencyOggName, RadioObject, Transmitter)
      RadioObject:NewTransmission(AgencyOggFile, AgencyOggDur, "Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
  ...
  local function FinalController()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenHeading  = AI_ATC2:SRS_ConvertHeading(RwyStrng)
    ...
    AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
    RadioObject:NewTransmission(AudioFile.filename, AudioFile.duration, "Airbase_ATC/Departure/SoundFiles/", nil, 0.1)
    AI_ATC2:ReadHeading(RwyStrng, RadioObject, Transmitter)
    RadioObject:NewTransmission("FinalController.ogg", 1.602, "Airbase_ATC/Departure/SoundFiles/", nil, 0.1)
  ...
  local function TurnThree()
    if AI_ATC2:FunctionDelay(Alias, function() TurnThree() end, Transmitter)==false then return end
    CalculateAltitude(Vector3, FinalAltitude)
    local UnitCoord = Unit:GetCoordinate()
    Turn, Vector = CalculateTurnDirection(UnitCoord)
    TurnAudioFile = TurnTable[Turn]
    TurnSub = string.format("Turn %s heading %s", Turn, Heading)
    AI_ATC2:RepeatLastTransmission(Alias, function()TurnThree() end)
    RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
    ...
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC2:SRS_ConvertHeading(Heading)
        local spokenAlt      = AI_ATC2:SRS_ConvertAltitude(AltitudeSub)
        local spokenApproach = AI_ATC2:SRS_ConvertApproachInstruction(ApproachSub, Runway)
        local msg = string.format("%s, %s, turn %s heading %s. Maintain at or above %s until %s.",
          spokenCallsign, AgencySpoken, string.lower(Turn or ""), spokenHeading, spokenAlt, spokenApproach)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      end
      ...
      Subtitle = string.format("%s: Maintain at or above %s until %s", Title, AltitudeSub, ApproachSub)
      RadioObject:NewTransmission("AtOrAbove.ogg", 1.289, "Airbase_ATC/Departure/SoundFiles/", nil, 0.1, Subtitle, 6)
      AI_ATC2:ReadFlightLevel(FinalAltitude, RadioObject, Transmitter, true)
      RadioObject:NewTransmission(ApproachTypeFile.filename, ApproachTypeFile.duration, "Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
      if Type=="ILS" then
        RadioObject:NewTransmission(ApproachFile.filename, ApproachFile.duration, "Airbase_ATC/Departure/SoundFiles/", nil, 0.1)
        AI_ATC2:Runway(Runway, RadioObject, Transmitter)
    ...
    SchedulerObject3 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        ...
        if Airborne and Unit:IsInZone(Zone_3) then
          ...
          SchedulerObject3:Stop()
        elseif not Airborne then
          AI_ATC2:LandingManager(Alias)
          SchedulerObject3:Stop()
        end
      elseif not ATM2.ClientData[Alias] then
        SchedulerObject3:Stop()
      end
    end, {}, 1, 1)
...
--*******************************************************************************ATC PUSH TOWER**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Push_Tower(Alias)
  ...
  local function CalculateBearing(Object)
    local bearing = tonumber(AI_ATC2:CorrectHeading(AirbaseCoord:HeadingTo(Object:GetCoordinate())))
  ...
  SCHEDULER:New(nil, function()
    ...
    RunwayHeading = AI_ATC2.Runways.Landing[5]
    AirbaseCoord = AI_ATC2_Vec3
    Destination = AI_ATC2.Runways.Landing[3]
    AirbaseVec2 = AirbaseCoord:GetVec2()
  ...
  local function Execute()
    local Procedure = AI_ATC2.Procedure
    local Approach = ATM2.ClientData[Alias].Approach.Type
    AI_ATC2:TerminateSchedules(Alias)
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:LandingSubMenu(Alias)
    if Approach=="IFR" and Procedure=="VFR" then
      AI_ATC2:GenerateEmptyMenu(Alias, "Approach")
      AI_ATC2:CancelIFRSubMenu(Alias)
    end
    
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Execute() end)
      local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      if Approach=="VFR" or Approach=="Generic" then
        local Subtitle = string.format("%s: %s contact tower on 257.950.", Title, CallsignSub)
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
          local spokenFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
          local msg = string.format("%s, contact silverbow tower on %s.", spokenCallsign, spokenFreq)
          AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
          return
        end
        ...
        AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
        RadioObject:NewTransmission("SilverbowTower.ogg", 3.471, "Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
      elseif Approach=="IFR" then
        local Subtitle = string.format("%s: %s Radar service terminated. Contact Silverbow tower on 257.950.", Title, Callsign)
        if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
          local spokenFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
          local msg = string.format("%s, radar service terminated. Contact tower on %s.", spokenCallsign, spokenFreq)
          AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
          return
        end
        ...
        RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 7)
        AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
        RadioObject:NewTransmission("SilverbowIFR.ogg", 4.859, "Airbase_ATC/Departure/SoundFiles/", nil, 0.01)
      end
    end, {}, Delay)
  end
  ...
  SchedulerObject = SCHEDULER:New(nil, function()
    local Bearing = CalculateBearing(Unit)
    local Heading = AI_ATC2:CorrectHeading(Unit:GetHeading())
    local CorrectedHeading = AI_ATC2:AngularDifference(Heading, RunwayHeading)
    local FunctionDelay = AI_ATC2:FunctionDelay(Alias, nil, Transmitter)
...
--******************************************************************************ATC CANCEL IFR***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CancelIFR(Alias, agency)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local Agency = "NATCF_LEE"
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  local Type = ClientData.Chart
  local Unit = ClientData.Unit
  ...
  if Type=="PAR" then
    Title = string.format("%s GCA", AI_ATC2.Airbase)
    Transmitter = "SFA"
    ATM2.ClientData[Alias].Chart = "TACAN"
  end
  ...
  local Procedure = AI_ATC2.Procedure
  if Procedure=="VFR" then
    ATM2.ClientData[Alias].Approach.Type = "VFR"
  end
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:CancelIFR(Alias, agency) end, Transmitter)==false then
    return
  end
    ...
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(6, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()ApproachMessage() end)
      local Subtitle = string.format("%s: %s, cancellation recieved, contact tower on 257.95.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Agency] and AI_ATC2_MSRS[Agency].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
        local msg = string.format("%s, cancellation received. Contact tower on %s.",
          spokenCallsign, spokenFreq)
        AI_ATC2:TransmitSRS(Agency, msg, 0, nil, RadioObject, Subtitle, 6)
        return
      end

      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 6)
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      RadioObject:NewTransmission("SilverbowCancel.ogg", 3.904, "Airbase_ATC/Departure/SoundFiles/", nil, 0.1)
    end, {}, Delay)
  end
  ...
  local function TowerMessage()
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(6, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()TowerMessage() end)
      local Subtitle = string.format("%s: %s Contact tower on 325.750.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Agency] and AI_ATC2_MSRS[Agency].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
        local msg = string.format("%s, contact tower on %s.", spokenCallsign, spokenFreq)
        AI_ATC2:TransmitSRS(Agency, msg, 0, nil, RadioObject, Subtitle, 3)
        return
      end

      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 3)
      AI_ATC2:Callsign(Callsign, RadioObject, Agency, Flight)
      RadioObject:NewTransmission("SilverbowCancel.ogg", 3.904, "Airbase_ATC/Ground/SoundFiles/", nil, 0.01)
    end, {}, Delay)
  end
  
  if Agency=="NATCF_LEE" then
    ApproachMessage()
  else
    TowerMessage()
  end
...
--******************************************************************************PUSH GCA***************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:PushGCA(Alias, missed, radar)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  AI_ATC2:TerminateSchedules(Alias)
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:GCASubMenu(Alias, missed, radar)
  
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:PushGCA(Alias, missed, radar) end, Transmitter)==false then
    return
  end
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(6, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      local Subtitle = string.format("%s: %s, Contact Silverbow GCA on 343.725.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("SFA")
        local msg = string.format("%s, contact Silverbow G C A on %s.", spokenCallsign, spokenFreq)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      end
      ...
      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 5)
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      RadioObject:NewTransmission("SilverbowGCA.ogg", 3.843, "Airbase_ATC/Departure/SoundFiles/", nil, 0.1)
    end, {}, Delay)
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RequestDeparture(Alias)
  local Transmitter = "NATCF_LEE"
  local Title = "Nellis Control"
  local Airbase = AI_ATC2.Airbase
  local RadioObject = AI_ATC2:FindTransmitter(Alias, Transmitter)
  ...
  SCHEDULER:New(nil, function()
    ...
    ATM2.ClientData[Alias].Approach.Type = "IFR"
    ATM2.ClientData[Alias].Recovery = Recovery
    ATM2.ClientData[Alias].Chart = "TACAN"
    AI_ATC2:TerminateSchedules(Alias)
    AI_ATC2:ResetMenus(Alias)
  ...
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:RequestDeparture(Alias) end, Transmitter)==false then
    return
  end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TowerTraffic(Alias)
  local Transmitter = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = TOWER_RADIO2
  ...
  local Flight = ClientData.Flight
  local CallsignSub = Flight and FlightCallsign or Callsign
  local ApproachType = ATM2.ClientData[Alias].Landing.Procedure
  local Runway = AI_ATC2.Runways.Landing[1]
  local Delay = 1.5 + math.random() * (2.5 - 1.5)
  
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TowerTraffic(Alias) end, Transmitter)==false then
    return
  end
  ...
  if not ATM2.TowerControl[Alias] then
    ATM2.TowerControl[Alias] = {RequestedApproach = ApproachType, State = "On Approach", Type = Type, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
  elseif ATM2.TowerControl[Alias] and ATM2.TowerControl[Alias].Schedules then
    for _, sched in ipairs(ATM2.TowerControl[Alias].Schedules) do
      if sched and sched.Stop then sched:Stop() end
    end
    ATM2.TowerControl[Alias].Schedules = {}
  end
  ...
  local StateTbl = {
    ...
    ["Landed on runway 14"] = {filename = "OnFinal.ogg", duration = 0.570, subtitle = "on final"},
    ["Landed on runway 32"] = {filename = "OnFinal.ogg", duration = 0.570, subtitle = "on final"},
  ...
  local function TrafficReport(newContact)
    local ClientHeading  = tonumber(AI_ATC2:CorrectHeading(UnitObject:GetHeading()))
    local Range = tostring(math.floor(TrafficCoord:Get2DDistance(ClientCoord) / 1852 + 0.5))
    local TrafficHeading = tonumber(AI_ATC2:CorrectHeading(ClientCoord:HeadingTo(TrafficCoord)))
    local Heading = UTILS.HdgDiff(ClientHeading, TrafficHeading)
    local RelativeHeading = (TrafficHeading - ClientHeading) % 360
    local Bearing = tostring(AI_ATC2:HeadingToClockBearing(RelativeHeading))
    local feet = ClosestObject:GetAltitude() / 0.3048
    local TrafficAltitude = string.format("%.1f", feet / 1000)
    local TrafficAltitudeSub = AI_ATC2:ReadFlightLevel(TrafficAltitude, RadioObject, Transmitter, false)
    local Aircraft = AI_ATC2_SoundFiles[RadioKey].Aircraft[TrafficType]
    ...
    if (RelativeHeading >= 240 or RelativeHeading <= 120) and ATM2.TowerControl[Alias].State~=Base then
      Subtitle = Subtitle.." Report traffic in sight."
    end
    AI_ATC2:ChannelOpen(10, Transmitter, Alias)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenBearing  = AI_ATC2:SRS_ConvertClockBearing(Bearing)
      local spokenRange    = AI_ATC2:SRS_ConvertDigits(Range)
      local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(tostring(math.floor((tonumber(TrafficAltitude) or 0) * 1000)))
      local aircraftPhrase = AI_ATC2:SRS_ConvertAircraftType(TrafficType, RadioKey)
      local countPhrase = ""
      if Count == 2 then
      ...
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 10)

      for alias, data in pairs(ATM2.TowerControl) do
        if alias~=Alias then
          ATM2.TowerControl[Alias].Contacts[alias] = {}
        end
      end
      return
    end
    ...
    AI_ATC2:ReadFlightLevel(TrafficAltitude, RadioObject, Transmitter, true, 0.00)
    if Aircraft then
  ...
  local function GenerateSchedule()
    if ATM2.TowerControl[Alias] and ATM2.TowerControl[Alias].Schedules then
      local SchedulerObjects = ATM2.TowerControl[Alias].Schedules
      SchedulerObject = SCHEDULER:New(nil, function()
        if not ATM2.TowerControl[Alias] then
          SchedulerObject:Stop()
          return
        end
        local TwrObject = ATM2.TowerControl[Alias]
        local FunctionDelay = AI_ATC2:FunctionDelay(Alias, nil, Transmitter, 5)
        Initialise()
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AcknowledgeTraffic(Alias, variable)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:AcknowledgeTraffic(Alias, variable) end, Transmitter)==false then
    return
  end
  ...
  local function TrafficInsight()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:AcknowledgeTraffic(Alias, variable) end)
      local Subtitle = string.format("%s: %s, Copy, Traffic in sight.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
  ...
  local function NoJoy()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:AcknowledgeTraffic(Alias, variable) end)
      local Subtitle = string.format("%s: %s, Report that traffic in sight.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AcknowledgeExtend(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:AcknowledgeExtend(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:AcknowledgeExtend(Alias) end)
...
--*******************************************************************************ATC TOWER SAY WIND******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TowerWinds(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TowerWinds(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:TowerWinds(Alias) end)
    local Subtitle = string.format("%s: %s, Wind is %s at %s.", Title, CallsignSub, WindDirection, WindSpeed)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
      local spokenWindDir  = AI_ATC2:SRS_ConvertHeading(WindDirection)
      local spokenWindSpd  = AI_ATC2:SRS_ConvertDigits(WindSpeed)
      local msg = string.format("%s, wind is %s at %s.", spokenCallsign, spokenWindDir, spokenWindSpd)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
      return
    end
...
--******************************************************************************ATC GO AROUND***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RunwayOccupied(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:RunwayOccupied(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:RunwayOccupied(Alias) end)
...
--******************************************************************************ATC RUNWAY INSIGHT*******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:AcknowledgeRunway(Alias)
  local Transmitter = "Tower"
  local Agency = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:AcknowledgeRunway(Alias) end, Transmitter)==false then
    return
  end
  ...
  local function RunwayInsight()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:AcknowledgeRunway(Alias) end)
      local Subtitle = string.format("%s: %s, Copy Runway in sight.", Title, CallsignSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
...
--******************************************************************************ATC TOWER CHECKIN********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Tower_Checkin(Alias)
  local Transmitter = "Tower"
  local RadioKey = "Ground"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:Tower_Checkin(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ApproachType = ATM2.ClientData[Alias].Landing.Procedure
    ATM2.ClientData[Alias].Landing.Type = "Option"
    if not ATM2.TowerControl[Alias] then
      ATM2.TowerControl[Alias] = {RequestedApproach = ApproachType, State = "On Approach", Type = Type, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
    else
      ATM2.TowerControl[Alias].RequestedApproach = ApproachType
      ATM2.TowerControl[Alias].State = "On Approach"
    end
    ...
    SCHEDULER:New(nil, function()
      ...
      if StateData and StateData.subtitle then
        ...
        TrafficAudio = AI_ATC2_SoundFiles[RadioKey].Aircraft[TrafficType]
      else
        StateSub = ""
      end
      ...
      if TrafficType ~= "" and StateData and TrafficAudio and StateSub ~= "" then
        ...
        TrafficSub = string.format("your number %s", LandingNo)
      end
    ...
    elseif ApproachType == "Deadside" then
      Report = "report ready overhead for"
      Subtitle = string.format("%s: %s %s, %s for runway %s .", Title, CallsignSub, Title, Report, Runway)
      ApproachAngle = 360
      ReportRange = 4630
    end
  end, {}, 0.6)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(Callsign)
        local spokenRunway   = AI_ATC2:SRS_ConvertRunway(Runway)
        local msg

        if ApproachType == "Straight in" then
          msg = string.format("%s, Silverbow tower, report five mile straight in, runway %s.",
            spokenCallsign, spokenRunway)
        elseif ApproachType == "Instrument Straight in" then
          local spokenLandingNo = AI_ATC2:SRS_ConvertDigits(LandingNo or "1")
          if TrafficType and TrafficType ~= "" and StateData and StateSub and StateSub ~= "" then
            local aircraftPhrase = AI_ATC2:SRS_ConvertAircraftType(TrafficType, RadioKey)
            msg = string.format("%s, Silverbow tower, report five miles. You're number %s behind the %s %s for runway %s.",
              spokenCallsign, spokenLandingNo, aircraftPhrase, StateSub, spokenRunway)
          else
            msg = string.format("%s, Silverbow tower, report five miles for runway %s.",
              spokenCallsign, spokenRunway)
          end
        elseif ApproachType == "Overhead" then
          msg = string.format("%s, Silverbow tower, report five mile initial, runway %s.",
            spokenCallsign, spokenRunway)
        elseif ApproachType == "SFO" then
          msg = string.format("%s, Silverbow tower, runway %s. %s turn out approved. Report high key.",
            spokenCallsign, spokenRunway, string.lower(Break or ""))
        elseif ApproachType == "Deadside" then
          msg = string.format("%s, Silverbow tower, report ready overhead for runway %s.",
            spokenCallsign, spokenRunway)
        end

        if msg then
          AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
          AI_ATC2:TowerTraffic(Alias)
          return
        end
      end
      ...
      elseif ApproachType == "Instrument Straight in" then
        ...
        AI_ATC2:ReadDigits(LandingNo, RadioObject, Transmitter)
  ...
  local function BaseTurnFailsafe()
    SchedulerObject4 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        local Coord = Unit:GetCoordinate()
        local Heading = tonumber(AI_ATC2:CorrectHeading(Unit:GetHeading()))
        local Range = Coord:Get2DDistance(AirbaseCoord)
        local Angle = AI_ATC2:AngularDifference(Heading, RunwayHeading)
  ...
  local function HandleRecipricol()
    SchedulerObject3 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        local Heading = tonumber(AI_ATC2:CorrectHeading(Unit:GetHeading()))
        local Angle = AI_ATC2:AngularDifference(Heading, RecipricolHeading)
        if Angle <= 20 then
          ...
          elseif ApproachType == "SFO" then
            --BaseTurnFailsafe()
            --AI_ATC2:ReportBaseSubMenu(Alias)
            SchedulerObject3:Stop()
          else
            SchedulerObject3:Stop()
          end
    ...
    SchedulerObject2 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        ...
        if Angle <= ApproachAngle and Range <= ReportRange then
          ...
          elseif ApproachType == "Overhead" then
            MESSAGE:New("Pilot did not report Initial", 20):ToUnit(Unit)
            AI_ATC2:Report5MileInitial(Alias)
            HandleRecipricol()
          elseif ApproachType == "Deadside" then
  ...
  SCHEDULER:New(nil, function()
    if ApproachType == "Overhead" or ApproachType == "Deadside" then
      AI_ATC2:OverheadInitialSubMenu(Alias)
      InitialBumper()
    elseif ApproachType == "Straight in" or ApproachType == "Instrument Straight in" then
      AI_ATC2:InitialSubMenu(Alias)
      InitialBumper()
    elseif ApproachType == "SFO" then
      OverheadApproach()
      AI_ATC2:ReportHighKeyMenu(Alias)
    end
  end, {}, Delay + 0.2)
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeloRequestLanding(Alias, Type)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  local AudioTbl = {
    ["Right"] = { filename = "LeftDownwind.ogg", duration = 2.873 },
    ["Left"] = { filename = "RightDownwind.ogg", duration = 2.901 },
  }
  
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:HeloRequestLanding(Alias, Type) end, Transmitter)==false then
    return
  end
  ...
  AI_ATC2:TerminateSchedules(Alias)
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:HeloBaseSubMenu(Alias, Type)
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  
  SCHEDULER:New(nil, function()
    AirbaseCoord = AI_ATC2_Vec3
    AirbaseVec2 = AI_ATC2_Vec3:GetVec2()
  ...
  local function ClosedCircuit()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()ClosedCircuit() end)
      AI_ATC2:ChannelOpen(12, Transmitter, Alias)
      local Subtitle = string.format("%s: %s %s, Runway %s, Join %s downwind at or below 3900. Report base.", Title, CallsignSub, Title, Runway, Base)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC2:SRS_ConvertRunway(Runway)
        local msg = string.format(
          "%s, Silverbow tower, runway %s. Join %s downwind at or below three thousand nine hundred feet. Report base.",
  ...
  local function StraightIn()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC2:SRS_ConvertRunway(Runway)
        local msg = string.format("%s, Silverbow tower, runway %s. Report three miles.",
          spokenCallsign, spokenRunway)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
...
--****************************************************************************ATC REPORT HIGH KEY********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReportKey(Alias, Key)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local RadioKey = "Ground"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:ReportKey(Alias, Key) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    if not ATM2.TowerControl[Alias] then
      ATM2.TowerControl[Alias] = {RequestedApproach = ApproachType, State = Position, Type = Type, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
    else
      ATM2.TowerControl[Alias].State = Position
    end
  end, {}, 0.5 )
  ...
  local function HighKey()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()HighKey() end)
      AI_ATC2:ChannelOpen(5, Transmitter, Alias)
      ...
      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 5)
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, false)
  ...
  local function LowKey()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()LowKey() end)
      AI_ATC2:ChannelOpen(5, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s. Report base.", Title, Callsign, SequenceSub)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign  = AI_ATC2:SRS_ConvertCallsign(Callsign)
        local spokenRunway    = AI_ATC2:SRS_ConvertRunway(Runway)
        local spokenLandingNo = AI_ATC2:SRS_ConvertDigits(LandingNo)
        ...
        local msg = string.format("%s, %s Report base.", spokenCallsign, spokenSequence)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      end
    ...
    SchedulerObject2 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        ...
        elseif Range >= 16668 then
          MESSAGE:New("Exceeded 9Nm from Silverbow", 20):ToUnit(Unit)
          AI_ATC2:SayIntentions(Alias)
          SchedulerObject2:Stop()
        end
      else
        SchedulerObject2:Stop()
  ...
  local function BaseTurnFailSafe()
    SchedulerObject = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit then
        ...
        local Heading = tonumber(AI_ATC2:CorrectHeading(Unit:GetHeading()))
        local Range = Coord:Get2DDistance(AirbaseCoord)
        local Angle = AI_ATC2:AngularDifference(Heading, ReciprocalHeading)
  ...
  if Key=="High" then
    HighKey()
    AI_ATC2:ReportLowKeyMenu(Alias)
  else
    LowKey()
    BaseTurnFailSafe()
    AI_ATC2:ReportBaseSubMenu(Alias)
...
--****************************************************************************ATC REPORT INITIAL*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Report5MileInitial(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local RadioKey = "Ground"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:Report5MileInitial(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ApproachType = ATM2.ClientData[Alias].Landing.Procedure
    if not ATM2.TowerControl[Alias] then
      ATM2.TowerControl[Alias] = {RequestedApproach = "Overhead", State = "Initial", Type = Type, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
    else
      ATM2.TowerControl[Alias].RequestedApproach = "Overhead"
      ATM2.TowerControl[Alias].State = "Initial"
    end
    AirbaseCoord = AI_ATC2_Vec3
    UnitCoord = Unit:GetCoordinate()
    ...
    RunwayHeading = AI_ATC2.Runways.Landing[5]
    ReciprocalHeading = (RunwayHeading + 180) % 360 
    LandingType = ATM2.ClientData[Alias].Landing.Type
    if Runway=="14" then
      Break = "Left"
    else
      Break = "Right"
    ...
    if ApproachType=="Deadside" then
      BaseSub = " Begin your descent, report base"
      SubDuration = 8
    else
      BaseSub = " Report base"
      SubDuration = 7
  ...
  local function ExtendDownwind()
    if AI_ATC2:FunctionDelay(Alias, function() ExtendDownwind() end, Transmitter)==false then return end
    AI_ATC2:RepeatLastTransmission(Alias, function()ExtendDownwind() end)
    AI_ATC2:ChannelOpen(7, Transmitter, Alias)
    InitData()
    SCHEDULER:New(nil, function()
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        if TrafficType and StateData then
          local aircraftPhrase = AI_ATC2:SRS_ConvertAircraftType(TrafficType, RadioKey)
          msg = string.format("%s, Silverbow tower. You're number %s behind the %s %s for runway %s. %s %s.",
            spokenCallsign, spokenLandingNo, aircraftPhrase, StateSub, spokenRunway, BreakSub, BaseSub)
        else
          msg = string.format("%s, Silverbow tower. You're number %s for runway %s. %s %s.",
            spokenCallsign, spokenLandingNo, spokenRunway, BreakSub, BaseSub)
        end
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, SubDuration)
        return
      end
      ...
      for alias, data in pairs(ATM2.TowerControl) do
        if alias ~= Alias then
          ...
          if (AppTyp=="Straight in" or AppTyp=="Instrument Straight in") and StateTbl[State]then
            ...
            if ExtRange >= 4630 and ExtRange <= 14816 and ATM2.TowerControl[Alias].Contacts[alias] then
              ExtendDownwind()
              SchedulerObject3:Stop()
            end
          end
...
--****************************************************************************ATC REPORT INITIAL*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ReportInitial(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:ReportInitial(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    if not ATM2.TowerControl[Alias] then
      ...
      if ATM2.TowerControl[Alias].RequestedApproach == "Closed traffic" then
        ATM2.TowerControl[Alias].State = string.format("%s Base", Break)
      else
        ATM2.TowerControl[Alias].State = Position
      end
    ...
    if Flight then
      AI_ATC2:WingmanBaseSubMenu(Alias)
    end
  end, {}, 0.5 )
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        local spokenWindDir = AI_ATC2:SRS_ConvertHeading(WindDirection)
        local spokenWindSpd = AI_ATC2:SRS_ConvertDigits(WindSpeed)
        local landingWord = "cleared for the option"
...
--****************************************************************************HELO REPORT BASE***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeloBase(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:HeloBase(Alias) end, Transmitter)==false then
    return
  end
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        local spokenWindDir = AI_ATC2:SRS_ConvertHeading(WindDirection)
        local spokenWindSpd = AI_ATC2:SRS_ConvertDigits(WindSpeed)
        local msg = string.format("%s, runway %s. Wind %s at %s. %s.",
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:HeloLandingManager(Alias)
  end, {}, Delay + 10 )
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:WingmanReportBase(Alias, LandingType, Integer)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:WingmanReportBase(Alias, LandingType, Integer) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    WindDirection = AI_ATC2:RectifyHeading(tostring(math.floor(WindDirection + 0.5)))
    WindSpeed = (tostring(math.floor(UTILS.MpsToKnots(WindSpeed)- 0.5)))
    if ATM2.ClientData[Alias].Wingman2Menu then
      ATM2.ClientData[Alias].Wingman2Menu:RemoveSubMenus()
      ATM2.ClientData[Alias].Wingman3Menu:RemoveSubMenus()
      ATM2.ClientData[Alias].Wingman4Menu:RemoveSubMenus()
      AI_ATC2:WingmanClosedSubMenu(Alias)
    end
  end, {}, 0.5 )
...
--****************************************************************************ATC CLOSED TRAFFIC*********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:ClosedTraffic(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local RadioKey = "Ground"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  ...
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:ClosedTraffic(Alias) end, Transmitter)==false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    ...
    if not ATM2.TowerControl[Alias] then
      ATM2.TowerControl[Alias] = {RequestedApproach = "Closed traffic", State = Position, Type = Type, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
    else
      ATM2.TowerControl[Alias].RequestedApproach = "Closed traffic"
      ATM2.TowerControl[Alias].State = Position
      SCHEDULER:New(nil, function()
        if ATM2.TowerControl and ATM2.TowerControl[Alias] and ATM2.TowerControl[Alias].Contacts then
          ATM2.TowerControl[Alias].Contacts = {}
        end
      end, {}, 5)
    end
  end, {}, 0.5 )
    ...
    for alias, data in pairs(ATM2.TowerControl) do
      if alias ~= Alias then
        ...
        if (AppTyp == "Straight in" or AppTyp == "Instrument Straight in") and StateTbl[State] then 
          ...
          and ATM2.TowerControl[Alias] and ATM2.TowerControl[Alias].Contacts then
            local ExtCoord = ExtGrp:GetCoordinate()
            local ExtRange = ExtCoord:Get2DDistance(AirbaseCoord)
            if ExtRange >= 4630 and ExtRange <= 12964 
            and ATM2.TowerControl[Alias].Contacts[alias] then
              ExtendDownwind()
              SchedulerObject2:Stop()
              return
            end
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:WingmanClosedTraffic(Alias, Integer)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local RadioKey = "Ground"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  ...
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:WingmanClosedTraffic(Alias, Integer) end, Transmitter)==false then
    return
  end
...
--*****************************************************************************ATC BREAK OUT*************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:BreakOut(Alias, NavPoint)
  ...
  local TowerControl = ATM2.TowerControl[Alias]
  ...
  or TowerControl.State == string.format("Landed on runway %s", Runway)) then
    AI_ATC2:GoAround(Alias, "VFR")
    return
  end

  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:BreakOut(Alias, NavPoint) end, Transmitter) == false then
    return
  end
  ...
  SCHEDULER:New(nil, function()
    if not ATM2.TowerControl[Alias] then
      ATM2.TowerControl[Alias] = {RequestedApproach = "Straight in", State = "Outside Downwind", Type = ClientType, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
    else
      ATM2.TowerControl[Alias].RequestedApproach = "Straight in"
      ATM2.TowerControl[Alias].State = "Outside Downwind"
      SCHEDULER:New(nil, function()
    ...
    if ATM2.ClientData[Alias].WingmanMenu then
      ATM2.ClientData[Alias].WingmanMenu:RemoveSubMenus()
    end
  end, {}, 0.5)
  ...
  SCHEDULER:New(nil, function()
    ...
    Instruction = "Break out and report 5 mile Initial."
    AI_ATC2:NavpointSubMenu(Alias, NavPoint)
  end, {}, 1.0)
  
  local function RadioMessage()
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, RadioMessage)
      AI_ATC2:ChannelOpen(5, Transmitter, Alias)
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        if NavPoint then
          local spokenNavPoint = AI_ATC2:SRS_ConvertNavFix(NavPoint)
          msg = string.format("%s, break out. Re-enter via %s. Report %s.",
            spokenCallsign, spokenNavPoint, spokenNavPoint)
        else
          msg = string.format("%s, break out and report five mile initial.", spokenCallsign)
        end
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      end
  ...
  SchedulerObject = SCHEDULER:New(nil, function()
    if not (ATM2.ClientData[Alias] and Unit) then
      SchedulerObject:Stop()
      return
    end
    local Coord = Unit:GetCoordinate()
...
--******************************************************************************ATC GO AROUND************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GoAround(Alias, Type)
  if not ATM2.ClientData[Alias] then
    return
  end
  ...
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:GoAround(Alias, Type) end, Transmitter)==false then
    return
  end
  ...
  local InstructionTable = {
    ["IFR"] = {
      ["14"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Execute published missed Approach." },
      ["32"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Execute published missed Approach."  },
    },
    ["VFR"] = { 
      ["14"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Break out and report 5 mile initial."  },
      ["32"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Break out and report 5 mile initial."  },
    },
  }
  ...
  SCHEDULER:New(nil, function()
    if not ATM2.TowerControl[Alias] then
      ...
      elseif  finalApproach == "IFR" then
        ATM2.TowerControl[Alias].RequestedApproach = "Missed Approach"
        ATM2.TowerControl[Alias].State = "Missed Approach"
        if ATM2.TowerControl[Alias].Schedules then
          for _, sched in ipairs(ATM2.TowerControl[Alias].Schedules) do
            sched:Stop()
    ...
    if ApproachType=="Generic" then
      ApproachType = AI_ATC2.Procedure
    end
    AirbaseCoord = AI_ATC2_Vec3
    Runway = AI_ATC2.Runways.Landing[1]
    ...
    if ApproachType=="VFR" then
      ...
      AI_ATC2:NavpointSubMenu(Alias)
    elseif ApproachType=="IFR" then
      AudioData = InstructionTable["IFR"][Runway]
      Instruction = AudioData.subtitle.." Contact Nellis Control on 254.400"
      AI_ATC2:DepartureSubMenu(Alias, true)
    end
  end, {}, 0.5 )
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        ...
        local msg
        if ApproachType == "VFR" then
          msg = string.format("%s, go around. Unable closed traffic, break out and report five mile initial.",
            spokenCallsign)
        else
          local spokenFreq = AI_ATC2:SRS_ConvertFrequency("NATCF_LEE")
          msg = string.format("%s, execute published missed approach. Contact Nellis Control on %s.",
            spokenCallsign, spokenFreq)
        end
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      ...
      elseif ApproachType=="IFR" then
        RadioObject:NewTransmission(AudioData.filename, AudioData.duration, "Airbase_ATC/Ground/SoundFiles/", nil, 0.1)
        RadioObject:NewTransmission("NellisControl.ogg", 2.922, "Airbase_ATC/Ground/SoundFiles/", nil, 0.03)
      end
    end, {}, Delay )
  end
...
--****************************************************************************ATC BACK TO RADAR**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:BackToRadar(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  AI_ATC2:TerminateSchedules(Alias)
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:B2CheckInSubMenu(Alias)
  if AI_ATC2.PAR_TickSchedulers and AI_ATC2.PAR_TickSchedulers[Alias] then
    for _, sched in ipairs(AI_ATC2.PAR_TickSchedulers[Alias]) do
      if sched and sched.Stop then sched:Stop() end
    end
  ...
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:BackToRadar(Alias) end, Transmitter)==false then
    return
  end
  ...
  local RunwayTable = {
    ["32"] = { Turn = "Right", Offset = 90, SoundFile = {filename = "TurnRight.ogg", duration = 0.922}},
    ["14"] = { Turn = "Left", Offset = -90, SoundFile = {filename = "TurnLeft.ogg", duration = 0.827}},
  }
  
  SCHEDULER:New(nil, function()
    if not ATM2.TowerControl[Alias] then
      ATM2.TowerControl[Alias] = {RequestedApproach = "Straight in", State = "Missed Approach", Type = Type, Contacts = {}, Schedules = {}, Count = ClientCount, CycleCount = 0}
    else
      ATM2.TowerControl[Alias].RequestedApproach = "Straight in"
      ATM2.TowerControl[Alias].State = "Missed Approach"
      if ATM2.TowerControl[Alias].Schedules then
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC2:ChannelOpen(10, Transmitter, Alias)
      AI_ATC2:RepeatLastTransmission(Alias, function()Message() end)
      local Subtitle = string.format("%s: %s Turn %s heading %s. Climb and maintain 11000. Contact Nellis Control on 254.400.", Title, CallsignSub, Turn, Heading)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading = AI_ATC2:SRS_ConvertHeading(Heading)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("NATCF_LEE")
        local msg = string.format("%s, turn %s heading %s. Climb and maintain one one thousand. Contact Nellis Control on %s.",
      ...
      RadioObject:NewTransmission("Climb11.ogg", 1.927, "Airbase_ATC/Ground/SoundFiles/", nil, 0.01)
      RadioObject:NewTransmission("NellisControl.ogg", 2.921, "Airbase_ATC/Ground/SoundFiles/", nil, 0.01)
    end, {}, Delay)
  end
...
--****************************************************************************ATC SAY INTENTIONS********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SayIntentions(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:SayIntentions(Alias) end, Transmitter)==false then
    return
  end
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:TerminateSchedules(Alias)
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:LandingSubMenu(Alias, true)
  end, {}, 0.5)
...
--****************************************************************************ATC SAY INTENTIONS********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:SayIntentions2(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:SayIntentions2(Alias) end, Transmitter)==false then
    return
  end
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
...
--****************************************************************************ATC BACK TO RADAR**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RadarVectorDeparture(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  SCHEDULER:New(nil, function()
    ...
    if ApproachType=="VFR" then
      Instruction = "Contact Nellis Control on 254.400"
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC2:SRS_ConvertFrequency("NATCF_LEE")
        local msg = string.format("%s, contact Nellis Control on %s.",
          spokenCallsign, spokenFreq)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 3)
        return
      end
      ...
      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 3)
      AI_ATC2:Callsign(Callsign, RadioObject, Transmitter, Flight)
      RadioObject:NewTransmission(SoundFile, 3.338, "Airbase_ATC/Ground/SoundFiles/", nil, 0.01)
    end, {}, Delay)
  end
...
--****************************************************************************ATC LANDING MANAGER********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:LandingManager(Alias, PAR)
  local Agency = "Tower"
  local Transmitter = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = TOWER_RADIO2
  ...
  local function FinalCheck()
    if not ATM2.RunwayOccupied then return false end
    for alias, _ in pairs(ATM2.RunwayOccupied) do
      if alias ~= Alias then
        return true
      end
    end
  ...
  SCHEDULER:New(nil, function()
    ...
    Exit = AI_ATC2_TaxiToPark[Runway][Taxiway].Exit
    AirbaseCoord = AI_ATC2_Vec3
    UnitCoord = Unit:GetCoordinate()
    RunwayHeading = AI_ATC2.Runways.Landing[5]
  ...
  local function Execute()
    SchedulerObject = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit and Unit:IsAlive() then
        local UnitSpeed = Unit:GetVelocityKNOTS()
        if AI_ATC2:FunctionDelay(Alias, nil, Transmitter)==true then
          ...
          local function Message()
            ...
            if AI_ATC2_MSRS and AI_ATC2_MSRS[Agency] and AI_ATC2_MSRS[Agency].Active then
              ...
              local msg = string.format("%s, welcome back, exit runway via taxiway %s. Contact ground for parking.",
                spokenCallsign, Exit)
              AI_ATC2:TransmitSRS(Agency, msg, 0, nil, RadioObject, Subtitle, 7)
              return
            end
    ...
    SchedulerObject3 = SCHEDULER:New(nil, function()
      if ATM2.ClientData[Alias] and Unit and Unit:IsAlive() then
        ...
        if Airborne and (Range >= variableRange or Angle >= variableAngle)  then
          ...
          if ApproachType=="VFR" then
            AI_ATC2:GoAround(Alias)
          else
            AI_ATC2:SayIntentions2(Alias)
          end
          SchedulerObject3:Stop()
  ...
  local function TakeOffCheck()
    if not ATM2.RunwayOccupied[Alias] then
      ATM2.RunwayOccupied[Alias] = {}
      SCHEDULER:New(nil, function()
        if ATM2.RunwayOccupied[Alias] then
          ATM2.RunwayOccupied[Alias] = nil
  ...
  SchedulerObject_A = SCHEDULER:New(nil, function()
    if ATM2.ClientData[Alias] and Unit then
      ...
      if not Exceeded7nm and Range >= InitialRange and Range >= 12964 then
        Exceeded7nm = true
        MESSAGE:New("Exceeded 7Nm from Silverbow", 20):ToUnit(Unit)
        AI_ATC2:SayIntentions(Alias)
        StopBoth()
        return
      end
    ...
    elseif not ATM2.ClientData[Alias] and Unit then
  ...
  SchedulerObject_B = SCHEDULER:New(nil, function()
    if ATM2.ClientData[Alias] and Unit then
      ...
      if Range <= 5556 and Angle <= 10 then
        if ATM2.TowerControl[Alias] and not FinalHandled then
          FinalHandled = true
          ATM2.TowerControl[Alias].State = "On Final Approach"
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:HeloLandingManager(Alias)
  local Transmitter = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = TOWER_RADIO2
  local ClientData = ATM2.ClientData[Alias]
...
--**********************************************************************************AI_ATC2 ROLL OUT******************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:RollOutLanding(Alias)
  local Agency = "Tower"
  local Transmitter = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = TOWER_RADIO2
  ...
  local ApproachType  = ClientData.Approach.Type
  local Runway = AI_ATC2.Runways.Landing[1]
  local Exit = AI_ATC2_TaxiToPark[Runway].Exit
  if Jester then Jester:Silence() end
  local Callsign = ClientData.Callsign
  local FlightCallsign = ClientData.FlightCallsign
  local Flight = ClientData.Flight
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:RollOutLanding(Alias) end, Transmitter)==false then
    return
  end
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  ...
  local function Execute()
    ...
    SCHEDULER:New(nil, function()
      ...
      AI_ATC2:Callsign(Callsign, RadioObject, Agency, Flight)
      RadioObject:NewTransmission("WelcomeBack.ogg", 2.508, "Airbase_ATC/Ground/SoundFiles/", nil, 0.01)
      AI_ATC2:Phonetic(Exit, RadioObject, Agency)
      RadioObject:NewTransmission("ContactGround.ogg", 1.289, "Airbase_ATC/Ground/SoundFiles/", nil, 0.01)
      if Jester then Jester:Speak() end
    end, {}, Delay)
...
--**********************************************************************************AI_ATC2 PAR***********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TowerPAR(Alias)
  local Agency = "Tower"
  ...
  AI_ATC2.PARdata[Alias] = {}
  AI_ATC2.PARdata[Alias].Course = {}
  AI_ATC2.PARdata[Alias].Glidepath = {}
  AI_ATC2.PARdata[Alias].AudioFSM = {
    State = "IDLE",
  ...
  AI_ATC2.PARdata[Alias].ApproachTick = {
    SchedulerCount = 0,
    tick1Complete = false,
    tick2Complete = false,
    tick3Complete = false,
  ...
  AI_ATC2.PAR_TickSchedulers = AI_ATC2.PAR_TickSchedulers or {}
  AI_ATC2.PAR_TickSchedulers[Alias] = {}

  local function StopPARTickSchedulers()
    if AI_ATC2.PAR_TickSchedulers[Alias] then
      for _, sched in ipairs(AI_ATC2.PAR_TickSchedulers[Alias]) do
        if sched and sched.Stop then sched:Stop() end
      end
      AI_ATC2.PAR_TickSchedulers[Alias] = {}
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:TowerPAR(Alias) end, Transmitter)==false then 
    return 
  end
  
  AI_ATC2:TerminateSchedules(Alias)
  AI_ATC2:ResetMenus(Alias)
  AI_ATC2:GCAGoAroundSubMenu(Alias, RadioObject)
  ...
  SCHEDULER:New(nil, function()
    ...
    if Runway=="14" then
      DepartureZone = AI_ATC_Navpoints["PAR_32"]:GetCoordinate()
      TouchDownPoint = AI_ATC_Navpoints["PAR_14"]:GetCoordinate()
      AltBase = 8200
    elseif Runway=="32" then
      DepartureZone = AI_ATC_Navpoints["PAR_14"]:GetCoordinate()
      TouchDownPoint = AI_ATC_Navpoints["PAR_32"]:GetCoordinate()
      AltBase = 8200
    end
  ...
  local function CalculateAltitude(altitude)
    Alt = altitude
    AltSub = AI_ATC2:ReadFlightLevel(Alt, RadioObject, Transmitter, false)
    PatternAlt = math.floor((tonumber(Alt) or 0) * 1000 + 0.5)
  ...
  local function CheckIn()
    ...
    AI_ATC2:Callsign(Callsign, RadioObject, Agency, false)
  ...
  local function RunwayInSight()
    local Subtitle = string.format("%s: Copy Runway in sight. Contact tower on 257.950.", Title)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local towerFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
      local msg = string.format("Copy runway in sight. Contact tower on %s.", towerFreq)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 2)
    else
      RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, nil, Subtitle, 2)
      RadioObject:NewTransmission("RunwayInsight.ogg", 1.186, "Airbase_ATC/Ground/PAR/", nil, 0.1)
      RadioObject:NewTransmission("ContactTower5.ogg", 2.784, "Airbase_ATC/Ground/SoundFiles/", nil, 0.01)
    end
    AI_ATC2:TerminateSchedules(Alias)
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:TowerCheckIn2Menu(Alias)
  end
  ...
  local function Cleared2Land()
    ...
    if not ATM2.TowerControl[Alias] then
      ATM2.TowerControl[Alias] = {RequestedApproach = "Instrument Straight in", State = "On Final Approach", Type = Type }
    else
      ATM2.TowerControl[Alias].State = "On Final Approach"
    end
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      ...
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
      AI_ATC2:LandingManager(Alias, true)
      return
    end

    RadioObject:NewTransmission("DeadAir.ogg", 0.100, "Airbase_ATC/Ground/SoundFiles/", nil, 0.3, Subtitle, 7)
    RadioObject:NewTransmission("Wind.ogg", 0.583, "Airbase_ATC/Ground/SoundFiles/", nil, 0.1)
    AI_ATC2:ReadHeading(WindDirection, RadioObject, Agency)
    RadioObject:NewTransmission("At.ogg", 0.38, "Airbase_ATC/Ground/SoundFiles/", nil, 0.1)
    AI_ATC2:ReadNumber(WindSpeed, RadioObject, Agency)
    RadioObject:NewTransmission("Option.ogg", 1.115, "Airbase_ATC/Ground/SoundFiles/", nil, 0.05)
    AI_ATC2:LandingManager(Alias, true)
  end
  ...
  local function OverApproach()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local msg = "Over approach lights."
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 2)
      return
    end
  ...
  local function OverThreshold()
    ...
    local Subtitle = string.format("%s: over landing threshold. Contact tower on 257.950", Title)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local towerFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
      local msg = string.format("Over landing threshold. Contact tower on %s.", towerFreq)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 4)
    else
      RadioObject:NewTransmission("DeadAir.ogg",0.100,"Airbase_ATC/Ground/SoundFiles/",nil,nil,Subtitle,4)
  ...
  local function AltAdvisory()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenAltitude = AI_ATC2:SRS_ConvertAltitude(tostring(math.floor(AltBase)))
    ...
    AI_ATC2:ReadFlightLevel(feet, RadioObject, Agency, true, 0.00)
  end
  ...
  local function AppGlidepath()
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local msg = "Approaching glidepath, configure aircraft for landing."
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 2)
      return
    end
  ...
  local function Distance2Land(distance)
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenDistance = AI_ATC2:SRS_ConvertDigits(distance)
      local msg = string.format("%s miles.", spokenDistance)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 2)
      return
    end

    RadioObject:NewTransmission("DeadAir.ogg",0.100,"Airbase_ATC/Ground/SoundFiles/",nil,nil,Subtitle,2)
    AI_ATC2:ReadDistance(tostring(distance), RadioObject, Agency)
  end
  
  local function OnCourseCall()
    local PARdata = AI_ATC2.PARdata[Alias]
    local Subtitle = string.format("%s: heading %s.", Title, PARdata.HeadingStr)
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      local spokenHeading = AI_ATC2:SRS_ConvertHeading(PARdata.HeadingStr)
      local msg = string.format("Heading %s.", spokenHeading)
      AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 3)
      return
    end
    ...
    AI_ATC2:ReadHeading(PARdata.HeadingStr, RadioObject, Agency)
  end
  ...
  local function AudioTransmission()
    ...
    if willSpeakHeading and turnDir and FSM then
      ...
      if shouldCall then
        ...
        if not AI_ATC2.PARdata[Alias].History then
          AI_ATC2.PARdata[Alias].History = {}
        end
        AI_ATC2.PARdata[Alias].History.LastCalledHeading = newHdg
        AI_ATC2.PARdata[Alias].History.LastHeadingCallTime = now
    ...
    if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
      if Subtitle ~= "" then
        AI_ATC2:TransmitSRS(Transmitter, Subtitle .. ".", 0, nil, RadioObject, Subtitle, 4)
      end
      return
    end
  ...
  local function ApproachControl()
    ...
    local tick = AI_ATC2.PARdata[Alias].ApproachTick
    ...
    tick_sched_1 = SCHEDULER:New(nil, function()
      ...
      if not AI_ATC2.PARdata[Alias] then
        return
      end
      ...
      AI_ATC2.PARdata[Alias].CurrentDistance = DistanceCall
      
      tick.tick1Complete = true
      
    end, {}, 0.1)
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_1)

    ---------------------------------------------------------------------------------------
    -- TICK 2 (0.2s): GLIDEPATH CALCULATION
    ---------------------------------------------------------------------------------------
    tick_sched_2 = SCHEDULER:New(nil, function()
      if not AI_ATC2.PARdata[Alias] then return end
      local tick = AI_ATC2.PARdata[Alias].ApproachTick
      ...
      if not AI_ATC2.PARdata[Alias].GlidepathHistory then
        AI_ATC2.PARdata[Alias].GlidepathHistory = {
          LastDeviation = nil,
          LastUpdateTime = nil,
        }
      end
      
      local GPHistory = AI_ATC2.PARdata[Alias].GlidepathHistory
      local currentTime = timer.getTime()
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_2)
    ...
    tick_sched_3 = SCHEDULER:New(nil, function()
      ...
      local History = AI_ATC2.PARdata[Alias].History
      local currentTime = timer.getTime()
      ...
      elseif cross < -dir_eps then
        ...
        local prevDir = AI_ATC2.PARdata[Alias].Course and AI_ATC2.PARdata[Alias].Course.Direction
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_3)
    ...
    tick_sched_4 = SCHEDULER:New(nil, function()
      ...
      -- Previous status
      local prevStatus = AI_ATC2.PARdata[Alias].Course and AI_ATC2.PARdata[Alias].Course.Status or nil
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_4)
    ...
    tick_sched_5 = SCHEDULER:New(nil, function()
      ...
      local prevAbs = AI_ATC2.PARdata[Alias].Course and AI_ATC2.PARdata[Alias].Course.CourseDeviation
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_5)
    ...
    tick_sched_6 = SCHEDULER:New(nil, function()
      ...
      if crs.CourseStatus ~= "on course" then
        ...
        if crs.prevStatus == "on course" then
          ...
          local FSM = AI_ATC2.PARdata[Alias].AudioFSM
          ...
          AI_ATC2.PARdata[Alias].HeadingStr = headingStr
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_6)
    ...
    tick_sched_7 = SCHEDULER:New(nil, function()
      ...
      AI_ATC2.PARdata[Alias].PARCallout = PARCallout
      AI_ATC2.PARdata[Alias].HeadingStr = HeadingStr
      ...
      --env.info(string.format(
        ...
        --AI_ATC2.PARdata[Alias].Course and AI_ATC2.PARdata[Alias].Course.CourseDeviation or -999, 
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_7)
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_8)
    ...
    tick_sched_9 = SCHEDULER:New(nil, function()
      ...
      -- Initialize FSM
      AI_ATC2.PARdata[Alias].AudioFSM = AI_ATC2.PARdata[Alias].AudioFSM or {
        State = "IDLE",
        LastDistanceCalled = 999,
        LastCourseStatus = nil,
        Did_DH  = false,
      ...
      if not AI_ATC2.PARdata[Alias].GlidepathTracking then
        AI_ATC2.PARdata[Alias].GlidepathTracking = {
          SeenAbove = false,
          SeenBelow = false,
          SeenOn = false,
        }
      end
      local GPTrack = AI_ATC2.PARdata[Alias].GlidepathTracking
    ...
    table.insert(AI_ATC2.PAR_TickSchedulers[Alias], tick_sched_9)
...
--****************************************************************************GCA SAY INTENTIONS********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GCAPushTower(Alias, RadioObject)
  local Agency = "Tower"
  local Transmitter = "Tower"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:GCAPushTower(Alias, RadioObject) end, Transmitter)==false then
    return
  end
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local towerFreq = AI_ATC2:SRS_ConvertFrequency("Tower")
        local msg = string.format("%s, contact tower on %s.",
...
--****************************************************************************GCA SAY INTENTIONS********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:GCATowerCheckIn(Alias)
  local Transmitter = "Tower"
  local RadioObject = TOWER_RADIO2
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local ClientData = ATM2.ClientData[Alias]
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:GCATowerCheckIn(Alias) end, Transmitter)==false then
    return
  end
  USERSOUND:New("RADIO_TRANS_START.ogg"):ToUnit(Unit)
  ...
  SCHEDULER:New(nil, function()
    AI_ATC2:ResetMenus(Alias)
    AI_ATC2:GoAroundSubMenu(Alias, true)
  end, {}, 0.5)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, %s tower, say intentions.", spokenCallsign, AI_ATC2.AirbaseAlias)
        AI_ATC2:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 3)
        return
      end
...
--****************************************************************************ATC TAXI TO PARKING********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:TaxiParking(Alias)
  local Transmitter = "Ground"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = GROUND_RADIO2
  local ClientData = ATM2.ClientData[Alias]
  ...
  local Flight = ClientData.Flight
  local CallsignSub = Flight and FlightCallsign or Callsign
  local HoldShort, TurnDirection, Hold = AI_ATC2:HoldShortLanding(Alias)
  ...
  SCHEDULER:New(nil, function()
    ...
    if Hold==true then
      ...
      AI_ATC2:LandingHoldSubMenu(Alias, HoldShort)
    else
      Duration = 1
      Instruction = ""
      AI_ATC2:TaxiSubMenu(Alias)
  ...
  local function Execute(parkingspot)
    if MarkCoord~=nil then
      ATM2.ClientData[Alias].Mark = MarkCoord:MarkToGroup(parkingspot, GroupObject, true)
    end
    SCHEDULER:New(nil, function()
      AI_ATC2:RepeatLastTransmission(Alias, function()Execute(parkingspot) end)
      AI_ATC2:ChannelOpen(8, Transmitter, Alias)
      local Subtitle = string.format("%s: %s %s", Title, CallsignSub, Instruction)
      if AI_ATC2_MSRS and AI_ATC2_MSRS[Transmitter] and AI_ATC2_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC2:SRS_ConvertCallsign(CallsignSub)
        ...
        if Hold==true then
          local spokenRunway = AI_ATC2:SRS_ConvertRunway(HoldShort)
          local spokenExit = AI_ATC2:SRS_ConvertNavFix(Exit)
          ...
          local taxiString = AI_ATC2:TaxiToParking(Alias, RadioObject, Transmitter, false)
          taxiString = taxiString:gsub("%s+$", ""):gsub("%.$", "")
          local parkingSpot = AI_ATC2:SRS_ConvertSpotNumber(Spot)
      ...
      if Hold==true then
        ...
        AI_ATC2:TaxiToParking(Alias, RadioObject, Transmitter)
        ...
        AI_ATC2:SpotNumber(Spot, RadioObject, Transmitter)
      end
    end, {}, Delay)
  end
  ...
  ATC_Coroutine:AddCoroutine(function()
    ...
    for key, value in pairs(ParkingTbl) do
      ...
      if value.Number == Spot then
        Execute(key)
        ATM2.ClientData[Alias].ParkingSpace = key
        break
      end
      if Count >= Iteration then
        Count = 0
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:CrossRunwayLanding(Alias, Audio)
  local Transmitter = "Ground"
  local Title = string.format("%s %s", AI_ATC2.AirbaseAlias, Transmitter)
  local RadioObject = GROUND_RADIO2
  local ClientData = ATM2.ClientData[Alias]
  ...
  local Group = Unit:GetGroup()
  local Runway = AI_ATC2.Runways.Takeoff[1]
  local HoldShort = ATM2.GroundControl[Alias].HoldShortLanding
  local Spot = ClientData.SpotNumber
  ...
  if AI_ATC2:FunctionDelay(Alias, function() AI_ATC2:CrossRunwayLanding(Alias, Audio) end, Transmitter)==false then
    return
  end
  
   AI_ATC2:RepeatLastTransmission(Alias, function() AI_ATC2:CrossRunwayLanding(Alias, true) end)
...
--*******************************************************************************START AI_ATC2************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC2:Start()
  local Subtitle = "********************************************AI_ATC(Silverbow) v2.9.27 HAS STARTED********************************************************************"
  env.info(Subtitle)
  AI_ATC2:EnableCrewChief(true)
  AI_ATC2:InitATIS()
  AI_ATC2:FindTankerUnits()
  AI_ATC2:InitClients()
  AI_ATC2:InitRadios()
  AI_ATC2:GroundController(false)
  AI_ATC2:TowerController(false)
  SCHEDULER:New(nil, function()
    AI_ATC2:StartATIS()
  end, {}, 1)
end
...
SCHEDULER:New(nil, function()
  --AI_ATC2:SetCallsign("NELLIS_F-5E", "Burnin' Stogie", "31")
  AI_ATC2:Start()
end, {}, 6)