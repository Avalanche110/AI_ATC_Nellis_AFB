...
AI_ATC3_SoundFiles.Departure.SID = {
  ["ESSAA ONE"]     = {filename = "ESSAA ONE.ogg",     duration = 1.393, Subtitle = "ESSAA ONE Departure"},
  ["JAYSN ONE"]     = {filename = "JAYSN ONE.ogg",     duration = 1.382, Subtitle = "JAYSN ONE Departure"},
  ["LEAHI ONE"]     = {filename = "LEAHI ONE.ogg",     duration = 1.463, Subtitle = "LEAHI ONE Departure"},
  ["RANGE TWO"]     = {filename = "RANGE TWO.ogg",     duration = 1.382, Subtitle = "RANGE TWO Departure"},
  ["SILVER ONE"]    = {filename = "SILVER ONE.ogg",    duration = 1.544, Subtitle = "SILVER ONE Departure"},
  ["STOFF TWO"]     = {filename = "STOFF TWO.ogg",     duration = 1.521, Subtitle = "STOFF TWO Departure"},
  ["TONOPAH THREE"] = {filename = "TONOPAH THREE.ogg", duration = 1.625, Subtitle = "TONOPAH THREE Departure"},
}
  ...
  AI_ATC3.SID = {
    ["14"] = {
      ["ESSAA ONE"] = {
        Altitude = "18",
        Radial = "214",
        Instruction = {file = "214Radial.ogg",    duration = 2.078, Subtitle = "Intercept the 214 radial"},
        NAVPOINTS = {
      ...
      ["JAYSN ONE"] = {
        Altitude = "18",
        Radial = "204",
        Instruction = {file = "204Radial.ogg",    duration = 2.171, Subtitle = "Intercept the 204 radial"},
        NAVPOINTS = {
...
function AI_ATC3:ClearanceSubMenu(Alias)
  ...
  local AI_ATC3_Departure_Menu = MENU_GROUP:New(Group, "Departure...", AI_ATC3_Clearance_Menu)
  
  MENU_GROUP_COMMAND:New(Group, "VFR", AI_ATC3_Departure_Menu, function() AI_ATC3:VFR_Clearance(Alias) end, Group)
  
  local OptionsMenu = MENU_GROUP:New(Group, "Options...", AI_ATC3_Clearance_Menu)
  ...
  MENU_GROUP_COMMAND:New(Group, "Heavy",    Menu3, function() AI_ATC3:SetCallsign(Alias, "Heavy",        "11") end, Group)
...
function AI_ATC3:ReadBackSubMenu(Alias)
  ...
  local AI_ATC3_Readback_Menu = MENU_GROUP:New(Group, "ReadBack...", AI_ATC3_Clearance_Menu)
  local OptionsMenu    = MENU_GROUP:New(Group, "Options...", AI_ATC3_Clearance_Menu)
  local CallsignMenu   = MENU_GROUP:New(Group, "Set Callsign...", OptionsMenu)
  
  if squawk and string.find(squawk, "001", 1, true) then
    MENU_GROUP_COMMAND:New(Group, "Squawk 1001",   AI_ATC3_Readback_Menu, function() AI_ATC3:ClearanceReadBack(Alias, "1001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 2001",   AI_ATC3_Readback_Menu, function() AI_ATC3:ClearanceReadBack(Alias, "2001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 3001",   AI_ATC3_Readback_Menu, function() AI_ATC3:ClearanceReadBack(Alias, "3001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 4001",   AI_ATC3_Readback_Menu, function() AI_ATC3:ClearanceReadBack(Alias, "4001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 5001",   AI_ATC3_Readback_Menu, function() AI_ATC3:ClearanceReadBack(Alias, "5001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 6001",   AI_ATC3_Readback_Menu, function() AI_ATC3:ClearanceReadBack(Alias, "6001") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Squawk 7001",   AI_ATC3_Readback_Menu, function() AI_ATC3:ClearanceReadBack(Alias, "7001") end, Group)
  else
...
function AI_ATC3:SeperateFromGroup(Alias)
  ...
  local Menu = MENU_GROUP:New(Group, "Seperate from Group", AI_ATC3.ParentMenu)
  
  MENU_GROUP_COMMAND:New(Group, "Seperate from group", Menu, function() AI_ATC3:SeperateGroup(Alias, Menu) end, Group)
...
function AI_ATC3:GroundStartSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Request Engine Start", AI_ATC3_Ground_Menu, function() AI_ATC3:EngineStart(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:TaxiSubMenu(Alias)
  ...
  if Helo==false then
    MENU_GROUP_COMMAND:New(Group, "Request Engine Start", AI_ATC3_Ground_Menu, function() AI_ATC3:EngineStart(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Taxi clearance", AI_ATC3_Ground_Menu, function()AI_ATC3:TaxiClearance(Alias) end, Group)
  elseif Helo==true then
    MENU_GROUP_COMMAND:New(Group, "Request Engine Start", AI_ATC3_Ground_Menu, function() AI_ATC3:EngineStart(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Taxi clearance", AI_ATC3_Ground_Menu, function()AI_ATC3:TaxiClearance(Alias) end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Hover check", AI_ATC3_Ground_Menu, function()AI_ATC3:HoverCheck(Alias, "Ground") end, Group)
    MENU_GROUP_COMMAND:New( Group, "Request Takeoff from parking", AI_ATC3_Tower_Menu, function()AI_ATC3:TakeoffFromParking(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:CrossPadSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Request clearance to pad", AI_ATC3_Tower_Menu, function() AI_ATC3:TakePad(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************GROUND - HOVER CHECK**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC3:HoverSubMenu(Alias)
  local Group = ATM3.ClientData[Alias].Unit:GetGroup()
  local AI_ATC3_Tower_Menu = ATM3.ClientData[Alias].TowerMenu
  local HoverMenu = MENU_GROUP_COMMAND:New( Group, "Request hover check", AI_ATC3_Tower_Menu, function()AI_ATC3:HoverCheck(Alias, "Tower") end, Group)
...
function AI_ATC3:HeloTakeOffSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Request Takeoff", AI_ATC3_Tower_Menu, function()AI_ATC3:HeloTakeoff(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER TAKEOFF SUB MENU**********************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function AI_ATC3:TakeOffSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Request Takeoff", AI_ATC3_Tower_Menu, function()AI_ATC3:TakeoffClearance(Alias) end, Group)
  if not Helo then
    local ClimbMenu = MENU_GROUP:New(Group, "Unrestricted climb", AI_ATC3_Tower_Menu)
...
function AI_ATC3:DepartureSubMenu(Alias, missed)
  ...
  if Randomizer==1 and missed~=true then
    MENU_GROUP_COMMAND:New(Group, "Check in", DepartureMenu, function() AI_ATC3:DepartureIdent(Alias) end, Group)
  elseif Randomizer~=1 and missed~=true then
    MENU_GROUP_COMMAND:New(Group, "Check in", DepartureMenu, function() AI_ATC3:DepartureCheckin(Alias) end, Group)
  elseif missed==true then
    MENU_GROUP_COMMAND:New(Group, "Check in", AppraochMenu, function() AI_ATC3:MissedApproach(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:NavigationSubMenu(Alias, Modifier)
    ...
    if branch == "Helo" then
      for _, navpoint in ipairs(navTable) do
        if navpoint and navpoint.GetName then
          ...
          MENU_GROUP_COMMAND:New(Group, "Report "..name, ReportMenu, function() AI_ATC3:RadarTerminate(Alias) end, Group)
          MENU_GROUP_COMMAND:New(Group, "Vectors for "..name, NavPoint, function() AI_ATC3:NavAssist(Alias, name, Transmitter) end, Group)
        end
      end

    else
      MENU_GROUP_COMMAND:New(Group, "Report Anchor point", ReportMenu, function() AI_ATC3:RadarTerminate(Alias) end, Group)
  ...
  MENU_GROUP_COMMAND:New(Group, "Request Approach", DepartureMenu, function() AI_ATC3:RequestApproach(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************APPROACH SUB MENU**************************************************************************************--
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:ApproachTypeMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Cancel IFR", ApproachMenu, function() AI_ATC3:CancelIFR(Alias) end, Group)
  ...
  local function GenerateIFRMenus()
    if Runway =="08" then
      ...
      MENU_GROUP_COMMAND:New(Group, "Request GCA",    IFRMenu, function() AI_ATC3:PushGCA(Alias)                      end, Group)
...
function AI_ATC3:GCASubMenu(Alias, missed, modifier)
  ...
  if not modifier then
    MENU_GROUP_COMMAND:New(Group, "GCA Check in", AppraochMenu, function() AI_ATC3:IFRApproachType5(Alias, "PAR") end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, "GCA Check in", AppraochMenu, function() AI_ATC3:ApproachBackToRadar(Alias, "PAR") end, Group)
  end
...
function AI_ATC3:B2CheckInSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Check in", AppraochMenu, function() AI_ATC3:B2RCheckIn(Alias) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:BackToRadarSubMenu(Alias)
  ...
  if ActiveRunway=="08" or ActiveRunway=="13" then
    ...
    MENU_GROUP_COMMAND:New(Group, "Request GCA", IFRMenu, function() AI_ATC3:PushGCA(Alias, true, true) end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, TacSub, IFRMenu, function() AI_ATC3:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, TacFinal, IFRMenu, function() AI_ATC3:ApproachBackToRadar(Alias, "TACAN") end, Group)
    MENU_GROUP_COMMAND:New(Group, "", IFRMenu, function()  end, Group)
...
function AI_ATC3:ApproachAssistMenu(Alias, report)
  ...
  if Procedure=="VFR" then
    if Helo then
      ...
      MENU_GROUP_COMMAND:New(Group, "Request IFR Pickup", ApproachMenu, function() SetApproachType("IFR") AI_ATC3:IFRApproach(Alias) end, Group)
    end
  elseif Procedure=="IFR" then
...
function AI_ATC3:VectorToFinal(Alias, Tbl, Transmitter)
  ...
  MENU_GROUP_COMMAND:New(Group, "Radar Downwind", VectorMenu, function() AI_ATC3:NavAssist(Alias, Downwind, Transmitter, "Downwind") end, Group)
...
function AI_ATC3:MissedApproachMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Request GCA", IFRMenu, function() AI_ATC3:PushGCA(Alias, true) end, Group)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:LandingSubMenu(Alias, Modifier)
  ...
  if Helo~=true then
    if ApproachType == "VFR" then
      MENU_GROUP_COMMAND:New(Group, "Straight In", CommandMenu, function() AI_ATC3:StraightIn(Alias) end, Group)
      ...
      MENU_GROUP_COMMAND:New(Group, "High Tactical Overhead", CommandMenu, function() AI_ATC3:Deadside(Alias) end, Group)
      if Modifier then
        MENU_GROUP_COMMAND:New(Group, "Request Departure", CommandMenu, function() AI_ATC3:RadarVectorDeparture(Alias) end, Group)
      end
    elseif ApproachType == "IFR" then
      MENU_GROUP_COMMAND:New(Group, "Instrument Straight In", CommandMenu, function() AI_ATC3:InstrumentStraightIn(Alias) end, Group)
      if Modifier then
        MENU_GROUP_COMMAND:New(Group, "   ", CommandMenu, function() end, Group)
        MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function() AI_ATC3:RadarVectorDeparture(Alias) end, Group)
      end
    end
  else
    MENU_GROUP_COMMAND:New(Group, "Straight In", CommandMenu, function() AI_ATC3:HeloRequestLanding(Alias, "Straight In") end, Group)
    MENU_GROUP_COMMAND:New(Group, "Closed traffic", CommandMenu, function() AI_ATC3:HeloRequestLanding(Alias, "Closed traffic") end, Group)
  end
...
function AI_ATC3:InitialSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Full Stop", InitialMenu, function() AI_ATC3:RequestFullStop(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", InitialMenu, function() AI_ATC3:RequestTouchGo(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", InitialMenu, function() AI_ATC3:RequestLowApproach(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", InitialMenu, function() AI_ATC3:RequestOption(Alias) end, Group)
...
function AI_ATC3:ReportHighKeyMenu(Alias)
  ...
  local TowerMenu = ATM3.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Report", TowerMenu)
  MENU_GROUP_COMMAND:New(Group, "Report High Key", CommandMenu, function() AI_ATC3:ReportKey(Alias, "High") end, Group)
  AI_ATC3:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:ReportLowKeyMenu(Alias)
  ...
  local TowerMenu = ATM3.ClientData[Alias].TowerMenu
  local CommandMenu = MENU_GROUP:New(Group, "Report", TowerMenu)
  MENU_GROUP_COMMAND:New(Group, "Report Low Key", CommandMenu, function() AI_ATC3:ReportKey(Alias, "Low") end, Group)
  AI_ATC3:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************TOWER REPORT INITIAL************************************************************************************--
...
function AI_ATC3:ReportBaseSubMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu, function() AI_ATC3:RequestFullStop(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu, function() AI_ATC3:RequestTouchGo(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu, function() AI_ATC3:RequestLowApproach(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu, function() AI_ATC3:RequestOption(Alias) end, Group)
  AI_ATC3:TowerAncilleryMenu(Alias)
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--***********************************************************************HELO REPORT BASE************************************************************************************--
...
function AI_ATC3:HeloBaseSubMenu(Alias, Type)
  ...
  if Type=="Closed traffic" then
    MENU_GROUP_COMMAND:New(Group, "Report base", TowerMenu, function() AI_ATC3:HeloBase(Alias) end, Group)
  else
    MENU_GROUP_COMMAND:New(Group, "Report 3 miles", TowerMenu, function() AI_ATC3:HeloBase(Alias) end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
function AI_ATC3:WingmanBaseSubMenu(Alias)
  ...
  local BaseMenu = MENU_GROUP:New(Group, "Report base", CommandMenu)
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu, function() AI_ATC3:WingmanReportBase(Alias, "Full Stop", "2") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu, function() AI_ATC3:WingmanReportBase(Alias, "Touch and Go", "2") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu, function() AI_ATC3:WingmanReportBase(Alias, "Low Approach", "2") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu, function() AI_ATC3:WingmanReportBase(Alias, "Option", "2") end, Group)
  ...
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu3, function() AI_ATC3:WingmanReportBase(Alias, "Full Stop", "3") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu3, function() AI_ATC3:WingmanReportBase(Alias, "Touch and Go", "3") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu3, function() AI_ATC3:WingmanReportBase(Alias, "Low Approach", "3") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu3, function() AI_ATC3:WingmanReportBase(Alias, "Option", "3") end, Group)
  ...
  MENU_GROUP_COMMAND:New(Group, "Full Stop", BaseMenu4, function() AI_ATC3:WingmanReportBase(Alias, "Full Stop", "4") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Touch and Go", BaseMenu4, function() AI_ATC3:WingmanReportBase(Alias, "Touch and Go", "4") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Low Approach", BaseMenu4, function() AI_ATC3:WingmanReportBase(Alias, "Low Approach", "4") end, Group)
  MENU_GROUP_COMMAND:New(Group, "Option", BaseMenu4, function() AI_ATC3:WingmanReportBase(Alias, "Option", "4") end, Group)
...
function AI_ATC3:WingmanClosedSubMenu(Alias)
  ...
  if Wingman2Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", Command2Menu, function() AI_ATC3:WingmanClosedTraffic(Alias, "2") end, Group)
  end
  ...
  if Wingman3Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", Command3Menu, function() AI_ATC3:WingmanClosedTraffic(Alias, "3") end, Group)
  end
  ...
  if Wingman4Menu then
    ...
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", Command4Menu, function() AI_ATC3:WingmanClosedTraffic(Alias, "4") end, Group)
  end
end
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--**************************************************************************TOWER GO AROUND**************************************************************************************--
...
function AI_ATC3:GoAroundSubMenu(Alias, modifier)
  ...
  if Proceedure=="VFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function() end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", CommandMenu, function() SetApproachType("VFR") AI_ATC3:ClosedTraffic(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function() SetApproachType("IFR") AI_ATC3:BackToRadar(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Missed Approach", CommandMenu, function() SetApproachType("IFR") AI_ATC3:GoAround(Alias) end, Group)
  ...
  elseif Proceedure=="IFR" then
    ...
    MENU_GROUP_COMMAND:New(Group, " ", CommandMenu, function()  end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function()SetApproachType("IFR") AI_ATC3:BackToRadar(Alias) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Missed Approach", CommandMenu, function()SetApproachType("IFR") AI_ATC3:GoAround(Alias, "IFR") end, Group)
    MENU_GROUP_COMMAND:New(Group, "  ", CommandMenu, function()  end, Group)
  end
  
  if modifier then
    MENU_GROUP_COMMAND:New(Group, "Full stop", CommandMenu, function() AI_ATC3:RollOutLanding(Alias) end, Group)
  end
...
function AI_ATC3:GCAGoAroundSubMenu(Alias, RadioObject)
  ...
  MENU_GROUP_COMMAND:New(Group, "Cancel IFR", ApproachMenu, function() AI_ATC3:CancelIFR(Alias, "Tower") end, Group)
  ...
  if Proceedure=="VFR" then
    MENU_GROUP_COMMAND:New(Group, "", CommandMenu, function() end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request closed traffic", CommandMenu, function() AI_ATC3:GCAPushTower(Alias, RadioObject) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Request Back to Radar", CommandMenu, function() AI_ATC3:GCAPushTower(Alias, RadioObject) end, Group)
    MENU_GROUP_COMMAND:New(Group, "Missed Approach", CommandMenu, function() AI_ATC3:GCAPushTower(Alias, RadioObject) end, Group)
...
function AI_ATC3:TowerCheckIn2Menu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group, "Check In", CommandMenu, function() AI_ATC3:GCATowerCheckIn(Alias) end, Group)
...
function AI_ATC3:TowerAncilleryMenu(Alias)
  ...
  MENU_GROUP_COMMAND:New(Group,"Traffic in sight", AncilaryMenu, function() AI_ATC3:AcknowledgeTraffic(Alias, true) end, Group)
  MENU_GROUP_COMMAND:New(Group,"No Joy", AncilaryMenu, function() AI_ATC3:AcknowledgeTraffic(Alias, false) end, Group)
  MENU_GROUP_COMMAND:New(Group,"Acknowledge Extend Downwind", AncilaryMenu, function() AI_ATC3:AcknowledgeExtend(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group,"Say Winds", AncilaryMenu, function() AI_ATC3:TowerWinds(Alias) end, Group)
  MENU_GROUP_COMMAND:New(Group,"Break Out", AncilaryMenu, function() AI_ATC3:BreakOut(Alias, NavPoint) end, Group)
...
function AI_ATC3:ParkingSubMenu(Alias)
  ...
  if Helo==false then
    MENU_GROUP_COMMAND:New(Group, "Taxi to Parking", GroundMenu, function() AI_ATC3:TaxiParking(Alias) end, Group)
  elseif Helo==true then
    MENU_GROUP_COMMAND:New(Group, "Taxi to Parking", GroundMenu, function() AI_ATC3:TaxiParking(Alias) end, Group)
  end
end
...
function AI_ATC3:ClearanceReadBack(Alias, code)
  ...
  local function Execute()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC3_MSRS and AI_ATC3_MSRS["Clearance"] and AI_ATC3_MSRS["Clearance"].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, readback correct. Contact Ground prior to taxi.", spokenCallsign)
...
function AI_ATC3:HeloTaxi(Alias, Audio)
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, %s ground. Taxi via juliett, kilo. Contact tower holding short of jolly.",spokenCallsign,AI_ATC3.AirbaseAlias)
      AI_ATC3:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
      return
    end
...
function AI_ATC3:VFRDeparture(Alias, Audio)
  ...
  SCHEDULER:New(nil, function()
    if Helo then
      ...
      TerminalRange = 55559
      Instruction = "Climb and maintain 14,000. Cleared Scheduled, Contact BLACKJACK, UHF Channel 16."
    end
    AirbaseName = "Nellis"
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
      ...
      if Helo then
        ...
        msg = msg .. " Climb and maintain one four thousand. Cleared scheduled. Contact black jack, U H F Channel sixteen."
      end
...
function AI_ATC3:RadarTerminate(Alias, Audio)
  ...
  SCHEDULER:New(nil, function()
    ...
    if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
      local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
      local msg = string.format("%s, radar service terminated, cleared scheduled. Contact BlackJack UHF Channel sixteen.", spokenCallsign)
      AI_ATC3:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
...
function AI_ATC3:VFRApproach(Alias)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      local Subtitle = string.format("%s: %s, Nellis control, fly heading %s, Expect visual approach for runway %s", Title, CallsignSub, TurnHeading, Runway )

      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading = AI_ATC3:SRS_ConvertHeading(TurnHeading)
        local spokenRunway = AI_ATC3:SRS_ConvertRunway(Runway)
        local msg = string.format("%s, Nellis control, fly heading %s, expect visual approach for runway %s.",
...
function AI_ATC3:IFRApproachType2(Alias, Type, Missed)
  ...
  local function Message()
    ...
    SCHEDULER:New(nil, function()
      AI_ATC3:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC3:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s Approach. %s. Proceed direct %s and fly the 16DME arc to runway %s.", Title, CallsignSub, AI_ATC3.AirbaseAlias, AltSubtitle, Fix, Runway )
      ...
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        ...
        local msg = string.format("%s, %s approach, %s %s, proceed direct %s, fly the sixteen D M E arc to runway %s. Report established on the arc.",
...
function AI_ATC3:IFRApproachType4(Alias, Type, Missed)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC3:RepeatLastTransmission(Alias, function()Message() end)
      AI_ATC3:ChannelOpen(11, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s Approach, fly heading %s. %s. %s. Report %s", Title, CallsignSub, AI_ATC3.AirbaseAlias, TurnHeading, AltSubtitle, Sqwuak, Navpoint )
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC3:SRS_ConvertHeading(TurnHeading)
        local spokenAlt      = AI_ATC3:SRS_ConvertAltitude(AltSub)
        local spokenNavpoint = AI_ATC3:SRS_ConvertNavFix(Navpoint)
        local msg = string.format("%s, %s approach, fly heading %s. %s %s. %s. Report %s.",
...
function AI_ATC3:IFRApproachType5(Alias, Type, Call, Base)
  ...
  local function CorrectHeading(NewHeading)
    ...
    SCHEDULER:New(nil, function()
      AI_ATC3:ChannelOpen(12, Transmitter, Alias)
      local Subtitle = string.format("%s: %s, %s GCA, fly heading %s.", Title, CallsignSub, AI_ATC3.AirbaseAlias, NewHeading)
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading  = AI_ATC3:SRS_ConvertHeading(NewHeading)
...
function AI_ATC3:ApproachLocalizer(Alias, Type)
  ...
  local function FinalController()
    ...
    if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
      ...
      local msg = string.format("%s, Indian Springs G C A, turn %s heading %s, standby final controller.",
...
function AI_ATC3:MissedApproach(Alias, Audio)
  ...
  local RadialTable = {
    ["08"] = {
      ["ILS"] = { filename = "112Radial.ogg", duration = 2.148, subtitle = "Intercept the 112 radial." },
      ["TACAN"] = { filename = "112Radial.ogg", duration = 2.148, subtitle = "Intercept the 112 radial." },
    },
    ["26"] = {
      ["TACAN"] = { filename = "246Radial.ogg", duration = 2.171, subtitle = "Intercept the 246 radial." },
      ["ILS"] = { filename = "246Radial.ogg", duration = 2.171, subtitle = "Intercept the 246 radial." },
    },
    ["13"] = {
      ["ILS"] = { filename = "112Radial.ogg", duration = 2.148, subtitle = "Intercept the 112 radial." },
      ["TACAN"] = { filename = "112Radial.ogg", duration = 2.148, subtitle = "Intercept the 112 radial." },
  ...
  local function Execute()
    ...
    SCHEDULER:New(nil, function()
      ...
      if Approach=="VFR" or Approach=="Generic" then
        local Subtitle = string.format("%s: %s contact Indian Springs Tower on 360.600.", Title, CallsignSub)
        if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
      ...
      elseif Approach=="IFR" then
        local Subtitle = string.format("%s: %s Radar service terminated. Contact tower on 360.600.", Title, Callsign)
        if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
          local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
          local spokenFreq = AI_ATC3:SRS_ConvertFrequency("Tower")
          local msg = string.format("%s, radar service terminated. Contact Indian Springs Tower on %s.", spokenCallsign, spokenFreq)
          AI_ATC3:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 6)
          return
        end
...
function AI_ATC3:CancelIFR(Alias, agency)
  ...
  if AI_ATC3:FunctionDelay(Alias, function() AI_ATC3:CancelIFR(Alias, agency) end, Transmitter)==false then
    ...
    SCHEDULER:New(nil, function()
      ...
      local Subtitle = string.format("%s: %s, cancellation recieved, contact tower on 360.600.", Title, CallsignSub)
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC3:SRS_ConvertFrequency("Tower")
  ...
  local function TowerMessage()
    SCHEDULER:New(nil, function()
      ...
      local Subtitle = string.format("%s: %s Contact tower on 360.600.", Title, CallsignSub)
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC3:SRS_ConvertFrequency("Tower")
        local msg = string.format("%s, contact tower on %s.", spokenCallsign, spokenFreq)
...
function AI_ATC3:PushGCA(Alias, missed, radar)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC3:ChannelOpen(6, Transmitter, Alias)
      AI_ATC3:RepeatLastTransmission(Alias, function()Message() end)
      local Subtitle = string.format("%s: %s, Contact Indian Springs GCA on 343.725.", Title, CallsignSub)
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenFreq = AI_ATC3:SRS_ConvertFrequency("SFA")
        local msg = string.format("%s, contact Indian Springs G C A on %s.", spokenCallsign, spokenFreq)
        AI_ATC3:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 5)
        return
      end
...
function AI_ATC3:TowerTraffic(Alias)
  ...
  local StateTbl = {
    ...
    ["Landed on runway 08"]  = {filename = "OnFinal.ogg", duration = 0.570, subtitle = "on final"},
    ["Landed on runway 26"]  = {filename = "OnFinal.ogg", duration = 0.570, subtitle = "on final"},
    ["Landed on runway 13"]  = {filename = "OnFinal.ogg", duration = 0.570, subtitle = "on final"},
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        ...
        if ApproachType == "Straight in" then
          msg = string.format("%s, Indian Springs tower, report five mile straight in, runway %s.",
        ...
        elseif ApproachType == "Instrument Straight in" then
          ...
          if TrafficType and TrafficType ~= "" and StateData and StateSub and StateSub ~= "" then
            local aircraftPhrase = AI_ATC3:SRS_ConvertAircraftType(TrafficType, RadioKey)
            msg = string.format("%s, Indian Springs tower, report five miles. You're number %s behind the %s %s for runway %s.",
              spokenCallsign, spokenLandingNo, aircraftPhrase, StateSub, spokenRunway)
          else
            msg = string.format("%s, Indian Springs tower, report five miles for runway %s.",
              spokenCallsign, spokenRunway)
          end
        elseif ApproachType == "Overhead" then
          msg = string.format("%s, Indian Springs tower, report five mile initial, runway %s.",
            spokenCallsign, spokenRunway)
        elseif ApproachType == "SFO" then
          msg = string.format("%s, Indian Springs tower, runway %s. %s turn out approved. Report high key.",
            spokenCallsign, spokenRunway, string.lower(Break or ""))
        elseif ApproachType == "Deadside" then
          msg = string.format("%s, Indian Springs tower, report ready overhead for runway %s.",
            spokenCallsign, spokenRunway)
        end
...
function AI_ATC3:HeloRequestLanding(Alias, Type)
  ...
  local function ClosedCircuit()
    SCHEDULER:New(nil, function()
      ...
      AI_ATC3:ChannelOpen(12, Transmitter, Alias)
      local Subtitle = string.format("%s: %s %s, Runway %s, Join %s downwind at or below 3600. Report base.", Title, CallsignSub, Title, Runway, Base)
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC3:SRS_ConvertRunway(Runway)
        local msg = string.format(
  ...
  local function StraightIn()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenRunway = AI_ATC3:SRS_ConvertRunway(Runway)
        local msg = string.format("%s, Indian Springs tower, runway %s. Report three miles.",
          spokenCallsign, spokenRunway)
        AI_ATC3:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 7)
        return
      end
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        ...
        if TrafficType and StateData then
          local aircraftPhrase = AI_ATC3:SRS_ConvertAircraftType(TrafficType, RadioKey)
          msg = string.format("%s, Indian Springs tower. You're number %s behind the %s %s for runway %s. %s %s.",
            spokenCallsign, spokenLandingNo, aircraftPhrase, StateSub, spokenRunway, BreakSub, BaseSub)
        else
          msg = string.format("%s, Indian Springs tower. You're number %s for runway %s. %s %s.",
...
function AI_ATC3:GoAround(Alias, Type)
  ...
  local InstructionTable = {
    ["IFR"] = {
      ["08"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Execute published missed Approach." },
      ["26"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Execute published missed Approach."  },
      ["13"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Execute published missed Approach."  },
      ["31"] = { filename = "MissedApproach.ogg", duration = 1.765, subtitle = "Execute published missed Approach."  },
    },
    ["VFR"] = { 
      ["08"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Break out and report 5 mile initial."  },
      ["26"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Break out and report 5 mile initial."  },
      ["13"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Break out and report 5 mile initial."  },
      ["31"] = { filename = "BreakOut.ogg", duration = 2.239, subtitle = "Break out and report 5 mile initial."  },
    },
  }
  ...
  SCHEDULER:New(nil, function()
    ...
    elseif ApproachType=="IFR" then
      ...
      Instruction = AudioData.subtitle.." Contact Nellis Control 254.400"
...
function AI_ATC3:BackToRadar(Alias)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      AI_ATC3:ChannelOpen(10, Transmitter, Alias)
      AI_ATC3:RepeatLastTransmission(Alias, function()Message() end)
      local Subtitle = string.format("%s: %s Turn %s heading %s. Climb and maintain 10000. Contact Nellis Control on 254.400.", Title, CallsignSub, Turn, Heading)
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local spokenHeading = AI_ATC3:SRS_ConvertHeading(Heading)
        local spokenFreq = AI_ATC3:SRS_ConvertFrequency("NATCF_LEE")
        local msg = string.format("%s, turn %s heading %s. Climb and maintain one three thousand. Contact Nellis Control on %s.",
...
function AI_ATC3:TowerPAR(Alias)
  ...
  local function RunwayInSight()
    local Subtitle = string.format("%s: Copy Runway in sight. Contact Indian Springs tower on 360.600.", Title)
    if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
  ...
  local function OverThreshold()
    ...
    local Subtitle = string.format("%s: over landing threshold. Contact tower on 360.600", Title)
    if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
      local towerFreq = AI_ATC3:SRS_ConvertFrequency("Tower")
...
function AI_ATC3:GCATowerCheckIn(Alias)
  ...
  local function Message()
    SCHEDULER:New(nil, function()
      ...
      if AI_ATC3_MSRS and AI_ATC3_MSRS[Transmitter] and AI_ATC3_MSRS[Transmitter].Active then
        local spokenCallsign = AI_ATC3:SRS_ConvertCallsign(CallsignSub)
        local msg = string.format("%s, %s tower, say intentions.", spokenCallsign, AI_ATC3.AirbaseAlias)
        AI_ATC3:TransmitSRS(Transmitter, msg, 0, nil, RadioObject, Subtitle, 3)
        return
      end
