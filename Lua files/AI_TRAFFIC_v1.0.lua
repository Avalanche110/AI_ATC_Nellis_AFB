...
function AI_Traffic:SpawnApproach()
  ...
  local FighterTemplate = { "A-10C-II","AV-8B","F-15C","F-15E","F-16C","F-4E","F-5E","F/A-18C","M-2000C","MB-339A","Tornado" }
  local TwoShipTemplate = { "A-10C-II-2","AV-8B-2","F-15C-2","F-15E-2","F-16C-2","F-4E-2","F-5E-2","F/A-18C-2","M-2000C-2","MB-339A-2","Tornado-2" }
  local HeavyTemplate   = { "C-17A","KC-130","KC-135","B-52","B-1B" }
